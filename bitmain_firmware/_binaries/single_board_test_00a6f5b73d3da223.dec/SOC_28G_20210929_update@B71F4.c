int __fastcall SOC_28G_20210929_update(int a1, unsigned __int8 a2, char a3, unsigned __int8 a4)
{
  int v9; // [sp+1Ch] [bp+Ch] BYREF
  __int16 v10; // [sp+101Eh] [bp+100Eh]

  V_LOCK();
  logfmt_raw(&v9, 0x1000u, 0, "%s core_id %02x ...", "SOC_28G_20210929_update", (unsigned __int8)a3);
  V_UNLOCK();
  zlog(
    g_zc,
