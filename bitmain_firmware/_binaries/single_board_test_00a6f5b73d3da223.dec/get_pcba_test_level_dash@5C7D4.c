  ...
  if ( !((int (__fastcall *)(_DWORD, int, int, int *))v2[19])(a1[34], 52, 393216, &v8) )
  {
    for ( i = 0; i <= 4; ++i )
    {
      if ( __PAIR64__(HIWORD(v8), (unsigned __int16)v8) == __PAIR64__(
                                                             *((unsigned __int16 *)&unk_1B8108 + 5 * i + 3),
                                                             *((unsigned __int16 *)&unk_1B8108 + 5 * i + 2))
        && __PAIR64__(HIBYTE(v9), (unsigned __int8)v9) == __PAIR64__(
                                                            *((unsigned __int8 *)&unk_1B8108 + 10 * i + 9),
                                                            *((unsigned __int8 *)&unk_1B8108 + 10 * i + 8)) )
      {
    ...
    if ( !a1[192] )
    {
      ...
      {
        if ( __PAIR64__(HIWORD(v8), (unsigned __int16)v8) == __PAIR64__(
                                                               *((unsigned __int16 *)&unk_1B8108 + 5 * j + 3),
                                                               *((unsigned __int16 *)&unk_1B8108 + 5 * j + 2)) )
        {
