// Decompiled: configfs.ko_125ec9b50c3495fc_debug
  ...
  if (lVar3 == 0 || lVar4 == 0) {
    ...
    if (cVar1 == '\0') {
      ...
      if (((*(long *)(lVar3 + 0x40) == 0) ||
        ...
        if (lVar2 != 0) {
          __mutex_init(lVar2 + 0x20,"&buffer->mutex",&DAT_00107100);
...

{
  ...
  if ((DAT_00106c82 >> 2 & 1) != 0) {
    __dynamic_pr_debug(&PTR_s_configfs_00106c60,"configfs: %s: count = %zd, ppos = %lld, buf = %s\n",
...

{
  ...
  if (param_2[1] == 0) {
    iVar2 = (*(code *)*param_2)(param_2,&DAT_00106318,1,0,*(undefined8 *)(*(long *)(lVar5 + 0x30) + 0x38),4);
    if (iVar2 != 0) {
      return 0;
    }
    param_2[1] = 1;
  ...
  iVar2 = (*pcVar7)(param_2,&DAT_00106320,2,1,uVar4,4);
  if (iVar2 != 0) {
    return 0;
  }
  param_2[1] = 2;
...

{
  ...
  lockref_get(param_1 + 0x58);
  if ((DAT_00106caa >> 2 & 1) != 0) {
    __dynamic_pr_debug(&PTR_s_configfs_00106c88,"configfs: configfs %s: dropping attrs for  dir\n",
...

{
  ...
  if (param_1 != 0) {
    ...
    *(int **)(piVar6 + 4) = piVar1;
    ...
    if ((DAT_00106cd2 >> 2 & 1) != 0) {
      __dynamic_pr_debug(&PTR_s_configfs_00106cb0,"configfs:  o %pd removing done (%d)\n",param_1,
        ...
        if (lVar12 == 0) {
          ...
          if (*(long *)(param_1 + 0x10) == 0) {
            ...
            if (puVar6 != (undefined8 *)0x0) {
              ...
              iVar1 = iVar3 * 3 + iVar1;
              if (iVar1 + -1 < 0x1001) {
                if ((DAT_00106cfa >> 2 & 1) != 0) {
                  __dynamic_pr_debug(&PTR_s_configfs_00106cd8,"configfs: %s: depth = %d, size = %d\n",
                ...
                if ((DAT_00106d22 >> 2 & 1) != 0) {
                  __dynamic_pr_debug(&PTR_s_configfs_00106d00,"configfs: %s: path = \'%s\'\n","configfs_get_target_path"
                                     ,puVar5);
                }
...

{
  ...
  *(undefined1 **)(param_1 + 0x30) = &DAT_00105200;
  lVar1 = configfs_new_inode(0x41ed,&DAT_00106b48,param_1);
  if (lVar1 == 0) {
    if ((DAT_00106d4a >> 2 & 1) != 0) {
      __dynamic_pr_debug(&PTR_s_configfs_00106d28,"configfs: could not get root inode\n");
    }
    return 0xfffffff4;
  }
  ...
  *(undefined1 **)(lVar1 + 0x178) = configfs_dir_operations;
  ...
  if (lVar1 == 0) {
    ...
    __dynamic_pr_debug(&PTR_s_configfs_00106d50,"configfs: %s: could not get root dentry!\n","configfs_fill_super");
    uVar2 = 0xfffffff4;
  }
  else {
    config_group_init(&PTR_DAT_00106ba0);
    *(undefined1 **)(lVar1 + 0x90) = &DAT_00106b48;
...
{
  _mcount();
  return param_1 == &PTR_DAT_00106ba0;
}
...

{
  ...
  _mcount();
  iVar1 = simple_pin_fs(&PTR_s_configfs_00106c28,&DAT_00107108,&DAT_00107100);
  if (iVar1 == 0) {
    return *DAT_00107108;
  }
  return (long)iVar1;
...
{
  _mcount();
  simple_release_fs(&DAT_00107108);
  return;
}
...
{
  _mcount();
  config_item_set_name(param_1,&DAT_00106750,param_2);
  ...
  if (param_1 != (undefined8 *)0x0) {
    ...
    if (iVar4 + -1 == 0) {
      ...
      if ((DAT_00106d9a >> 2 & 1) != 0) {
        __dynamic_pr_debug(&PTR_s_configfs_00106d78,"config_item %s: cleaning up\n",*param_1);
      }
...

{
  ...
  if (configfs_dir_cachep == 0) {
    ...
    if (iVar1 == 0) {
      iVar1 = register_filesystem(&PTR_s_configfs_00106c28);
      if (iVar1 == 0) {
        return 0;
      }
      printk(&DAT_00106650);
...
{
  unregister_filesystem(&PTR_s_configfs_00106c28);
  sysfs_remove_mount_point(_kernel_kobj,"config");
  kmem_cache_destroy(configfs_dir_cachep);
  configfs_dir_cachep = 0;
  return;
