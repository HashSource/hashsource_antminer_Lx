...

{
  ...
  __libc_start_main(FUN_0001180c,in_stack_00000000,&stack0x00000004,0x1189d,&DAT_000118d9,param_1);
...

{
  ...
  iVar1 = DAT_000220a8;
  sVar2 = strlen(acStack_78);
  local_14 = sendto(iVar1,acStack_78,sVar2,0,(sockaddr *)&DAT_000220e8,0x10);
  if (local_14 < 0) {
    printf("send error....");
  }
  else {
...

{
  ...
  sVar1 = sendto(DAT_000220a8,param_1,10,0,(sockaddr *)&DAT_000220e8,0x10);
  if (sVar1 < 0) {
    printf("send error....");
    uVar2 = extraout_r3;
  }
...

{
  ...
  fStack_98.fds_bits[(int)uVar2 >> 5] = fStack_98.fds_bits[(int)uVar2 >> 5] | 1 << (uVar3 & 0xff);
  local_14 = (char *)0x0;
  local_14 = (char *)calloc(0x1e,1);
  iVar1 = select(DAT_000220a8 + 1,&fStack_98,(fd_set *)0x0,(fd_set *)0x0,&local_a0);
  if (iVar1 != -1) {
    if (iVar1 == 0) {
      ...
      if ((1 << (uVar3 & 0xff) & fStack_98.fds_bits[(int)uVar2 >> 5]) != 0) {
        local_a4 = 0x10;
        local_18 = recvfrom(DAT_000220a8,local_14,0x1e,0,(sockaddr *)&DAT_000220d8,&local_a4);
        if (0 < local_18) {
          printf("rev:\n%s\t",local_14);
          DAT_000220d4 = 0;
...

{
  ...
  printf("monitor-ipsig compile %s--%s\n","Jan 14 2020","18:22:32",0,param_2,param_1);
  FUN_000110bc();
  do {
...
void FUN_0001189c(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
