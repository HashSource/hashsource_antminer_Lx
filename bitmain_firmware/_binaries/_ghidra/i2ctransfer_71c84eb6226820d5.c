  ...
  for (iVar5 = 0; iVar5 != param_2; iVar5 = iVar5 + 1) {
    ...
    if (uVar4 == 0) {
      ...
      while( true ) {
        ...
        if ((int)(param_1[2] - 1) <= (int)uVar3) break;
...
LAB_000110dc:
          ...
          if (*local_23c != 0) {
            if (*local_23c == 0x40) {
              ...
              if ((-1 < local_258) && ((iVar15 != 0 || (iVar20 = FUN_00011f18(iVar4,local_258,0), iVar20 == 0))))
              goto LAB_00010eb8;
            }
            else {
...

{
  ...
  __libc_start_main(FUN_00010c64,in_stack_00000000,&stack0x00000004,0x1202d,&DAT_00012069,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
            ...
            while( true ) {
              ...
              if (pFVar2 == (FILE *)0x0) {
                ...
                if (pFVar2 == (FILE *)0x0) {
                  ...
                  if (__dirp_00 == (DIR *)0x0) goto LAB_00011a60;
                  do {
                    while( true ) {
                      do {
                        pdVar11 = readdir64(__dirp_00);
                        if (pdVar11 == (dirent64 *)0x0) goto LAB_00011a60;
              ...
              *(int *)((int)pvVar1 + uVar14 * 0x10 + 4) = iVar3;
              if (iVar3 == 0) goto LAB_00011954;
              puVar13 = (&PTR_s_Dummy_bus_000126a4)[iVar9 * 2];
              *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 8) = (&PTR_s_dummy_000126a0)[iVar9 * 2];
              *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 0xc) = puVar13;
              pdVar11 = readdir64(__dirp);
              uVar14 = uVar12;
              if (pdVar11 == (dirent64 *)0x0) goto LAB_00011bb0;
            }
            fprintf(stderr,"%s: path truncated\n",local_128);
            goto LAB_00011a60;
          }
...

{
  ...
  if (__s1 != (char *)0x0) {
    ...
    if (uVar2 != 0xffffffff) goto LAB_00011e64;
  }
  uVar2 = 0xffffffff;
...
LAB_00012024:
    ...
    if (local_14[0] < 0x5a) {
      if (local_14[0] != 0x4e) goto LAB_00011fd8;
    }
    else if (local_14[0] != 0x6e) {
      if (local_14[0] != 0x79) goto LAB_00011fd8;
      goto LAB_00012024;
    }
    param_1 = 0;
  }
...
void FUN_0001202c(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
