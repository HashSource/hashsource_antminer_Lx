...
LAB_00010d50:
    ...
    __libc_start_main(FUN_00010920,in_stack_ffffff40,auStack_bc,0x11511,&DAT_0001154d,uVar4,auStack_bc);
                    /* WARNING: Subroutine does not return */
    abort();
  }
...

{
  ...
  __libc_start_main(FUN_00010920,in_stack_00000000,&stack0x00000004,0x11511,&DAT_0001154d,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
...
undefined4 FUN_00010f38(undefined4 param_1,uint param_2,int param_3,int param_4)

{
  ...
  while (param_3 = param_3 + -1, param_3 != 0) {
    while( true ) {
      ...
      param_3 = param_3 + -1;
      uVar2 = uVar2 + 1;
      if (param_3 == 0) goto LAB_00010fe4;
    }
    _IO_putc(iVar1,stdout);
  }
LAB_00010fe4:
...
int FUN_00011190(char *param_1,undefined4 param_2,undefined4 param_3,undefined4 *param_4)
...
void FUN_00011510(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
