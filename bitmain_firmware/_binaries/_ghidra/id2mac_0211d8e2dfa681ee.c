// Decompiled: id2mac_0211d8e2dfa681ee
...

{
  ...
  __libc_start_main(FUN_00010408,in_stack_00000000,&stack0x00000004,0x10835,&DAT_00010871,param_1);
...

{
  ...
  if (sVar1 == 0) {
    ...
    do {
      pbVar3 = pbVar4 + 1;
      uVar7 = *(uint *)(&DAT_0002103c + ((uint)*pbVar4 ^ uVar7 >> 8) * 4) & 0xffff ^ (uVar7 & 0xff) << 8;
      pbVar4 = pbVar3;
    ...
    do {
      pbVar3 = pbVar4 + 1;
      uVar5 = *(uint *)(&DAT_00010880 + ((uint)*pbVar4 ^ uVar5 >> 0x18) * 4) ^ uVar5 << 8;
      pbVar4 = pbVar3;
    } while (pbVar3 != param_1 + sVar1);
    uVar6 = uVar7 & 0xfe;
    uVar7 = uVar7 >> 8;
  ...
  sprintf(param_2,"%02x:%02x:%02x:%02x:%02x:%02x",uVar6,uVar7,uVar9,uVar5,uVar8,uVar2);
  return;
}
...
void FUN_00010834(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
