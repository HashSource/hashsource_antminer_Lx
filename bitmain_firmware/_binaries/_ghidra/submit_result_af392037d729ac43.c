...

{
  ...
  __libc_start_main(0x10e29,in_stack_00000000,&stack0x00000004,0x153ed,&DAT_00015429,param_1);
...

{
  ...
  if ((iVar1 < 0) || (iVar1 = setsockopt(param_1,1,0x14,&uStack_20,8), iVar1 < 0)) {
...

{
  ...
  iVar2 = 0;
  while (phVar3 = gethostbyname("mtcs.bitmain.com"), phVar3 == (hostent *)0x0) {
  ...
  if (piVar7 != (in_addr_t *)0x0) {
    ...
    do {
      ...
      pcVar6 = inet_ntoa((in_addr)**(in_addr_t **)((int)phVar3->h_addr_list + iVar2));
      __s = inet_ntoa((in_addr)**(in_addr_t **)((int)phVar3->h_addr_list + iVar2));
      __n = strlen(__s);
...
undefined1 FUN_000116f4(void *param_1,size_t param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  cVar2 = -5;
  printf("submit_result: %s","send_message_to_bitmain_MES_system",param_3,param_4,param_4);
  do {
...
undefined4 FUN_00011818(uint param_1,int param_2,code *param_3,undefined4 param_4,uint param_5)
...
LAB_0001186a:
    do {
      ...
      if (uVar6 < param_2 + param_1) {
        uVar2 = FUN_00013c8c(uVar6,(param_2 + param_1) - uVar6,&local_34);
        if (uVar2 == 0) {
          return 0xffffffff;
        }
        if ((((local_34 != 0x5c && local_34 != 0x22) && (0x1f < (int)local_34)) &&
            (((param_5 & 0x400) == 0 || (local_34 != 0x2f)))) && (((param_5 & 0x40) == 0 || ((int)local_34 < 0x80))))
        goto LAB_0001186a;
      }
      if ((uVar6 != uVar5) && (iVar1 = (*param_3)(uVar5,uVar6 - uVar5,param_4), iVar1 != 0)) {
        return 0xffffffff;
      }
      if (uVar2 == uVar6) {
...
LAB_00011860:
        ...
        if ((int)local_34 < 0xd) {
          if (local_34 == 9) {
            ...
            if (local_34 != 8) goto LAB_0001184c;
            uVar4 = 2;
            pcVar3 = "\\b";
          }
          goto LAB_00011860;
        ...
        if (0x22 < (int)local_34) {
          if (local_34 == 0x2f) {
            ...
            if (local_34 != 0x5c) goto LAB_0001184c;
            uVar4 = 2;
            pcVar3 = "\\\\";
          }
          goto LAB_00011860;
...
LAB_0001184c:
          if ((int)local_34 < 0x10000) {
            ...
            local_34 = uVar6;
            snprintf(acStack_30,0xd,"\\u%04X\\u%04X",uVar6 * 0x1000 >> 0x16 | 0xd800,uVar5 | 0xdc00);
            pcVar3 = acStack_30;
            uVar4 = 0xc;
          }
          goto LAB_00011860;
...
undefined4 FUN_000119e8(uint param_1,int param_2,int param_3,code *param_4,undefined4 param_5)

{
  ...
  if (uVar3 == 0) {
    if ((param_3 != 0) && (-1 < (int)(param_1 << 0x1a))) {
      uVar2 = (*param_4)(&DAT_00015c9c,1,param_5,param_1 << 0x1a,param_4);
      return uVar2;
    }
  }
  else {
...
undefined4
FUN_00011a48(undefined4 *param_1,uint param_2,int param_3,undefined4 param_4,code *param_5,undefined4 param_6)

{
  ...
  if (param_1 != (undefined4 *)0x0) {
    ...
    case 0:
      ...
      if ((iVar2 == 0) &&
         ((iVar2 = FUN_00013e80(param_1), uVar10 != 0 || (iVar12 = (*param_5)(&DAT_00015cd4,1,param_6), iVar12 == 0))))
      {
        if (iVar2 != 0) {
          iVar14 = param_3 + 1;
          ...
          if ((param_2 & 0x80) == 0) {
            while( true ) {
              ...
              sVar6 = strlen(pcVar5);
              FUN_00011818(pcVar5,sVar6,param_5,param_6,uVar9);
              iVar7 = (*param_5)(puVar15,uVar1,param_6);
              if (iVar7 != 0) {
                return 0xffffffff;
              }
              uVar4 = FUN_00013ec4(iVar2);
              iVar2 = FUN_00011a48(uVar4,uVar9,iVar14,param_4,param_5,param_6);
              if (iVar2 != 0) {
                return 0xffffffff;
              }
              if (iVar12 == 0) break;
              ...
              iVar7 = FUN_000119e8(uVar9,iVar14,1,param_5,param_6);
              iVar2 = iVar12;
              if (iVar7 != 0) {
                return 0xffffffff;
              }
            }
            iVar2 = FUN_000119e8(uVar9,param_3,0,param_5,param_6);
            if (iVar2 != 0) {
              return 0xffffffff;
            }
          }
            ...
            if (sVar6 != 0) {
              ...
              do {
                ...
                sVar8 = strlen(pcVar5);
                FUN_00011818(pcVar5,sVar8,param_5,param_6,uVar9);
                iVar12 = (*param_5)(puVar15,uVar1,param_6);
                if ((iVar12 != 0) || (iVar2 = FUN_00011a48(iVar2,uVar9,iVar14,param_4,param_5,param_6), iVar2 != 0)) {
LAB_00011e56:
                  FUN_0001383c(__base);
                  return 0xffffffff;
                }
                if (uVar3 < uVar11) {
                  iVar2 = (*param_5)(&DAT_00015cd0,1,param_6);
                  if (iVar2 != 0) goto LAB_00011e56;
                  iVar2 = FUN_000119e8(uVar9,iVar14,1,param_5,param_6);
                }
                else {
                  iVar2 = FUN_000119e8(uVar9,param_3,0,param_5,param_6);
                }
    ...
    case 1:
      iVar2 = FUN_00013db0(param_4,param_1,acStack_8c,0xb);
      if ((iVar2 == 0) &&
         ((uVar3 = FUN_00013f08(param_1), uVar10 != 0 || (iVar2 = (*param_5)(&DAT_00015cc8,1,param_6), iVar2 == 0)))) {
        if (uVar3 != 0) {
          iVar12 = param_3 + 1;
          ...
          do {
            ...
            iVar2 = FUN_00011a48(uVar1,uVar9,iVar12,param_4,param_5,param_6);
            if (iVar2 != 0) {
              return 0xffffffff;
            }
            if (uVar11 < uVar3 - 1) {
              ...
              iVar2 = FUN_000119e8(uVar9,iVar12,1,param_5,param_6);
            }
            else {
              iVar2 = FUN_000119e8(uVar9,param_3,0,param_5,param_6);
            }
...
LAB_00011bce:
    ...
    case 4:
      ...
      if (-1 < (int)uVar9) goto LAB_00011bce;
      break;
    case 5:
...
undefined4 FUN_00011ea4(uint *param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
undefined4 FUN_00011f54(undefined4 param_1,undefined4 param_2,undefined4 param_3)
  ...
  if (((uint)param_1 & 3) != 0) {
    if ((int)param_1 << 0x1f < 0) {
      if (0xc < param_2) {
        do {
          param_2 = param_2 - 0xc;
          uVar3 = uVar3 + (uint)*(byte *)((int)param_1 + 10) * 0x10000 + (uint)*(byte *)((int)param_1 + 9) * 0x100 +
                          (uint)(byte)param_1[2] + (uint)*(byte *)((int)param_1 + 0xb) * 0x1000000;
          uVar4 = (((uint)*(byte *)((int)param_1 + 2) * 0x10000 + (uint)*(byte *)((int)param_1 + 1) * 0x100 +
                    (uint)(byte)*param_1 + (uint)*(byte *)((int)param_1 + 3) * 0x1000000) - uVar3) + uVar4 ^
                  (uVar3 >> 0x1c | uVar3 * 0x10);
          iVar7 = uVar6 + (uint)*(byte *)((int)param_1 + 6) * 0x10000 + (uint)*(byte *)((int)param_1 + 5) * 0x100 +
                          (uint)(byte)param_1[1] + (uint)*(byte *)((int)param_1 + 7) * 0x1000000;
          param_1 = param_1 + 3;
          iVar1 = uVar3 + iVar7;
      ...
      switch(param_2) {
      case 0xc:
        uVar3 = uVar3 + (uint)*(byte *)((int)param_1 + 0xb) * 0x1000000;
      case 0xb:
      ...
      if (0xc < param_2) {
        do {
          param_2 = param_2 - 0xc;
          param_1 = puVar5 + 3;
          uVar3 = uVar3 + (uint)(ushort)puVar5[2] + (uint)*(ushort *)((int)puVar5 + 10) * 0x10000;
          iVar7 = uVar6 + (uint)(ushort)puVar5[1] + (uint)*(ushort *)((int)puVar5 + 6) * 0x10000;
          iVar1 = uVar3 + iVar7;
          uVar6 = uVar4 + (((uint)(ushort)*puVar5 + (uint)*(ushort *)((int)puVar5 + 2) * 0x10000) - uVar3) ^
                  (uVar3 >> 0x1c | uVar3 * 0x10);
          iVar8 = uVar6 + iVar1;
...
switchD_0001203e_caseD_2:
      ...
      case 5:
        uVar6 = uVar6 + (byte)param_1[1];
      case 4:
        uVar4 = (ushort)*param_1 + uVar4 + (uint)*(ushort *)((int)param_1 + 2) * 0x10000;
        break;
      case 7:
        uVar6 = uVar6 + (uint)*(byte *)((int)param_1 + 6) * 0x10000;
      case 6:
      ...
      case 10:
        ...
        break;
      case 0xc:
        uVar3 = (ushort)param_1[2] + uVar3 + (uint)*(ushort *)((int)param_1 + 10) * 0x10000;
        uVar6 = (ushort)param_1[1] + uVar6 + (uint)*(ushort *)((int)param_1 + 6) * 0x10000;
        uVar4 = (ushort)*param_1 + uVar4 + (uint)*(ushort *)((int)param_1 + 2) * 0x10000;
        break;
      default:
...

{
  ...
  if (*param_1 >> (uVar5 & 0xff) != 0) {
    ...
    *puVar1 = (uint)puVar1;
    ...
    if (puVar8 == puVar1) goto LAB_000124f4;
    while( true ) {
...
LAB_000124f4:
  ...
  if ((sVar4 < 0xffffffe7) && (iVar9 = FUN_00013828(sVar4 + 0x19), iVar9 != 0)) {
...
int FUN_000125c8(int param_1,char *param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  iVar3 = FUN_0001238c(param_1,*(int *)(param_1 + 4) + ((1 << (*(uint *)(param_1 + 8) & 0xff)) - 1U & uVar2) * 8,param_2
                       ,uVar2);
  if (iVar3 != 0) {
...
int FUN_0001271c(int param_1,char *param_2,undefined4 param_3,undefined4 param_4)
...

{
  ...
  if (param_1 != 0) goto LAB_000127d0;
...
undefined4 FUN_00012994(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
  ...
  if (uVar2 == 0) {
    ...
    *(char *)(param_1 + 2) = (char)uVar4;
    ...
    if (uVar7 < 0x80) {
      ...
      FUN_000128d8(param_2,param_1,5,"unable to decode byte 0x%x",uVar4);
      return 0xfffffffe;
    }
...
uint FUN_00012bd8(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
...

{
  ...
  if (uVar2 != 0xfffffffe) {
    ...
    if (((uVar2 == 0x7b || uVar2 == 0x7d) || (uVar2 == 0x5b || uVar2 == 0x5d)) || (uVar2 == 0x3a || uVar2 == 0x2c))
    goto LAB_00012d0c;
    if (uVar2 == 0x22) {
      *(undefined4 *)(param_1 + 0x40) = 0;
      *(undefined4 *)(param_1 + 0x3c) = 0xffffffff;
      ...
      while (uVar2 != 0x22) {
        if (uVar2 == 0xfffffffe) goto LAB_00012e84;
        if (uVar2 == 0xffffffff) {
        ...
        if (uVar2 < 0x20) {
          ...
          if (uVar2 == 10) {
            ...
            FUN_000128d8(param_2,param_1,8,"control character 0x%x",uVar2);
          }
          goto LAB_00012e84;
        }
        if (uVar2 == 0x5c) {
          ...
          if (uVar2 == 0x75) {
            ...
            do {
              ...
              if ((bVar13 && !bVar12) && (5 < uVar2 - 0x61)) goto LAB_000130f0;
              uVar2 = FUN_00012bd8(param_1,param_2);
              iVar8 = iVar8 + -1;
            } while (iVar8 != 0);
          }
          else {
            if (((uVar2 != 0x22 && uVar2 != 0x5c) && (uVar2 != 0x2f && uVar2 != 0x62)) &&
        ...
        while( true ) {
          ...
          if (bVar7 == 0x66) {
            *pbVar5 = 0xc;
            ...
            if (bVar7 != 0x5c) {
              if (0x5c < bVar7) {
                if (bVar7 != 0x62) goto LAB_00012f6e;
                *pbVar5 = 8;
                goto LAB_00012fba;
              }
...
LAB_00012fb8:
            ...
            *pbVar5 = 0xd;
            ...
            if (bVar7 != 0x74) {
              if (bVar7 != 0x6e) goto LAB_00012f6e;
              bVar7 = 10;
              goto LAB_00012fb8;
            }
            *pbVar5 = 9;
...
LAB_00012fba:
        ...
        if (iVar10 < 0) {
LAB_00013120:
          FUN_000128d8(param_2,param_1,8,"invalid Unicode escape \'%.6s\'",pbVar9);
          goto LAB_00012e84;
        }
        pbVar9 = pbVar11 + 6;
...
LAB_00013138:
            FUN_000128d8(param_2,param_1,8,"invalid Unicode \'\\u%04X\'",iVar10);
            goto LAB_00012e84;
          }
          iVar8 = FUN_000129e8(pbVar11 + 7);
          if (iVar8 < 0) goto LAB_00013120;
          pbVar9 = pbVar11 + 0xc;
          if (0x3ff < iVar8 - 0xdc00U) {
            FUN_000128d8(param_2,param_1,8,"invalid Unicode \'\\u%04X\\u%04X\'",iVar10,iVar8);
            goto LAB_00012e84;
          }
          iVar10 = (iVar8 - 0xdc00U) + (iVar10 - 0xd800U) * 0x400 + 0x10000;
        }
        else if (iVar10 - 0xdc00U < 0x400) goto LAB_00013138;
    ...
    if (!bVar12 || (uVar2 == 0x2d || uVar2 - 0x30 == 9)) {
      *(undefined4 *)(param_1 + 0x3c) = 0xffffffff;
      ...
      if (uVar2 == 0x30) {
        uVar2 = FUN_00012bd8(param_1,param_2);
        if (uVar2 - 0x30 < 10) goto LAB_00012f98;
      }
      else {
        if (9 < uVar2 - 0x30) {
          FUN_00012ba0(param_1,uVar2);
      ...
      if (((*(uint *)(param_1 + 0x34) & 8) == 0) && (uVar2 != 0x45 && uVar2 != 0x2e)) {
        if (uVar2 != 0x65) {
          FUN_00012ba0(param_1,uVar2);
          ...
          if (local_34 == pcVar3 + *(int *)(param_1 + 0x2c)) {
            ...
            *(undefined4 *)(param_1 + 0x3c) = 0x101;
            return 0x101;
                    ...
                    /* WARNING: Subroutine does not return */
          __assert_fail("end == saved_text + lex->saved_text.length","load.c",0x202,"lex_scan_number");
        }
      }
      else {
        if (uVar2 == 0x2e) {
        ...
        if ((uVar2 & 0xffffffdf) != 0x45) goto LAB_00012dbe;
      }
      uVar2 = FUN_00012bd8(param_1,param_2);
...

{
  ...
  *(uint *)(param_1 + 0x38) = uVar4;
  ...
  if (iVar5 == 0x101) {
    iVar5 = FUN_00014150(*(undefined4 *)(param_1 + 0x40),*(undefined4 *)(param_1 + 0x44));
  }
  else if (iVar5 < 0x102) {
    if (iVar5 == 0x5b) {
      iVar5 = FUN_00013ed4();
      ...
      if (iVar3 != 0x5d) {
        while (iVar3 != 0) {
          ...
          if ((iVar3 == 0) || (iVar3 = FUN_0001483c(iVar5,iVar3), iVar3 != 0)) goto LAB_000133f2;
          FUN_00012bfc(param_1,param_3);
          if (*(int *)(param_1 + 0x3c) != 0x2c) {
            if (*(int *)(param_1 + 0x3c) == 0x5d) goto LAB_00013284;
            break;
          }
          FUN_00012bfc(param_1,param_3);
          iVar3 = *(int *)(param_1 + 0x3c);
            ...
            *(undefined4 *)(param_1 + 0x44) = 0;
            ...
            while( true ) {
              ...
              if (pvVar2 != (void *)0x0) {
                ...
                FUN_000128d8(param_3,param_1,0xd,"NUL byte in object key not supported");
                goto LAB_0001346a;
              }
              if (((param_2 & 1) != 0) && (iVar3 = FUN_00013e38(iVar5), iVar3 != 0)) {
                FUN_0001383c(pvVar8);
                FUN_000128d8(param_3,param_1,0xe,"duplicate object key");
                goto LAB_0001346a;
              }
              FUN_00012bfc(param_1,param_3);
              ...
              FUN_00012bfc(param_1,param_3);
              if (*(int *)(param_1 + 0x3c) != 0x100) goto LAB_0001345e;
              pvVar8 = *(void **)(param_1 + 0x40);
              sVar7 = *(size_t *)(param_1 + 0x44);
              *(undefined4 *)(param_1 + 0x40) = 0;
              *(undefined4 *)(param_1 + 0x44) = 0;
            ...
            if (*(int *)(param_1 + 0x3c) == 0x7d) goto LAB_00013284;
            FUN_000128d8(param_3,param_1,8,"\'}\' expected");
          }
          else {
LAB_0001345e:
            FUN_000128d8(param_3,param_1,8,"string or \'}\' expected");
          }
LAB_0001346a:
          if (*(int *)(iVar5 + 4) == -1) {
            return 0;
        ...
        if (iVar5 != 0x100) goto LAB_00013232;
        pvVar8 = *(void **)(param_1 + 0x40);
        sVar7 = *(size_t *)(param_1 + 0x44);
        if (((param_2 & 0x10) == 0) && (pvVar2 = memchr(pvVar8,0,sVar7), pvVar2 != (void *)0x0)) {
          FUN_000128d8(param_3,param_1,0xb,"\\u0000 is not allowed without JSON_ALLOW_NUL");
          return 0;
        }
    ...
    if (iVar5 != 0x105) goto LAB_00013232;
    iVar5 = FUN_00014270();
  }
LAB_00013284:
  if (iVar5 != 0) {
...

{
  ...
  *(undefined4 *)(param_1 + 0x38) = 0;
  ...
  if (((param_2 & 4) == 0) && ((*(uint *)(param_1 + 0x3c) & 0xffffffdf) != 0x5b)) {
    ...
    if (iVar2 != 0) {
      if (((int)(param_2 << 0x1e) < 0) || (FUN_00012bfc(param_1,param_3), *(int *)(param_1 + 0x3c) == 0)) {
        if (param_3 != 0) {
...
undefined4 FUN_00013604(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
...

{
  ...
  if (param_1 == (char *)0x0) {
    ...
    if (__stream == (FILE *)0x0) {
      ...
      FUN_000128d8(param_3,0,3,"unable to open %s: %s",param_1,pcVar3);
      uVar1 = 0;
    }
    else {
...

{
  ...
  if ((param_2 != 0xffffffff) && (__dest = (void *)(*DAT_000270f8)(), __dest != (void *)0x0)) {
...

{
  ...
  *piVar4 = 0;
  ...
  if (local_1c[0] == (char *)(*param_1 + param_1[1])) {
    if (((dVar6 <= 1.79769313486232e+308) && (-1 < (int)((uint)(dVar6 < -1.79769313486232e+308) << 0x1f))) ||
       (*piVar4 != 0x22)) {
      uVar5 = 0;
      *param_2 = dVar6;
    }
...

{
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    if (pcVar5 != (char *)0x0) goto LAB_00013ab4;
    if (param_2 <= pcVar2 + 3) {
      return (char *)0xffffffff;
    }
    pcVar4 = pcVar2 + 2;
...

{
  ...
  if (param_2 != 0) {
    ...
    if ((uVar3 == 0) ||
       ((uVar2 = (uint)bVar1, uVar3 != 1 &&
        ((param_2 < uVar3 || (iVar4 = FUN_00013bf4(param_1,uVar3,&local_1c), uVar2 = local_1c, iVar4 == 0)))))) {
      param_1 = (byte *)0x0;
    }
    else {
      local_1c = uVar2;
...
undefined4 FUN_00013db0(undefined4 param_1,undefined4 param_2,char *param_3,size_t param_4)
...
undefined4 FUN_00013f38(int *param_1,int *param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if ((((param_1 != (int *)0x0) && (*param_1 == 1)) && (param_2 != (int *)0x0)) &&
     ((*param_2 == 1 && (iVar2 = FUN_00013d64(param_1,param_2[3],1,1,param_4), iVar2 != 0)))) {
    uVar3 = param_2[3];
    uVar4 = 0;
...
undefined4 FUN_00013fd8(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
...
undefined4 FUN_00014064(undefined4 param_1,char *param_2,undefined4 param_3,undefined4 param_4)
...

{
  ...
  if ((param_2 != 0) && (iVar1 = FUN_00013cd8(param_2,param_3), iVar1 != 0)) {
...
undefined4 FUN_000140b0(undefined4 param_1,char *param_2,undefined4 param_3,undefined4 param_4)
...

{
  ...
  if (((iVar1 == 0) && (iVar1 = __isinf(in_d0), iVar1 == 0)) &&
     (puVar2 = (undefined4 *)FUN_00013828(0x10), puVar2 != (undefined4 *)0x0)) {
...

{
  ...
  if (((param_1 == (int *)0x0) || (*param_1 != 1)) || (uVar4 = param_1[3], uVar4 <= param_2)) {
    uVar3 = 0xffffffff;
  }
  else {
    ...
    uVar4 = uVar4 - 1;
    if (param_2 < uVar4) {
      memmove((void *)(param_1[4] + param_2 * 4),(void *)(param_1[4] + (param_2 + 1) * 4),(uVar4 - param_2) * 4);
      uVar4 = param_1[3] - 1;
    }
    uVar3 = 0;
    param_1[3] = uVar4;
    ...
    if (((param_1 == (int *)0x0) || (*param_1 != 1)) || (param_1 == param_3)) {
      ...
      *piVar3 = iVar2;
      ...
      if (__src != (void *)0x0) {
        ...
        if (__dest == __src) {
          memmove((void *)((int)__dest + (param_2 + 1) * 4),(void *)((int)__dest + param_2 * 4),
                  (param_1[3] - param_2) * 4);
        }
        else {
...

{
  ...
  if ((((param_1 == (int *)0x0) || (*param_1 != 0)) || (param_2 == (int *)0x0)) ||
     ((*param_2 != 0 || (iVar2 = FUN_00013db0(param_3,param_2,auStack_2c,0xb), iVar2 != 0)))) {
    uVar6 = 0xffffffff;
  }
  else {
    FUN_00013e80(param_2);
...
undefined4 FUN_0001483c(int *param_1,int *param_2,undefined4 param_3,undefined4 param_4)
  ...
  if (param_1 != (int *)0x0 && param_2 != (int *)0x0) {
    ...
    case 2:
      if (param_1[3] == param_2[3]) {
        uVar1 = memcmp((void *)param_1[2],(void *)param_2[2],param_1[3]);
        uVar2 = 1 - uVar1;
        if (1 < uVar1) {
          uVar2 = 0;
        }
...
int * FUN_00014a94(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (param_1 != (int *)0x0) {
    ...
    case 1:
      ...
      if (((piVar3 != (int *)0x0) && (*param_1 == 1)) && (uVar6 = param_1[3], uVar6 != 0)) {
        uVar7 = 0;
        do {
          iVar4 = 0;
          if (uVar7 < uVar6) {
      ...
      break;
    case 2:
      piVar3 = (int *)FUN_00013fc8(param_1[2],param_1[3],param_3,param_4);
      return piVar3;
    case 3:
      piVar3 = (int *)FUN_00014150(param_1[2],param_1[3],param_3,param_4);
      return piVar3;
    case 4:
...
switchD_00014ba2_default:
  ...
  case 1:
    ...
    if (iVar2 == 0) {
      piVar3 = (int *)FUN_00013ed4();
      if (piVar3 != (int *)0x0) {
        if ((*param_1 != 1) || (param_1[3] == 0)) goto LAB_00014bd2;
        uVar6 = 0;
        uVar8 = 0;
        if (param_1[3] != 0) goto LAB_00014cd6;
        while( true ) {
          uVar6 = FUN_00014b90(uVar6,param_2);
          iVar2 = FUN_0001483c(piVar3,uVar6);
          if (iVar2 != 0) break;
          if (*param_1 != 1) goto LAB_00014bd2;
          uVar8 = uVar8 + 1;
          if ((uint)param_1[3] <= uVar8) goto LAB_00014bd2;
          uVar6 = 0;
...
void FUN_00014da8(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined1 param_5,
...

{
  ...
  uVar2 = (*(code *)(&UNK_00014e28 + (0x1f - (LZCOUNT(param_2) - LZCOUNT(param_1))) * 0x10))(param_1,param_2,0);
  return uVar2;
}
...
void FUN_000153ec(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
