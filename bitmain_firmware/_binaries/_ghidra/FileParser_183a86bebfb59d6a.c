...

{
    ...
    __libc_start_main(FUN_000137e0, in_stack_00000000, &stack0x00000004,
                      0x13bc5, &DAT_00013c01, param_1);
...

{
    ...
    if (local_10 == (FILE *)0x0) {
        ...
        for (local_c = 0; local_c < 0xf; local_c = local_c + 1) {
            fread(&local_8014, *(size_t *)(&DAT_00025080 + local_c * 0x84), 1,
                  local_10);
            local_14 = fopen64(s__tmp_tmpNand_devicetree_dtb_sig_00025084 +
                                   local_c * 0x84,
                               "wb");
            if (local_14 == (FILE *)0x0) {
                printf("Try To Write To File \'%s\' Failed!\n",
                       s__tmp_tmpNand_devicetree_dtb_sig_00025084 +
                           local_c * 0x84);
                if (local_10 != (FILE *)0x0) {
                    fclose(local_10);
                }
            ...
            fwrite(&local_8014, *(size_t *)(&DAT_00025080 + local_c * 0x84), 1,
                   local_14);
            if (local_14 != (FILE *)0x0) {
                fclose(local_14);
            }
...
undefined4 FUN_00010ca8(void *param_1, size_t param_2, uchar *param_3,
                        void *param_4)
...
undefined4 FUN_00010e20(FILE *param_1, int param_2, undefined4 *param_3,
...
undefined8 FUN_000115d0(uint param_1, uint param_2, uint param_3, uint param_4,
...

{
    ...
    if (param_2 < 8) {
        ...
        lVar6 = FUN_000115d0((int)lVar8, (int)((ulonglong)lVar8 >> 0x20),
...

{
    ...
    uVar1 =
        FUN_000115d0((int)lVar8, (int)((ulonglong)lVar8 >> 0x20), (int)lVar6,
...

{
    ...
    lVar9 = FUN_0001154c((int)(lVar5 + lVar6),
    ...
    lVar6 =
        FUN_000115d0((int)lVar8, (int)((ulonglong)lVar8 >> 0x20), (int)lVar7,
    ...
    lVar5 = FUN_0001154c((int)(lVar10 + lVar5),
                         (int)((ulonglong)(lVar10 + lVar5) >> 0x20), 0x12);
    lVar8 = lVar8 + lVar5 + lVar9 * lVar1;
    uVar2 =
        FUN_000115d0((int)lVar7, (int)((ulonglong)lVar7 >> 0x20), (int)lVar8,
                     (int)((ulonglong)lVar8 >> 0x20), iVar3, iVar4);
    return uVar2;
}

int *FUN_00011ff4(int *param_1, undefined4 param_2, uint param_3, int param_4,
...
undefined4 FUN_00012114(undefined4 param_1, int param_2, undefined4 param_3,
...

{
    ...
    FUN_00011ff4(param_1, (int)((ulonglong)uVar4 >> 0x20), (int)uVar1,
...

{
    ...
    if (param_2 < 0x11) {
        ...
        do {
            ...
            lVar12 = FUN_0001154c((int)lVar11, (int)((ulonglong)lVar11 >> 0x20),
                                  0x25);
            ...
            lVar11 = FUN_0001154c((int)lVar12, (int)((ulonglong)lVar12 >> 0x20),
                                  0x2a);
            ...
            lVar12 = FUN_0001154c((int)lVar12, (int)((ulonglong)lVar12 >> 0x20),
                                  0x21);
            local_38 = lVar12 * -0x4b6d499041670d8d;
            FUN_00012114(&local_60, local_74,
            ...
            FUN_00012114(&local_70, iVar3, (int)lVar12,
        ...
        local_28 =
            FUN_0001154c((int)lVar13, (int)((ulonglong)lVar13 >> 0x20), 0x25);
        local_28 = local_28 * CONCAT44(local_4c, local_50);
        lVar11 = local_30 + CONCAT44(iStack_54, local_58);
        lVar12 = FUN_000114c8(local_74 + 0x30);
        lVar12 = lVar12 + lVar11;
        lVar12 =
            FUN_0001154c((int)lVar12, (int)((ulonglong)lVar12 >> 0x20), 0x2a);
        ...
        local_38 = FUN_0001154c(local_70 + (uint)local_38,
        ...
        lVar12 = local_38 + CONCAT44(uStack_64, local_68);
        lVar11 = FUN_000114c8(local_74 + 0x10);
        FUN_00012114(&local_88, iVar3, (int)lVar12,
                     (int)((ulonglong)lVar12 >> 0x20), lVar11 + local_30);
        local_70 = local_88;
        iStack_6c = uStack_84;
        local_68 = uStack_80;
        ...
        local_28._0_4_ = uVar6;
        local_28._4_4_ = uVar5;
        lVar12 = FUN_000115d0(local_60, iStack_5c, local_88, uStack_84,
                              local_50, local_4c);
        ...
        lVar11 = FUN_000115d0(local_58, iStack_54, local_68, uStack_64,
                              local_50, local_4c);
        lVar11 = lVar11 + CONCAT44(local_28._4_4_, (uint)local_28);
        uVar10 = FUN_000115d0((int)lVar12, (int)((ulonglong)lVar12 >> 0x20),
...
int FUN_00012c78(char *param_1, char *param_2, char *param_3, char *param_4,
                        ...
                        if (local_14 == local_24) {
                            ...
                            if (local_3c == (FILE *)0x0) {
                                ...
                                local_40 = (uint)CONCAT11(param_4[0x16],
                                                          param_4[0x17]);
                                local_44 =
                                    FUN_00010ca8(param_4 + 0x18, local_40,
                                    ...
                                    if (local_50 == (RSA *)0x0) {
                                        ...
                                        if (local_54 == 1) {
                                            ...
                                            if (param_4 == (char *)0xfffffff3) {
                                                ...
                                                printf("fwVer: %s\r\n",
                                                       param_4 + 0xd);
                                                iVar4 = strncmp(param_4 + 0xd,
                                                                "sweep", 5);
                                                if (iVar4 == 0) {
                                                    puts("All Done! this is a "
                                                         "sweep version! \r");
                                                    local_44 = 100;
                                                } else {
                                                    puts(
                                                        "All Done! this is not "
                                                        "a sweep version! \r");
                                                    local_44 = 0;
                                                }
                                            }
...

{
    ...
    if (param_1 < 2) {
        ...
        case 0x66:
            local_10 = FUN_00012c78(local_190, local_110, local_210,
...
void FUN_00013bc4(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
