...
LAB_00010cf8:
      ...
      if (((param_1 <= iVar6 + 2) || (iVar4 = FUN_00011d70(param_2[iVar10]), iVar4 < 0)) ||
...

{
  ...
  __libc_start_main(FUN_00010c00,in_stack_00000000,&stack0x00000004,0x11fd9,&DAT_00012015,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
            ...
            while( true ) {
              ...
              if (pFVar2 == (FILE *)0x0) {
                ...
                if (pFVar2 == (FILE *)0x0) {
                  ...
                  if (__dirp_00 == (DIR *)0x0) goto LAB_00011a0c;
                  do {
                    while( true ) {
                      do {
                        pdVar11 = readdir64(__dirp_00);
                        if (pdVar11 == (dirent64 *)0x0) goto LAB_00011a0c;
              ...
              *(int *)((int)pvVar1 + uVar14 * 0x10 + 4) = iVar3;
              if (iVar3 == 0) goto LAB_00011900;
              puVar13 = (&PTR_s_Dummy_bus_000125b4)[iVar9 * 2];
              *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 8) = (&PTR_s_dummy_000125b0)[iVar9 * 2];
              *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 0xc) = puVar13;
              pdVar11 = readdir64(__dirp);
              uVar14 = uVar12;
              if (pdVar11 == (dirent64 *)0x0) goto LAB_00011b5c;
            }
            fprintf(stderr,"%s: path truncated\n",local_128);
            goto LAB_00011a0c;
          }
...

{
  ...
  if (__s1 != (char *)0x0) {
    ...
    if (uVar2 != 0xffffffff) goto LAB_00011e10;
  }
  uVar2 = 0xffffffff;
...
LAB_00011fd0:
    ...
    if (local_14[0] < 0x5a) {
      if (local_14[0] != 0x4e) goto LAB_00011f84;
    }
    else if (local_14[0] != 0x6e) {
      if (local_14[0] != 0x79) goto LAB_00011f84;
      goto LAB_00011fd0;
    }
    param_1 = 0;
  }
...
void FUN_00011fd8(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
