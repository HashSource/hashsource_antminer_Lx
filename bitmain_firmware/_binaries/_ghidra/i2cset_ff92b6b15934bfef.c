...

{
  ...
  __libc_start_main(&LAB_00010d44,in_stack_00000000,&stack0x00000004,0x126e5,&DAT_00012721,param_1);
...
uint FUN_00011d60(undefined4 param_1,char *param_2,size_t param_3,int param_4)
            ...
            while( true ) {
              ...
              if (pFVar2 == (FILE *)0x0) {
                ...
                if (pFVar2 == (FILE *)0x0) {
                  ...
                  if (__dirp_00 == (DIR *)0x0) goto LAB_00012118;
                  do {
                    while( true ) {
                      do {
                        pdVar11 = readdir64(__dirp_00);
                        if (pdVar11 == (dirent64 *)0x0) goto LAB_00012118;
              ...
              if (iVar9 == 0) goto LAB_00012118;
              iVar9 = strncmp(acStack_3a0,"ISA ",4);
              if (iVar9 == 0) {
                iVar9 = 1;
              }
              else {
                iVar3 = FUN_00011d60(local_3bc,auStack_3b4,0x14,1);
                if (iVar3 < 0) {
                  iVar9 = 4;
                }
                else {
              ...
              uVar12 = uVar14 + 1;
              if (((uVar12 & 7) == 0) && (pvVar1 = (void *)FUN_00011c60(pvVar1,uVar12), pvVar1 == (void *)0x0)) {
                return (void *)0x0;
              }
              *(undefined4 *)((int)pvVar1 + uVar14 * 0x10) = local_3bc;
              iVar3 = __strdup(acStack_3a0);
              *(int *)((int)pvVar1 + uVar14 * 0x10 + 4) = iVar3;
              if (iVar3 == 0) goto LAB_0001200c;
              puVar13 = (&PTR_s_Dummy_bus_00012e3c)[iVar9 * 2];
              *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 8) = (&PTR_s_dummy_00012e38)[iVar9 * 2];
              *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 0xc) = puVar13;
              pdVar11 = readdir64(__dirp);
              uVar14 = uVar12;
              if (pdVar11 == (dirent64 *)0x0) goto LAB_00012268;
            }
            fprintf(stderr,"%s: path truncated\n",local_128);
            goto LAB_00012118;
          }
LAB_00012268:
      ...
      while( true ) {
        ...
        *pcVar6 = '\0';
        ...
        if (((uVar14 & 7) == 0) && (pvVar1 = (void *)FUN_00011c60(pvVar1,uVar14), pvVar1 == (void *)0x0)) {
          return (void *)0x0;
        }
...

{
  ...
  if (__s1 != (char *)0x0) {
    ...
    if (uVar2 != 0xffffffff) goto LAB_0001251c;
  }
  uVar2 = 0xffffffff;
...
LAB_000126dc:
    ...
    if (local_14[0] < 0x5a) {
      if (local_14[0] != 0x4e) goto LAB_00012690;
    }
    else if (local_14[0] != 0x6e) {
      if (local_14[0] != 0x79) goto LAB_00012690;
      goto LAB_000126dc;
    }
    param_1 = 0;
  }
...
void FUN_000126e4(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
