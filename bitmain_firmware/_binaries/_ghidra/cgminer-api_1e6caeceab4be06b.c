...

{
  ...
  __libc_start_main(&DAT_000106f4,in_stack_00000000,&stack0x00000004,0x10d9d,&DAT_00010dd9,param_1);
...
LAB_00010b18:
              ...
              *pcVar1 = '\0';
              pcVar7 = pcVar1 + 1;
              if (iVar5 == 0) {
                if (pcVar7 == (char *)0x0) goto LAB_00010b38;
              ...
              else if (pcVar7 == (char *)0x0) goto LAB_00010b18;
              printf("   [%s] => %s\n",param_1,pcVar7);
            }
          }
          else {
            pcVar4 = pcVar1 + 1;
            *pcVar1 = '\0';
            if (*param_1 != '\0') goto LAB_00010a58;
          }
          param_1 = pcVar4;
          iVar5 = iVar5 + 1;
        ...
        pcVar6 = pcVar1 + 1;
        *pcVar1 = '\0';
        if (*param_1 != '\0') goto LAB_00010a34;
      }
      param_1 = pcVar6;
    } while (param_1 != (char *)0x0);
  }
...
void FUN_00010d9c(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
