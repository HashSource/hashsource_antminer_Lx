unsigned __int64 __fastcall sub_11700(unsigned __int8 *a1, unsigned int a2)
{
  ...
  if ( a2 <= 7 )
  {
    ...
    {
      v9 = a2 + 8LL * (unsigned int)sub_11498((int)a1);
      v4 = sub_11498((int)&a1[a2 - 4]);
      return sub_115D0(v9, SHIDWORD(v9), (unsigned int)v4, 2 * a2 - 0x651E95C4D06FBFB1LL);
    }
  }
  else
  {
    v15 = 2 * a2 - 0x651E95C4D06FBFB1LL;
    v14 = sub_114C8(a1) - 0x651E95C4D06FBFB1LL;
    v13 = sub_114C8(&a1[a2 - 8]);
    v12 = v14 + v15 * sub_1154C(v13, 37);
    v2 = sub_1154C(v14, 25);
    return sub_115D0(v12, SHIDWORD(v12), (v2 + v13) * v15, v15);
  }
  return v3;
}
