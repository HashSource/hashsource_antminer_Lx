int __fastcall sub_12C78(const char *a1, char *a2, const char *a3, _BYTE *a4, char a5, char a6, char a7)
{
  size_t v8; // r0
  int v9; // r0
  const char *v10; // r0
  ...
  if ( v28 >= 2048 )
  {
    ...
    if ( stream )
    {
      ...
      if ( *a4 == 38 )
      {
        printf("miner_type %s\n", a2);
        v8 = strlen(a2);
        v40 = sub_121B8((unsigned __int8 *)a2, v8);
            ...
            if ( v48 == (unsigned __int8)a4[1304] )
            {
              ...
              if ( v46 == v42 )
              {
                ...
                if ( v37 )
                {
                  ...
                  v35 = sub_10CA8((int)(a4 + 24), n, (int)(a4 + 1048), (int)v25);
                  if ( v35 )
                  {
                  ...
                  else
                  {
                    ...
                    for ( k = 0; k < v48; ++k )
                    {
                      ...
                      sub_10E20(stream, v30, &v24[2 * k + 2], a4[5 * k + 1309], 0, a5);
                    }
                    for ( m = 0; m < v48; ++m )
                      sub_10E20(stream, 256, &v24[2 * v48 + 2 + 2 * m], a4[5 * m + 1309], 1, a5);
