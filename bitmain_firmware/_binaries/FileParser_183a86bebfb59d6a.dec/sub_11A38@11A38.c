unsigned __int64 __fastcall sub_11A38(int a1, int a2)
{
  __int64 v2; // r0
  __int64 v3; // r2
  __int64 v4; // r0
  ...
  v15 = v3;
  v14 = sub_114C8((const void *)(a1 + 8));
  v13 = sub_114C8((const void *)(a1 + a2 - 8)) * v16;
  v4 = sub_114C8((const void *)(a1 + a2 - 16));
  v5 = 797982799LL * (unsigned int)v4;
  HIDWORD(v5) += 797982799 * HIDWORD(v4) - 1696503237 * v4;
  v12 = v5;
  v6 = sub_1154C(v15 + v14, 43);
  v9 = v6 + sub_1154C(v13, 30) + v12;
  v8 = sub_1154C(v14 - 0x651E95C4D06FBFB1LL, 18) + v15 + v13;
  return sub_115D0(v9, SHIDWORD(v9), v8, v16);
}
