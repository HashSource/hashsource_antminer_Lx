unsigned __int64 __fastcall sub_11C18(int a1, int a2)
{
  __int64 v2; // r0
  __int64 v3; // r2
  __int64 v4; // r0
  ...
  v2 = sub_114C8((const void *)a1);
  v3 = 797982799LL * (unsigned int)v2;
  HIDWORD(v3) += 797982799 * HIDWORD(v2) - 1696503237 * v2;
  v23 = v3;
  v22 = sub_114C8((const void *)(a1 + 8));
  v21 = sub_114C8((const void *)(a1 + a2 - 8)) * v24;
  v4 = sub_114C8((const void *)(a1 + a2 - 16));
  v5 = 797982799LL * (unsigned int)v4;
  HIDWORD(v5) += 797982799 * HIDWORD(v4) - 1696503237 * v4;
  v20 = v5;
  v6 = sub_1154C(v23 + v22, 43);
  v19 = v20 + v6 + sub_1154C(v21, 30);
  v11 = sub_1154C(v22 - 0x651E95C4D06FBFB1LL, 18) + v23 + v21;
  v18 = sub_115D0(v19, SHIDWORD(v19), v11, v24);
  v17 = sub_114C8((const void *)(a1 + 16)) * v24;
  v16 = sub_114C8((const void *)(a1 + 24));
  v15 = (sub_114C8((const void *)(a1 + a2 - 32)) + v19) * v24;
  v14 = (sub_114C8((const void *)(a1 + a2 - 24)) + v18) * v24;
  v7 = sub_1154C(v17 + v16, 43);
  v10 = v7 + sub_1154C(v15, 30) + v14;
  v9 = sub_1154C(v16 + v23, 18) + v17 + v15;
  return sub_115D0(v10, SHIDWORD(v10), v9, v24);
}
