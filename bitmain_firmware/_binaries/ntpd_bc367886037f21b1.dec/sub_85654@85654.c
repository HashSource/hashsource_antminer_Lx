int __fastcall sub_85654(int a1, char *src, int *a3)
{
...
LABEL_21:
    if ( (*(_DWORD *)(a1 + 12) & 4) != 0 )
    {
      fprintf(stderr, off_B74DC[0], *(_DWORD *)(a1 + 28), v3);
      v28 = a1;
      goto LABEL_51;
    }
    return -1;
  ...
  do
  {
    ...
    if ( v15 )
    {
      ...
      if ( v17 )
      {
        ...
        v18 = (unsigned __int8 *)v10[14];
        if ( v18 && !sub_855A8(v3, v18, v6) )
        {
          if ( !*(_BYTE *)(v10[14] + v6) )
          {
            v30 = v14;
...
LABEL_46:
              if ( (*(_DWORD *)(a1 + 12) & 4) != 0 )
              {
                fprintf(stderr, off_B74C0[0], *(_DWORD *)(a1 + 28), v29[13]);
                if ( v29[11] )
                  fprintf(stderr, " -- %s");
                fputc(10, stderr);
LABEL_50:
...
LABEL_8:
  ...
  if ( v13 )
  {
    if ( v13 != 1 )
    {
      if ( (*(_DWORD *)(a1 + 12) & 4) != 0 )
      {
        fprintf(stderr, off_B74A4[0], *(_DWORD *)(a1 + 24), v3, v13);
        if ( v13 <= 4 )
        {
          ...
          v23 = 0;
          v24 = *(_DWORD *)(a1 + 68);
          fputs(off_B74A0[0], stderr);
          do
          {
            v25 = *(unsigned __int8 **)(v24 + 52);
            if ( v25 )
            {
              if ( sub_855A8(v3, v25, v21) )
              {
                v26 = *(unsigned __int8 **)(v24 + 56);
                if ( v26 )
                {
                  if ( !sub_855A8(v3, v26, v21) )
                    fprintf(stderr, "  %s%s\n", v22, *(_DWORD *)(v24 + 56));
                }
              }
              else
...
LABEL_42:
  ...
  if ( v36 || (v27 & 3) != 0 || (v31 = *(unsigned __int16 *)(a1 + 98), v31 == 0x8000) )
  {
    if ( (v27 & 4) != 0 )
    {
      fprintf(stderr, off_B74CC[0], *(_DWORD *)(a1 + 24), v3);
      v28 = a1;
      goto LABEL_51;
    }
    return -1;
