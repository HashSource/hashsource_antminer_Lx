bool __fastcall sub_4B278(int a1, int a2, int a3)
{
  __int16 *v3; // r5
  int v5; // r3
  int (**v8)(); // r2
  ...
  int (**v17)(); // r9
  int (**v18)(); // r2
  char v19[120]; // [sp+Ch] [bp-80h] BYREF
...
LABEL_14:
  if ( write(*(_DWORD *)(a2 + 28), v11, v12) != v12 )
    sub_3918C((__int16 *)a1, 3);
  v15 = *v3;
  if ( off_B36E4[5 * v15 + 138] == (int (*)())&byte_6 )
  {
    v16 = *(__int16 *)(a3 + 406);
    if ( v16 > 4 )
    {
