int __fastcall sub_18740(const struct sockaddr *a1)
{
  char *v2; // r4
  int sa_family; // r1
  int v5; // r3
...
LABEL_14:
      ...
      v8 = *(unsigned __int16 *)sub_65080(v2 + 24);
      if ( *(unsigned __int16 *)sub_65080(a1) == v8 )
      {
        v9 = *(unsigned __int16 *)sub_65080(v2 + 24);
        v10 = v2 + 24;
        if ( v9 == 2 )
        {
          v15 = *(_DWORD *)(sub_65080(v10) + 4);
          v14 = *(_DWORD *)(sub_65080(a1) + 4) == v15;
        }
        else
        {
          v11 = sub_65080(v10);
          ...
          if ( memcmp((const void *)(v11 + 8), (const void *)(v12 + 8), 0x10u) )
            goto LABEL_29;
          v13 = *(_DWORD *)(sub_65080(v2 + 24) + 24);
          v14 = *(_DWORD *)(sub_65080(a1) + 24) == v13;
        }
        if ( v14 )
          return (int)v2;
      }
