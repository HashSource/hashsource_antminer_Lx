int __fastcall sub_6EA50(const char *a1, int a2, int a3, const char *a4)
{
  const char *v8; // r11
  ...
  if ( sub_6EC88(v22, 128, &v19) )
  {
    v15 = stderr;
    v16 = sub_6E9AC(a3);
    v17 = (const char *)sub_73430(isc_msgcat, 1, 101, "failed");
  ...
  else
  {
    ...
    v9 = stderr;
    v10 = sub_6E9AC(a3);
    v11 = (const char *)sub_73430(isc_msgcat, 1, 101, "failed");
