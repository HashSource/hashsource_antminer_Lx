int __fastcall sub_16874(struct sockaddr *addr, int a2, int a3, unsigned __int8 *buf, size_t n)
{
  int result; // r0
  int v8; // r7
  bool v10; // zf
...
LABEL_14:
      ...
      v17 = (const char *)sub_6BF44(a2 + 24);
      sub_64A18(3, "setsockopt IP_MULTICAST_TTL/IPV6_MULTICAST_HOPS fails on address %s: %m", v17);
      v12 = *(_DWORD *)(a2 + 12);
    }
LABEL_15:
    if ( addr->sa_family == 2 )
