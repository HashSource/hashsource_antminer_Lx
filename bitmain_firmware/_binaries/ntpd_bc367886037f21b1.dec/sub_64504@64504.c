char *__fastcall sub_64504(int a1, char *s)
{
  int v4; // r5
  char *v5; // r0
  int v6; // r5
  ...
  v14 = 0;
  v4 = progname;
  if ( progname != dword_106108 )
  {
    dword_106108 = progname;
    v5 = strrchr((const char *)progname, 47);
    if ( v5 )
      dword_10610C = (int)(v5 + 1);
    else
      dword_10610C = v4;
  }
  v6 = syslogit;
  ...
  if ( v7 )
  {
    ...
    if ( msyslog_term_pid )
      _fprintf_chk(v11, 1, "%s[%d]: ", (const char *)dword_10610C, v8);
  ...
  if ( v6 )
  {
    ...
    _fprintf_chk(v12, 1, "%s[%d]: %s%s", (const char *)dword_10610C, v8, s, v10);
