int __fastcall sub_819A0(char *a1, _BYTE *a2, char a3)
{
  int v4; // r1
  int v5; // r3
  int v6; // r6
...
LABEL_3:
    ...
    case 55:
      ...
      v14 = *a1;
      if ( v8 <= 0x7F && (dword_9ED4C[v8] & 0x10000) != 0 )
      {
        v9 = (unsigned __int8)a1[2];
        v15 = v8;
        if ( v9 <= 0x7F && (dword_9ED4C[v9] & 0x10000) != 0 )
        {
          v6 = 3;
          v16 = v9;
        }
    ...
    case 120:
      ...
      if ( v11 > 0x7F || (dword_9ED4C[v11] & 0x70000) == 0 )
        goto LABEL_7;
      v12 = (unsigned __int8)a1[2];
      v14 = a1[1];
      if ( v12 <= 0x7F && (dword_9ED4C[v12] & 0x70000) != 0 )
      {
        v15 = v12;
        v6 = 3;
        v13 = 2;
