int __fastcall sub_2D028(int a1, int (__fastcall *a2)(int), int a3, int a4)
{
  int v8; // r4
  ...
  char *v18; // r1
  double v19; // [sp+8h] [bp-84h] BYREF
  char *v20; // [sp+14h] [bp-78h] BYREF
  double v21; // [sp+18h] [bp-74h] BYREF
  double v22; // [sp+20h] [bp-6Ch] BYREF
  ...
  double v29; // [sp+40h] [bp-4Ch] BYREF
  ...
  while ( sub_2CD10(a2, a3, &v33) )
  {
    ...
    if ( v33 == 35 )
    {
      ...
      {
        v17 = sub_2C6CC(v35);
        sub_6D4A4(&v19, v17, &v20, 10);
        v18 = v20;
        *(double *)(a1 + 24) = v19;
        if ( sub_2C73C(v17, v18) )
          goto LABEL_17;
      ...
      {
        v13 = sub_2C6CC(v35);
        sub_6D4A4(&v19, v13, &v20, 10);
        v14 = v20;
        *(double *)(a1 + 16) = v19;
        if ( sub_2C73C(v13, v14) )
        {
LABEL_17:
          *_errno_location() = 84;
          sub_2CFAC((_QWORD *)a1);
    ...
    {
      sub_6D4A4(&v19, &v33, &v20, 10);
      v9 = (unsigned __int8 *)v20;
      v21 = v19;
      if ( sub_2C73C(&v33, v20) )
        goto LABEL_17;
      v10 = sub_2C6CC(v9);
      v11 = strtol((const char *)v10, &v20, 10);
      if ( sub_2C73C(v10, v20) || (unsigned int)(v11 + 0x8000) >= 0x10000 )
        goto LABEL_17;
      if ( sub_6D738(&v21, &v22) < 0 )
      {
        *(_WORD *)(a1 + 34) = v11;
        goto LABEL_13;
      }
...
LABEL_27:
      ...
      v32 = 0;
      v29 = v21;
      v30 = LODWORD(v21) - LODWORD(v19);
      if ( !sub_2C7C4(a1, (int)&v29) )
        goto LABEL_27;
LABEL_13:
      v12 = LODWORD(v21);
      *(_WORD *)(a1 + 8) = v11;
