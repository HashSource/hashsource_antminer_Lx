__int16 *__fastcall sub_46FF8(int a1)
{
  int v1; // r6
  int v2; // r4
  _BYTE *v3; // r0
  ...
  v1 = *(_DWORD *)(a1 + 4);
  v2 = *(_DWORD *)(v1 + 84);
  v3 = sub_39BB4(a1, (bool *)(v2 + 56), 128, &v20);
  *(_DWORD *)(v2 + 184) = v3;
