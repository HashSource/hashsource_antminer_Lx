__int16 *__fastcall sub_54564(int a1)
{
  int v1; // r5
  int v2; // r4
  _DWORD *v3; // r10
  ...
  v2 = *(_DWORD *)(v1 + 84);
  v3 = *(_DWORD **)v2;
  result = (__int16 *)sub_39BB4(a1, v26, 128, v25);
    ...
    *v3 = 2;
           ...
           || sscanf((const char *)(v2 + 56), "%5d%*c%3d%*c%3d", &v23, &v22, &v24) != 3 )
    {
      if ( sscanf((const char *)(v2 + 56), "F%2d", &v21) == 1 && (unsigned int)(v21 - 1) <= 0x4E )
      {
        if ( v21 == 50 )
        {
          return sub_53CC4(v1, 3u);
        }
        else if ( v21 == 51 )
        {
          return sub_53CC4(v1, 4u);
        }
        else
        {
          return (__int16 *)sub_53ABC(v1, (int)"got F%02d - ignoring\n", v21);
        }
      }
      else if ( *(_WORD *)(v2 + 56) == 17750 && *(_BYTE *)(v2 + 58) == 82 && *(_BYTE *)(v2 + 62) == 46 )
      {
        result = sub_53CC4(v1, 6u);
        if ( (ntp_syslogmask & 0x400) != 0 )
          return (__int16 *)sub_64A18(6, "TL3: %s", (const char *)(v2 + 56));
      }
      else if ( !strncmp((const char *)(v2 + 56), " TRUETIME Mk III ", 0x11u)
             || !strncmp((const char *)(v2 + 56), " TRUETIME XL", 0xCu) )
      {
        result = sub_53CC4(v1, 2u);
        if ( (ntp_syslogmask & 0x400) != 0 )
          return (__int16 *)sub_64A18(6, "TM/TMD/XL: %s", (const char *)(v2 + 56));
      }
      else
      {
        ...
        {
          result = sub_53CC4(v1, 8u);
          if ( (ntp_syslogmask & 0x400) != 0 )
            return (__int16 *)sub_64A18(6, "TCU-800: %s", (const char *)(v2 + 56));
        }
        else
        {
LABEL_42:
    ...
    else
    {
      ...
      sub_53ABC(v1, (int)"GOES: station %s\n", v13);
      return sub_53CC4(v1, 5u);
    }
  }
  return result;
}
