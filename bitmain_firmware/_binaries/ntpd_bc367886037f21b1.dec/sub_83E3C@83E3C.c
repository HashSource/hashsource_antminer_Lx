int __fastcall sub_83E3C(_DWORD *a1, const char *a2, const char *a3)
{
  _DWORD *v6; // r6
  int result; // r0
  _BYTE *v8; // r4
  ...
  v6 = a1 + 1;
  result = fputs(off_B75B0[0], (FILE *)option_usage_fp);
  v8 = (_BYTE *)*a1;
  if ( v8 )
  {
    do
    {
      if ( sub_83B54(v16, 0x1001u, v8, a3) )
      {
        if ( *v8 == 36 )
        {
      ...
      fprintf((FILE *)option_usage_fp, off_B75A4[0], v8);
