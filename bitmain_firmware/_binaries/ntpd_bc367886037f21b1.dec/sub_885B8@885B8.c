int *__fastcall sub_885B8(char *a1)
{
  char *v1; // r5
  char *v2; // r0
  int v3; // r3
...
LABEL_22:
  while ( 2 )
  {
    while ( 2 )
    {
      if ( v21 <= 0x7F && (dword_9ED4C[v21] & 0xC01) != 0 )
        goto LABEL_35;
      if ( v21 == 34 )
      {
        v29 = v1 + 1;
