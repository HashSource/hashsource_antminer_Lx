int __fastcall sub_606FC(const char *a1, int a2, int a3)
{
  FILE *v4; // r8
  char *v5; // r0
  size_t v6; // r0
  ...
  sub_6BCB0(v47, 30, "/dev/mixer%d", a3);
  sub_6BCB0(v46, 20, "%s%d", "/etc/ntp.audio", a3);
  ...
  if ( v4
    ...
    || (_printf_chk(1, "audio_config_read: <%s> NO\n", v46),
        sub_6BCB0(v46, 20, "%s", "/etc/ntp.audio"),
        (v4 = (FILE *)fopen64(v46, "r")) != 0) )
  {
...
LABEL_35:
      if ( !strncmp(v16, "IDEV", 4u) && sscanf(v18, "%99s", v49) == 1 )
      {
        sub_6D12C(&byte_105FC8);
        _printf_chk(1, "idev <%s>\n", v49);
      }
      else if ( !strncmp(v16, "CDEV", 4u) && sscanf(v18, "%99s", v49) == 1 )
      {
        sub_6D12C(&byte_105F64);
        _printf_chk(1, "cdev <%s>\n", v49);
      }
      else if ( !strncmp(v16, "AGC", 3u) && sscanf(v18, "%99s", v49) == 1 )
      {
        sub_6D12C(&byte_10602C);
        _printf_chk(1, "agc <%s> %d\n", v49, v7);
      }
      else if ( !strncmp(v16, "MONITOR", 7u) && sscanf(v18, "%99s", v49) == 1 )
      {
        sub_6D12C(&byte_106090);
        v26 = sub_6066C(v49, -1);
...
LABEL_49:
  ...
  if ( v30 < 0 )
  {
    sub_64A18(3, "audio_init: %s %m", a1);
  }
  else
  {
    dword_1060F4 = open64(v29, 2);
    if ( dword_1060F4 < 0 )
    {
      sub_64A18(3, "audio_init: invalid control device <%s>", v29);
      close(v30);
      return dword_1060F4;
    }
    else
    {
      ...
      v31 = dword_1060F4;
      if ( ioctl(dword_1060F4, 0x80044DFE, &dword_1060F8) == -1 )
      {
        v39 = _errno_location();
        v40 = strerror(*v39);
      ...
      if ( ioctl(v31, 0x80044DFD, &dword_1060FC) == -1 )
      {
        v37 = _errno_location();
        v38 = strerror(*v37);
      ...
      {
        v32 = dword_1060FC;
        v33 = sub_6066C(&byte_10602C, dword_1060FC);
        if ( v33 < 0 )
          _printf_chk(1, "input %s not in recmask %#x\n", &byte_10602C, v32);
        else
          dword_B6CC0 = v33 | 0xC0044D00;
      }
      if ( byte_106090 )
      {
        v34 = dword_1060F8;
        v35 = sub_6066C(&byte_106090, dword_1060F8);
        if ( v35 < 0 )
          _printf_chk(1, "monitor %s not in devmask %#x\n", &byte_106090, v34);
        else
          dword_B6CC4 = v35 | 0xC0044D00;
      }
    }
  }
  return v30;
