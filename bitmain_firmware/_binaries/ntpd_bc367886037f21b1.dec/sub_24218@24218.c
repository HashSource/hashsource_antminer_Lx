unsigned int *__fastcall sub_24218(unsigned int *result, unsigned __int8 *a2, size_t a3, __int16 a4)
{
  bool v4; // zf
  unsigned int v6; // r4
  ...
  {
LABEL_20:
    v21 = (void *)sub_24158(result, a3, a4);
...
LABEL_15:
  ...
  v18 = a3;
LABEL_18:
  v20 = (void *)sub_637E4(v19, v18, 0, 0);
