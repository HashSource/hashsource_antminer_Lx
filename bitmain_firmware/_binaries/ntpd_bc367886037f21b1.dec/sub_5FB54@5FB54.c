int sub_5FB54()
{
  ...
  if ( sys_residual < 0.0 )
  {
    ...
    v3 = -sub_8BBA8(LODWORD(v23), HIDWORD(v23));
  }
  else
  {
    ldexp(NAN, _stack_chk_guard);
    v3 = sub_8BBA8(LODWORD(v2), HIDWORD(v2));
  }
  v5 = v3;
  LODWORD(v3) = 32;
  ldexp(*(double *)&v3, v4);
  if ( v1 < 0.0 )
    v6 = -sub_8BBA8(COERCE_UNSIGNED_INT64(-v1), HIDWORD(COERCE_UNSIGNED_INT64(-v1)));
  else
    v6 = sub_8BBA8(LODWORD(v1), HIDWORD(v1));
  v7 = v5 + v6;
  ...
  v14 = sub_8BB68(v13, HIDWORD(v13), 1000000000, 0);
  v15 = __CFADD__(v7, v14);
  v16 = v7 + v14;
  v17 = v15;
  sub_6545C((int)&v24, v12 + v17, &timer);
  v18 = v24;
  v19 = (unsigned int)&unk_F4240 * (unsigned __int64)v16 + 0x80000000;
  if ( (_UNKNOWN *)HIDWORD(v19) == &unk_F4240 )
    v18 = v24 + 1;
  v26[0] = v18;
  if ( (_UNKNOWN *)HIDWORD(v19) == &unk_F4240 )
    HIDWORD(v19) = 0;
  v26[1] = HIDWORD(v19);
  if ( sub_63EFC(v26, 0, v19) )
  {
    sub_64A18(3, "step-systime: %m");
    ...
    if ( enable_panic_check )
    {
      ...
      if ( allow_panic )
      {
        sub_64A18(3, "step_systime: allow_panic is TRUE!");
        return 0;
      }
    }
  }
  else
  {
    ...
    if ( enable_panic_check && allow_panic )
    {
      sub_64A18(3, "step_systime: allow_panic is TRUE!");
      if ( allow_panic )
        sub_6E8F0("systime.c", 589, 2, "!allow_panic");
    }
    return 1;
  }
  return result;
