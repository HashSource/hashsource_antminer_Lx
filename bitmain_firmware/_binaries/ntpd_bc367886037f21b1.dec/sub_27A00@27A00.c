int __fastcall sub_27A00(const void *a1, unsigned int a2, unsigned int a3)
{
  int v3; // r6
  int v4; // r4
  int pubkey; // r5
  ...
  if ( !v3 )
  {
    ...
    v4 = 0;
    sub_64A18(3, "cert_parse: %s", v29);
    return v4;
  }
  v4 = sub_637E4(0, 84, 0, 1);
  ...
  *(_DWORD *)(v4 + 12) = X509_get_version(v3);
  ...
  if ( !v7 )
  {
    sub_64A18(5, "cert_parse: invalid subject %s", v43);
    goto LABEL_25;
  }
  *(_DWORD *)(v4 + 48) = sub_63948(v7 + 3);
  ...
  *(_DWORD *)(v4 + 24) = ASN1_INTEGER_get(serialNumber);
  ...
  if ( !v12 )
  {
    sub_64A18(5, "cert_parse: invalid issuer %s", v43);
    goto LABEL_25;
  }
  v35 = (unsigned __int8 *)(v4 + 28);
  *(_DWORD *)(v4 + 52) = sub_63948(v12 + 3);
  v13 = (unsigned int *)X509_get0_notBefore(v3);
  sub_26734(*v13, v13 + 2, v4 + 28);
  v14 = (unsigned int *)X509_get0_notAfter(v3);
  sub_26734(*v14, v14 + 2, v4 + 38);
...
LABEL_13:
  ...
  if ( !strcmp(v23, v24) )
  {
    ...
    {
      sub_64A18(5, "cert_parse: signature not verified %s", *(const char **)(v4 + 48));
LABEL_25:
      v27 = (_DWORD *)v4;
      v4 = 0;
      sub_27968(v27);
  ...
  else if ( !strcmp((const char *)dword_107274, v24) )
  {
    sub_64A18(5, "cert_parse: certificate trail loop %s", v23);
    goto LABEL_25;
  }
  sub_6636C(v37, a3, 0);
  if ( sub_2664C(v35, (unsigned __int8 *)(v4 + 38)) > 0 || sub_2664C(v35, v37) < 0 )
  {
    sub_64A18(
      5,
