int __fastcall sub_557C0(int a1, int a2)
{
  int v3; // r9
  int v4; // r8
  int v5; // r0
  ...
  if ( v4 )
  {
    ...
    *(_DWORD *)(v7 + 4192) = 10;
    ...
    {
      if ( (v13 & 0x80) != 0 )
        v13 = sub_63BA0("/dev/icom", 9, 0);
      else
        v13 = sub_63BA0("/dev/icom", 13, 0);
      *(_DWORD *)(v7 + 48) = v13;
    }
    if ( v13 > 0 )
    {
      if ( sub_55404(*(_DWORD *)(a2 + 76), *(int **)(a2 + 84), 3) )
      {
