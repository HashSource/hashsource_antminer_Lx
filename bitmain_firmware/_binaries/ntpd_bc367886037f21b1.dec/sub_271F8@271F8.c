int __fastcall sub_271F8(unsigned int a1, int a2)
{
  unsigned int v3; // r7
  unsigned int v4; // r10
  int v5; // r3
...
LABEL_6:
  ...
  do
  {
    *(_DWORD *)(*(_DWORD *)(v3 + 240) + 4 * v9) = v6;
    ...
    v12 = v12 + v11 - 2 * v11;
    *(_DWORD *)(v3 + 244) = v9;
    v6 = sub_2706C(v10, v3 + 16, v6, v23, v22);
    if ( sub_61C10() )
      break;
    v14 = v6 <= 0xFFFF;
    if ( !v4 )
  ...
  *(_DWORD *)(v3 + 276) = hostval;
  ...
  if ( !*(_DWORD *)(v3 + 292) )
  {
    v17 = sub_637E4(*(_DWORD *)(v3 + 292), dword_B88E4, *(_DWORD *)(v3 + 292), 0);
    *(_DWORD *)(v3 + 292) = v17;
  }
  v19 = EVP_MD_CTX_new(v17, v18);
  EVP_DigestInit(v19, dword_B88E8);
  EVP_DigestUpdate(v19, v3 + 272, 12);
  EVP_DigestUpdate(v19, *(_DWORD *)(v3 + 284), 8);
  if ( EVP_SignFinal(v19, *(_DWORD *)(v3 + 292), v25, dword_B88E0) )
  {
    if ( v25[0] > dword_B88E4 )
      sub_6E8F0("ntp_crypto.c", 397, 2, "len <= sign_siglen");
    v20 = *(_DWORD *)(v3 + 68);
