char *__fastcall sub_2CA30(int a1)
{
  char *v2; // r5
  int v3; // r4
  int v4; // r3
  ...
  v4 = *(_DWORD *)(a1 + 4);
  lib_nextbuf = v3;
  if ( v4 < 0 || sub_662F4(&v6, a1) < 0 )
    sub_6BCB0(v2, 128, "%s", "9999-12-31T23:59:59Z");
  else
    sub_6BCB0(v2, 128, "%04d-%02d-%02dT%02d:%02d:%02dZ", v6, v7, v8, v9, v10, v11);
  return v2;
}
