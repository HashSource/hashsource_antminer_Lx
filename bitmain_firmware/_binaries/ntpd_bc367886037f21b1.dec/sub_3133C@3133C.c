int __fastcall sub_3133C(int *s, int a2)
{
  void *v3; // r0
  void *v4; // r0
  void *v5; // r0
...
LABEL_18:
        ...
        v14 = (const char *)sub_6BF44(v8);
        sub_64A18(3, "peer %s not in address table!", v14);
LABEL_19:
        v15 = s[15] & 0x7F;
...
LABEL_28:
            ...
            v20 = (const char *)sub_6BF44(v8);
            sub_64A18(3, "peer %s not in association ID table!", v20);
LABEL_29:
            v21 = &peer_list;
            v22 = (int *)peer_list;
            if ( s != (int *)peer_list )
            {
              ...
              {
LABEL_38:
                v24 = (const char *)sub_6BF44(v8);
                sub_64A18(3, "%s not in peer list!", v24);
                goto LABEL_2;
              }
              while ( s != v23 )
              {
