int __fastcall sub_1DDA0(int a1, int a2)
{
  int result; // r0
  void *v5; // r3
  void *v6; // r2
  ...
  if ( !ipv4_works )
  {
    if ( !ipv6_works )
    {
      sub_64A18(3, "Neither IPv4 nor IPv6 networking detected, fatal.");
      exit(1);
    }
    v5 = off_B511C;
    if ( (*(_DWORD *)((_BYTE *)&word_10 + (_DWORD)off_B511C) & 0xF) != 0 )
    {
      result = sub_64A18(4, "-4/--ipv4 ignored, IPv4 networking not found.");
      v5 = off_B511C;
    }
    goto LABEL_5;
  }
  ...
  if ( ipv6_works )
  {
    result = *(_DWORD *)((_BYTE *)&word_10 + (_DWORD)off_B511C) & 0xF;
    if ( result )
    {
      ipv6_works = 0;
    }
    else if ( (*(int *)((_BYTE *)&dword_50 + (_DWORD)off_B511C) & 0xF) != 0 )
    {
      ipv4_works = 0;
    }
LABEL_5:
    ...
    if ( !v6 )
      goto LABEL_6;
LABEL_51:
    result = sub_384FC(3, 1, 0);
    v5 = off_B511C;
    if ( (*(int *)((_BYTE *)&dword_110 + (_DWORD)off_B511C) & 0xF) == 0 )
      goto LABEL_9;
    goto LABEL_52;
  }
  if ( (*(int *)((_BYTE *)&dword_50 + (_DWORD)off_B511C) & 0xF) == 0 )
    goto LABEL_5;
  result = sub_64A18(4, "-6/--ipv6 ignored, IPv6 networking not found.");
  v5 = off_B511C;
  v6 = (void *)(*(int *)((_BYTE *)&dword_90 + (_DWORD)off_B511C) & 0xF);
  if ( v6 )
    goto LABEL_51;
LABEL_6:
  if ( (*(int *)((_BYTE *)&dword_D0 + (_DWORD)v5) & 0xF) != 0 )
  {
    result = sub_384FC(3, (int)v6, v6);
    v5 = off_B511C;
  }
  if ( (*(int *)((_BYTE *)&dword_110 + (_DWORD)v5) & 0xF) != 0 )
  {
LABEL_52:
    result = sub_384FC(1, 1, 0);
    v5 = off_B511C;
  }
LABEL_9:
  ...
  {
    result = sub_426A8(1, *(char **)((char *)&elf_hash_bucket[23] + (_DWORD)v5));
    v5 = off_B511C;
  }
  ...
  {
    result = sub_424A0(*(int *)((char *)&elf_hash_bucket[103] + (_DWORD)v5));
    v5 = off_B511C;
  }
  if ( (*(int *)((_BYTE *)&elf_hash_bucket[197] + (_DWORD)v5) & 0xF) != 0 )
  {
    result = sub_426A8(3, *(char **)((char *)&elf_hash_bucket[199] + (_DWORD)v5));
    v5 = off_B511C;
  }
  ...
  if ( (*(int *)((_BYTE *)&elf_hash_bucket[245] + (_DWORD)v5) & 0xF) != 0 )
  {
    ...
    if ( sscanf(v27, "%lf", &v28) == 1 )
      result = sub_384FC(4, 0, 0);
    else
      result = sub_64A18(3, "command line broadcast delay value %s undecodable", v27);
    v5 = off_B511C;
  }
  if ( (*(int *)((_BYTE *)&elf_hash_bucket[277] + (_DWORD)v5) & 0xF) != 0 )
  {
    result = sub_426A8(2, *(char **)((char *)&elf_hash_bucket[279] + (_DWORD)v5));
    v5 = off_B511C;
  }
    ...
    do
    {
      while ( 1 )
      {
        ...
        if ( (unsigned int)(v13 - 1) <= 0xFFFE )
          break;
        --v8;
        result = sub_64A18(3, "command line trusted key %s is invalid", v11);
        if ( v8 <= 0 )
          goto LABEL_31;
      }
      --v8;
      result = sub_61DF8(v13, 1);
    }
    while ( v8 > 0 );
LABEL_31:
    v5 = off_B511C;
  ...
  if ( (*(int *)((_BYTE *)&elf_hash_bucket[325] + (_DWORD)v5) & 0xF) != 0 )
  {
    ...
    if ( v26 < 0 )
    {
      ...
      sub_64A18(3, "command line interface update interval %ld must not be negative", v26);
      if ( a1 > 0 )
      {
        cmdline_server_count = a1;
        cmdline_servers = a2;
      }
      sub_89774(&ntpdOptions, 2);
    }
