void __fastcall sub_84ED8(int *a1)
{
  char *v2; // r0
  char *v3; // r6
  FILE *v4; // r7
  ...
  int v37; // r4
  char *v38; // r0
  unsigned __int16 *v39; // [sp+18h] [bp-14h]
  size_t v40; // [sp+1Ch] [bp-10h]
  int v41; // [sp+1Ch] [bp-10h]
  const char *v42; // [sp+20h] [bp-Ch] BYREF

  v42 = 0;
  v2 = sub_7F114((int)a1, &v42);
  v3 = v2;
  if ( v2 )
  {
    ...
    if ( v4 )
    {
      ...
      v42 = (const char *)time(0);
      v7 = ctime((const time_t *)&v42);
            ...
            if ( v11 == 0x8000 || *v9 == v11 )
            {
              ...
              switch ( v12 )
              {
                ...
                case 2:
                  ...
                  v9 += 32;
                  sub_7C3B0(v4, (int)v5, *((const char **)v5 + 6));
                  *((_DWORD *)v5 + 6) = v26;
                  if ( v8 > 0 )
                    continue;
                  goto LABEL_22;
                case 3:
                  ...
                  goto LABEL_20;
                case 4:
                  v14 = (char *)sub_83190((int)v5);
                  v40 = strlen(v14);
                  v15 = (char *)malloc(v40 + 3);
                  v16 = v15;
                  if ( !v15 )
                    sub_C610(v40 + 3);
                  *v15 = 61;
                  --v8;
                  memcpy(v15 + 1, v14, v40 + 1);
                  sub_7C3B0(v4, (int)v5, v16);
                  free(v16);
                  free(v14);
                  v9 += 32;
                  if ( v8 > 0 )
                  ...
                  if ( v27 )
                  {
                    ...
                    if ( (int)*v27 > 0 )
                    {
                      ...
                      do
                      {
                        v31 = *v29++;
                        v30 = v31;
                        v32 = (_DWORD *)sub_8170C(v31, 0);
                        if ( v32 )
                        {
                          fprintf(v4, "<%s type=nested>\n", *((_DWORD *)v5 + 13));
                          do
                          {
                            sub_7CBAC((int)v4, 1, (int)v5, v32);
                            v32 = (_DWORD *)sub_818D8(v30, (int)v32);
                          }
                          while ( v32 );
                          fprintf(v4, "</%s>\n", *((_DWORD *)v5 + 13));
                        }
...
LABEL_22:
    ...
    {
      fprintf(stderr, off_B7540[0], a1[7]);
      v34 = stderr;
      v35 = _errno_location();
      v36 = off_B74F4[0];
      v37 = *v35;
      v38 = strerror(*v35);
      fprintf(v34, v36, v37, v38, v3);
      if ( v42 )
        free(v3);
    }
  }
