size_t __fastcall sub_8A4E8(unsigned int a1, int a2, int a3)
{
  int v6; // r4
  __pid_t v7; // r0
  __pid_t v8; // r11
  ...
  v6 = pipe(pipedes);
  if ( v6 )
    sub_7CB20(*(_DWORD *)(a1 + 28), (int)"pipe", (int)off_B74B4[0]);
  v7 = fork();
  v8 = v7;
  if ( v7 == -1 )
    sub_7CB20(*(_DWORD *)(a1 + 28), (int)"fork", *(_DWORD *)(a1 + 28));
  if ( !v7 )
  {
    dup2(pipedes[1], 2);
    dup2(pipedes[1], 1);
...
LABEL_22:
  ...
  close(pipedes[1]);
  v9 = *(const char **)(a1 + 32);
  v10 = (const char *)(&off_B4208)[a2 + 97];
