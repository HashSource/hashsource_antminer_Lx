int __fastcall sub_6A75C(double a1, unsigned int a2, int a3, int a4, unsigned int a5, _DWORD *a6)
{
  double v6; // d0
  unsigned int *v7; // r6
  int v8; // r8
...
LABEL_63:
    ...
    while ( v31 );
LABEL_69:
    LODWORD(a1) = sub_6A150(v83, v7, a2, v96, a3, v28, a5);
    return LODWORD(a1);
  }
LABEL_7:
  v9 = -v6;
...
LABEL_34:
    if ( v15 >= 1.84467441e19 )
      goto LABEL_93;
    v16 = sub_8BBA8(LODWORD(v15), HIDWORD(v15));
    a1 = COERCE_DOUBLE(sub_8BA5C(v16, HIDWORD(v16)));
    if ( v15 < a1 )
      --v16;
    if ( v16 == -1 )
    {
LABEL_93:
    ...
    for ( ; v19; v17 = v17 / 10.0 )
      ++v19;
    v20 = sub_8BBA8(LODWORD(v17), HIDWORD(v17));
    v21 = v15 - COERCE_DOUBLE(sub_8BA5C(v16, HIDWORD(v16)));
    a1 = COERCE_DOUBLE(sub_8BA5C(v20, HIDWORD(v20)));
    v22 = v21 * a1;
    if ( v22 < 1.84467441e19 )
    {
      v84 = sub_8BBA8(LODWORD(v22), HIDWORD(v22));
      a1 = COERCE_DOUBLE(sub_8BA5C(v84, HIDWORD(v84)));
      v23 = v84;
      v24 = a1;
      if ( v22 < a1 )
      {
        v85 = v84 - 1;
        a1 = COERCE_DOUBLE(sub_8BA5C(v85, HIDWORD(v85)));
        v23 = v85;
        v24 = a1;
      }
      if ( v22 - v24 >= 0.5 )
...
LABEL_211:
  ...
  {
    v75 = v74 + 1;
    sub_8BB68(v11, HIDWORD(v11), 10, 0);
    v94[v74] = a0123456789abcd_3[v76];
    v74 = 1;
    LODWORD(v77) = sub_8BB68(v11, HIDWORD(v11), 10, 0);
    v78 = v75 <= 1;
    v11 = v77;
    if ( !v77 )
      v78 = 0;
...
LABEL_95:
  ...
  do
  {
    sub_8BB68(v16, HIDWORD(v16), 10, 0);
    ++v34;
    *++v33 = a0123456789abcd_3[v35];
    LODWORD(v36) = sub_8BB68(v16, HIDWORD(v16), 10, 0);
  ...
  if ( v86 )
  {
    ...
    do
    {
      sub_8BB68(v67, HIDWORD(v67), 10, 0);
      ++v37;
      *++v65 = a0123456789abcd_3[v68];
      LODWORD(v69) = sub_8BB68(v67, HIDWORD(v67), 10, 0);
