int __fastcall sub_7CBAC(int result, int a2, int a3, _DWORD *a4)
{
  int v4; // r8
  FILE *v6; // r4
  int v8; // r8
...
LABEL_6:
      ...
      else
      {
        ...
        for ( i = ++dword_B7164; ; i = dword_B7164 )
        {
          --v16;
          v19 = *v17++;
          sub_7CBAC(v6, i, 0, v19);
          if ( v16 == -1 )
            break;
        }
        v21 = dword_B7164 - 2;
...
LABEL_35:
    ...
    {
      case '&':
        v32 = (const char *)&unk_9EF4C;
        goto LABEL_47;
      case '<':
        v32 = (const char *)&off_9EF5C;
        goto LABEL_47;
      case '>':
        v32 = (const char *)&unk_9EF6C;
        goto LABEL_47;
      case '"':
        v32 = (const char *)&unk_9EF7C;
        goto LABEL_47;
      case '\'':
        v32 = (const char *)&unk_9EF8C;
LABEL_47:
        fputs(v32 + 8, v6);
        break;
      default:
