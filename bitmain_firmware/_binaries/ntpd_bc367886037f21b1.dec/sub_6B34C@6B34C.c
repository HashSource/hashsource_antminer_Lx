unsigned int __fastcall sub_6B34C(int a1, unsigned int a2, unsigned __int8 *a3, int *a4)
{
  int v4; // lr
  int v6; // lr
  unsigned int v7; // r6
...
LABEL_74:
          ...
          case 'i':
            ...
            sub_6A2EC(a1, &v43, v7, 10, v40, 0xAu, v8, v14, v9);
            break;
          case 'e':
LABEL_70:
            v9 |= 0x200u;
            ...
            v30 = v8;
LABEL_71:
            sub_6A75C(COERCE_DOUBLE(__PAIR64__(&v43, a1)), v7, v30, v14, v9, &v44);
            v16 = v44;
            a4 = (int *)(v29 + 8);
            if ( v44 )
              goto LABEL_18;
...
LABEL_65:
            ...
            if ( !v14 )
              v14 = 1;
            sub_6A75C(COERCE_DOUBLE(__PAIR64__(&v43, a1)), v7, v8, v14, v28, &v44);
            v16 = v44;
            a4 = (int *)(v27 + 8);
            if ( !v44 )
              break;
          ...
          case 'p':
            v34 = *a4++;
            if ( v34 )
              sub_6A2EC(a1, &v43, v7, v34, (unsigned int)v34, 0x10u, v8, v14, v9 | 0x88);
            else
              sub_6A150(a1, &v43, v7, "(nil)", v8, -1, v9);
            break;
          case 's':
            v37 = (const char *)*a4++;
            sub_6A150(a1, &v43, v7, v37, v8, v14, v9);
            break;
          case 'u':
            v25 = 10;
            goto LABEL_63;
...
LABEL_63:
            ...
            sub_6A2EC(a1, &v43, v7, v25, v32, v25, v8, v14, v26);
            break;
          default:
            break;
        }
