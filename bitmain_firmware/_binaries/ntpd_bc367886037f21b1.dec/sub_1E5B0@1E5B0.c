void *__fastcall sub_1E5B0(int a1, _DWORD *a2)
{
  ...
  v2 = (unsigned __int8 *)dword_B8408;
  v3 = dword_B840C;
  if ( dword_B840C <= (unsigned int)dword_B8408 )
    return 0;
  for ( i = 0; ; i = 1 )
  {
    v6 = v2 + 1;
...
LABEL_52:
      v15 = 0;
LABEL_31:
      _memcpy_chk(&unk_B8410, v16);
      *((_BYTE *)&dword_B83F4 + v15 + 28) = 0;
      *a2 = &unk_B8410;
      if ( a1 )
      {
LABEL_32:
...
LABEL_43:
  ...
  if ( v15 <= 0x7F )
    goto LABEL_31;
  ++numctlbadpkts;
  if ( (ntp_syslogmask & 2) != 0 && dword_B8490 <= (unsigned int)current_time )
  {
    dword_B8490 = current_time + 300;
    v29 = (const char *)sub_6BF44(dword_B8494);
    sub_64A18(
      4,
      "Possible 'ntpdx' exploit from %s#%u (possibly spoofed)",
      v29,
      (unsigned __int16)__rev16(*(unsigned __int16 *)(dword_B8494 + 2)));
    v3 = dword_B840C;
  }
  dword_B8408 = v3;
  return 0;
