char *__fastcall sub_425B4(int a1)
{
  char *v2; // r5
  int v3; // r4
  ...
  memset(v2, 0, 0x80u);
  lib_nextbuf = v3;
  if ( sub_6636C(&v5, a1, 0) < 0 )
    sub_6BCB0(v2, 128, "ntpcal_ntp_to_date: %ld: range error", a1);
  else
    sub_6BCB0(v2, 128, "%04d%02d%02d%02d%02d", v5, v6, v7, v8, v9);
  return v2;
}
