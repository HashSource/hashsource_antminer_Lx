void __fastcall sub_384FC(int a1, __int16 *a2, unsigned __int16 *s2)
{
  double v3; // d0
  int *v4; // r12
  ...
  switch ( a1 )
  {
    ...
    case 10:
      ...
      else
      {
        sub_30AEC(1u);
        if ( mon_enabled )
          sub_64A18(4, "restrict: 'monitor' cannot be disabled while 'limited' is enabled");
      }
      break;
    case 11:
    ...
    case 33:
      ...
      break;
    default:
      sub_64A18(5, "proto: unsupported option %d");
      break;
  }
}
