ssize_t __fastcall sub_4E5F4(ssize_t result)
{
  ssize_t v1; // r4
  _WORD **v2; // r3
  int v3; // r6
  ...
  if ( *(_DWORD *)(result + 84) == 7 )
  {
    ...
    switch ( (*v2)[26] )
    {
      ...
      case 1:
        ...
        *(_WORD *)(v3 + 38) = v21;
        *(_WORD *)(v3 + 44) = v20;
        if ( v18 > 0xCu || byte_98370[v18 - 1] < v20 )
        {
LABEL_12:
          *(_WORD *)(v3 + 52) = 0;
        }
        else
        {
          *(_WORD *)(v3 + 40) = v20;
          ...
          if ( v21 <= 0x5A )
            v24 = 2000;
          v25 = v21 + v24;
          if ( (v25 & 3) != 0 || (sub_8B734(v25, 100), !v26) && (sub_8B734(v25, 400), v27) )
          {
            if ( v19 > 2 )
              --*(_WORD *)(v3 + 40);
          }
          result = write(*(_DWORD *)(v3 + 24), &off_9837C, 3u);
          if ( result < 0 )
            result = sub_64A18(3, "leitch_send: unit %d send failed %m", *(unsigned __int8 *)(v3 + 36));
          *(_WORD *)(v3 + 52) = 2;
        }
        break;
      case 2:
        sub_4E4E4((unsigned __int8 *)result, *v2);
        result = sub_6300C(
                   *(__int16 *)(v3 + 40),
                   *(__int16 *)(v3 + 46),
                   *(__int16 *)(v3 + 50),
        ...
        v8 = vshld_n_s64(
               ...
               0x20u)
           + 500000;
        *(_DWORD *)(v3 + 60) = sub_8BB68(v8, HIDWORD(v8), &unk_F4240, 0);
        result = *v7;
        v9 = v7[1];
        *(_DWORD *)(v3 + 80) = *v7;
        *(_DWORD *)(v3 + 84) = v9;
      ...
      case 3:
        ...
        v5 = vshld_n_s64(
               ...
               0x20u)
           + 500000;
        *(_DWORD *)(v3 + 68) = sub_8BB68(v5, HIDWORD(v5), &unk_F4240, 0);
        result = *v4;
        v6 = v4[1];
        *(_DWORD *)(v3 + 88) = *v4;
        *(_DWORD *)(v3 + 92) = v6;
      ...
      case 4:
        ...
        if ( result )
        {
          ...
          v13 = vshld_n_s64(
                  ...
                  0x20u)
              + 500000;
          *(_DWORD *)(v3 + 76) = sub_8BB68(v13, HIDWORD(v13), &unk_F4240, 0);
          v14 = v12[1];
          *(_DWORD *)(v3 + 96) = *v12;
          *(_DWORD *)(v3 + 100) = v14;
          result = sub_39A1C(*(_DWORD *)v3);
          *(_WORD *)(v3 + 52) = 0;
        }
        else
        {
