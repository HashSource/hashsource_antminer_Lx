int __fastcall sub_5FF50(_DWORD *a1, int a2, _DWORD *a3, _DWORD *a4)
{
  int v5; // r0
  int v9; // r1
  unsigned int v10; // r4
...
LABEL_6:
        ...
        if ( CMAC_Init(v12, v11, 16, v13, 0) )
        {
          ...
          {
            v14 = sub_64A18(3, "MAC encrypt: CMAC %s buf too small.", "AES128CMAC");
          }
          else if ( CMAC_Update(v12, *a4, a4[1]) )
          {
            if ( !CMAC_Final(v12, *a1, &v31) )
            {
              v14 = sub_64A18(3, "MAC encrypt: CMAC %s Final failed.", "AES128CMAC");
              v31 = 0;
            }
          }
          else
          {
            v14 = sub_64A18(3, "MAC encrypt: CMAC %s Update failed.", "AES128CMAC");
          }
        }
        else
        {
          v14 = sub_64A18(3, "MAC encrypt: CMAC %s Init failed.", "AES128CMAC");
        }
        CMAC_CTX_cleanup(v12, HIDWORD(v14));
        return v31;
      }
    }
    sub_64A18(3, "MAC encrypt: CMAC %s CTX new failed.", "AES128CMAC");
    return v31;
  }
  ...
  if ( v16 )
  {
    ...
    if ( EVP_DigestInit_ex(v17, digestbyname, 0, v20) )
    {
      ...
      if ( (unsigned int)EVP_MD_size(v21) <= a1[1] )
      {
        if ( EVP_DigestUpdate(v17, *a3, a3[1]) )
        {
          if ( EVP_DigestUpdate(v17, *a4, a4[1]) )
          {
            ...
            else
            {
              ...
              sub_64A18(3, "MAC encrypt: MAC %s Digest Final failed.", v30);
              v32 = 0;
              v23 = 0;
            }
          }
          else
          {
            ...
            sub_64A18(3, "MAC encrypt: MAC %s Digest Update data failed.", v28);
            v23 = v32;
          }
        }
        else
        {
          ...
          sub_64A18(3, "MAC encrypt: MAC %s Digest Update key failed.", v29);
          v23 = v32;
        }
      }
      else
      {
        ...
        sub_64A18(3, "MAC encrypt: MAC %s buf too small.", v22);
        v23 = v32;
      }
    }
    else
    {
      ...
      sub_64A18(3, "MAC encrypt: MAC %s Digest Init failed.", v24);
      v23 = v32;
    }
    v31 = v23;
    EVP_MD_CTX_free(v17);
  ...
  sub_64A18(3, "MAC encrypt: MAC %s Digest CTX new failed.", v27);
  return v32;
}
