__int16 *__fastcall sub_437A8(__int16 *result)
{
  int v1; // r6
  int v2; // r4
  _DWORD *v3; // r1
  ...
  *(_DWORD *)(v2 + 188) = v7;
  if ( v7 == 94 )
  {
    ...
    result = (__int16 *)write(*(_DWORD *)(v2 + 28), &unk_B5DF0, 0x1Au);
...
LABEL_21:
  ...
  v16 = v4 + 36;
  sub_6BCB0(v2 + 56, 128, "%d %d %d %d %d", v9, v10, v11, v12, v13);
  v17 = strlen((const char *)(v2 + 56));
  v18 = (_DWORD *)(v2 + 232);
