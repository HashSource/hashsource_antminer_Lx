__int16 *__fastcall sub_59694(_DWORD *a1)
{
  int v2; // r7
  int *v3; // r4
  __int16 *result; // r0
  ...
  if ( *((_BYTE *)a1 + 88) != 33 )
    return result;
  v6 = (const char *)(v3 + 14);
  result = (__int16 *)sub_39BB4((int)a1, (bool *)v3 + 56, 128, v3 + 58);
  v3[46] = (int)result;
LABEL_5:
  if ( (int)result > 28 )
  {
