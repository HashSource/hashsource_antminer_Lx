  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( v11 != *(unsigned __int16 *)(a1 + 24) )
        sub_6E8F0("ntp_io.c", 699, 0, "((a)->sa.sa_family) == ((a_mask)->sa.sa_family)");
      v12 = *(unsigned __int16 *)(v7 + 52);
      if ( v12 != *(unsigned __int16 *)(v7 + 24) )
        sub_6E8F0("ntp_io.c", 700, 0, "((b)->sa.sa_family) == ((b_mask)->sa.sa_family)");
      if ( v11 != v12 )
      {
LABEL_25:
        result = 0;
...
LABEL_47:
  ...
  if ( result != -1 )
  {
    ...
    if ( v19 == 2 )
    {
      ...
      {
        v35 = sub_6BF44(v1);
        return sub_64A18(3, "setsockopt IP_MULTICAST_IF %s fails: %m", v35);
      }
    }
    else if ( v19 == 10 )
    {
      ...
      if ( result )
      {
        ...
        {
          v22 = sub_6BF44(v1);
          return sub_64A18(3, "setsockopt IPV6_MULTICAST_IF %u for %s fails: %m", v20, v22);
        }
      }
    }
  }
