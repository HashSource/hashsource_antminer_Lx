void __fastcall __noreturn main(int a1, char **a2, char **a3)
{
  ...
  char v43[24]; // [sp+14h] [bp-18h] BYREF
                ...
                if ( (unsigned int)(v40 - 80) > 7 )
                {
                  ...
                  if ( v8 )
                  {
                    ...
                    fwrite(
                      ...
                      (FILE *)stderr);
LABEL_85:
                    fprintf((FILE *)stderr, "I will read from device file %s, chip address 0x%02x, ", v43, v40);
