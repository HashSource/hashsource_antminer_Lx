  ...
  if ( v0 )
  {
    ...
    if ( stream )
    {
      ...
      while ( 1 )
      {
        ...
        v4 = v3 + 1;
        *v3 = 0;
        format = (char *)sub_11BD8(v3 + 1);
        v5 = strrchr(s, 9);
        v6 = v5 + 1;
        *v5 = 0;
        v36 = (FILE *)sub_11BD8(v5 + 1);
        v7 = strrchr(s, 9);
        v8 = v7 + 1;
        *v7 = 0;
        v40 = (char *)v36 + sub_11BD8(v7 + 1);
...
LABEL_23:
              ...
              {
                v24 = sub_11C80(v0, (int)&v15->_flags + 1);
                v23 = (FILE *)((char *)&v15->_flags + 1);
                v0 = v24;
                if ( !v24 )
                  return 0;
...
LABEL_11:
              ...
              v15 = v38;
              *((_QWORD *)v25 + 1) = *(_QWORD *)&off_12E54[2 * v22];
              v17 = readdir64(v16);
              if ( !v17 )
                goto LABEL_34;
            }
