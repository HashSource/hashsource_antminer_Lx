int __fastcall sub_AA34(const char *a1, int a2)
{
  const char *v2; // r5
  int result; // r0
  int v5; // r0
  ...
  v2 = a1;
  if ( !a1 )
    sub_10788("msyslog.c", 469, 0, "fname != ((void *)0)");
  if ( syslog_file )
  {
    if ( syslog_fname )
    {
    ...
    if ( strcmp(v2, "stdout") )
    {
      ...
      else if ( v2 != (const char *)v7 && *v2 != 47 && getcwd(buf, 0x200u) )
      {
        ...
        if ( v8 > 1 && buf[v8 - 1] == 47 )
          v9 = v8 - 1;
        v10 = strlen(v2) + v9 + 2;
        v11 = (char *)sub_96BC(0, v10, 0, 0);
        sub_F658(v11, v10, "%.*s%c%s", v9, buf, 47, v2);
        goto LABEL_18;
      }
      v11 = (char *)sub_9820(v2);
LABEL_18:
      if ( debug > 0 )
        sub_A770("attempting to open log %s\n", v11);
      v12 = (FILE *)fopen64(v11, "a");
      goto LABEL_21;
    }
    v6 = (FILE ***)&stdout_ptr;
  }
...
LABEL_21:
  if ( v12 )
  {
    if ( a2 && (syslogit || (const char *)syslog_abs_fname != v2) )
      sub_A848(5, "switching logging to file %s", v11);
