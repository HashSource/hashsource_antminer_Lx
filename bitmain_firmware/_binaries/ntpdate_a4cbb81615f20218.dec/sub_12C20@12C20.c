int __fastcall sub_12C20(_DWORD *a1, int a2, _DWORD *a3, _DWORD *a4)
{
  int v5; // r0
  unsigned int v9; // r4
  _BYTE *v10; // r5
...
LABEL_6:
        ...
        if ( CMAC_Init(v11, v10, 16, v12, 0) )
        {
          ...
          {
            sub_A848(3, "MAC encrypt: CMAC %s buf too small.", "AES128CMAC");
          }
          else if ( CMAC_Update(v11, *a4, a4[1]) )
          {
            if ( !CMAC_Final(v11, *a1, &v28) )
            {
              sub_A848(3, "MAC encrypt: CMAC %s Final failed.", "AES128CMAC");
              v28 = 0;
            }
          }
          else
          {
            sub_A848(3, "MAC encrypt: CMAC %s Update failed.", "AES128CMAC");
          }
        }
        else
        {
          sub_A848(3, "MAC encrypt: CMAC %s Init failed.", "AES128CMAC");
        }
        CMAC_CTX_cleanup(v11);
        return v28;
      }
    }
    sub_A848(3, "MAC encrypt: CMAC %s CTX new failed.", "AES128CMAC");
    return v28;
  }
  v14 = EVP_MD_CTX_new();
  v29 = 0;
  ...
  if ( v14 )
  {
    ...
    if ( EVP_DigestInit_ex(v15, digestbyname, 0) )
    {
      ...
      if ( (unsigned int)EVP_MD_size(v18) <= a1[1] )
      {
        if ( EVP_DigestUpdate(v15, *a3, a3[1]) )
        {
          if ( EVP_DigestUpdate(v15, *a4, a4[1]) )
          {
            ...
            else
            {
              ...
              sub_A848(3, "MAC encrypt: MAC %s Digest Final failed.", v27);
              v29 = 0;
              v20 = 0;
            }
          }
          else
          {
            ...
            sub_A848(3, "MAC encrypt: MAC %s Digest Update data failed.", v25);
            v20 = v29;
          }
        }
        else
        {
          ...
          sub_A848(3, "MAC encrypt: MAC %s Digest Update key failed.", v26);
          v20 = v29;
        }
      }
      else
      {
        ...
        sub_A848(3, "MAC encrypt: MAC %s buf too small.", v19);
        v20 = v29;
      }
    }
    else
    {
      ...
      sub_A848(3, "MAC encrypt: MAC %s Digest Init failed.", v21);
      v20 = v29;
    }
    v28 = v20;
    EVP_MD_CTX_free(v15);
  ...
  sub_A848(3, "MAC encrypt: MAC %s Digest CTX new failed.", v24);
  return v29;
}
