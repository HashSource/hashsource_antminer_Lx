int __fastcall sub_154BC(int a1)
{
  const char *v2; // r6
  char *v3; // r0
  char *v4; // r4
...
LABEL_27:
      ...
      {
        v21 = v16 - 1;
        if ( sub_F658((int)v38, 0x1001u, "%s.%d", v2, v16 - 1) > 0x1000
          || sub_F658((int)v39, 0x1001u, "%s.%d", v2, v16) > 0x1000 )
        {
          v19 = 19;
LABEL_30:
          v20 = sub_186F4(v19);
...
LABEL_39:
            if ( v17 )
            {
              if ( sub_F658((int)v39, 0x1001u, "%s.0", v2) > 0x1000 )
              {
                v14 = 19;
                goto LABEL_43;
              }
              v12 = sub_1B1F4(v2, v39);
              v13 = v12 == 0;
              if ( v12 )
                v13 = v12 == 38;
              v14 = v12;
...
LABEL_43:
    ...
    while ( 1 )
    {
      if ( --v16 < v17 )
        goto LABEL_27;
      if ( sub_F658((int)v38, 0x1001u, "%s.%d", v2, v16) > 0x1000 )
        break;
      v30 = sub_1B148(v38);
      v31 = v30 == 0;
      if ( v30 )
