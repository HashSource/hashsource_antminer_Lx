int sub_11540()
{
  ...
  if ( !result )
  {
    ...
    if ( v1 == -1 )
    {
      v4 = _errno_location();
      sub_129E0(*v4, v9, 128);
      v5 = (const char *)sub_11084((_DWORD *)isc_msgcat, 1, 101, (int)"failed");
      result = sub_1508C("./../lib/isc/unix/net.c", 266, "socket() %s: %s", v5, v9);
      dword_310E0 = 34;
      return result;
    }
    v8 = 1;
    if ( setsockopt(v1, 41, 26, &v8, 4u) >= 0 )
    {
      ...
      if ( v3 == -1 )
      {
        ...
        result = sub_1508C("./../lib/isc/unix/net.c", 289, "socket() %s: %s", v7, v9);
        dword_310E0 = 34;
        return result;
      }
      v8 = 1;
