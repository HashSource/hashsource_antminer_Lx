char *print_summary()
{
  ...
  *(float *)&v2 = v43;
  ...
  LODWORD(v8) = sub_12D7DC(total_accepted);
  v9 = v8 / v6 * 60.0;
  ...
  if ( total_accepted || total_rejected )
  {
    V_LOCK();
    v22 = total_rejected;
    LODWORD(v24) = sub_12D7DC(100 * total_rejected);
    HIDWORD(v24) = v23;
    LODWORD(v25) = sub_12D7DC(v22 + total_accepted);
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        if ( *(_QWORD *)(v26 + 2096) || *(_QWORD *)(v26 + 2104) )
        {
          V_LOCK();
          v28 = *(_QWORD *)(v26 + 2104);
          LODWORD(v30) = sub_12D7DC(100 * v28);
          HIDWORD(v30) = v29;
          LODWORD(v31) = sub_12D7DC(v28 + *v27);
