...
LABEL_9:
  ...
  LOWORD(v5) = -30912;
  LOWORD(v7) = -30796;
  HIWORD(v5) = (unsigned int)&unk_1371C8 >> 16;
  HIWORD(v7) = (unsigned int)"pace/Antminer_L7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_master/backend/backend_ckb/backend_ckb.c" >> 16;
