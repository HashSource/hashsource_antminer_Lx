int __fastcall sub_28FD0(_DWORD *a1, const char **a2)
{
  int v2; // r4
  const char **v5; // r7
  ...
  sub_12D7DC((__int64)(v12 * 100.0));
  v16 = json_real();
  json_object_set_new(v9, "rate_5s", v16);
  LODWORD(v17) = sub_12D7DC((__int64)(v13 * 100.0));
  v18 = v17 / 100.0;
  v19 = json_real();
...
LABEL_19:
  ...
  v29 = json_integer(*(__int64 *)&dword_164EE0);
