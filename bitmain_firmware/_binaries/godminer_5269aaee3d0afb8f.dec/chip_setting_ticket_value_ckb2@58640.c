int __fastcall chip_setting_ticket_value_ckb2(int a1, int a2)
{
  ...
  LOWORD(v2) = 30572;
  HIWORD(v2) = (unsigned int)"oot/tmp/release/build/godminer-origin_master/backend/chip_reg_io_base.c" >> 16;
  LOWORD(v5) = -14756;
  LOWORD(v6) = 30716;
  HIWORD(v5) = (unsigned int)&unk_16B55C >> 16;
  HIWORD(v6) = (unsigned int)": %02x %02x chip addr %02x reg addr %02x reg value %02x%02x%02x" >> 16;
  V_LOCK();
  LOWORD(v7) = 30900;
  v12 = v2 + 52;
