int __fastcall packet_2_nonce_ae(int a1, unsigned __int8 *a2, int a3, _BYTE *a4, _DWORD *a5, int *a6, _DWORD *a7)
{
  ...
  else
  {
    V_LOCK();
    LOWORD(v43) = 26888;
    HIWORD(v43) = (unsigned int)"w temp type %d" >> 16;
    logfmt_raw(var1004, 0x1000u, 0, v43, v12, v13);
    V_UNLOCK();
    LOWORD(v44) = -14756;
    HIWORD(v44) = (unsigned int)&unk_16B55C >> 16;
    LOWORD(v45) = 26940;
    HIWORD(v45) = (unsigned int)"/Antminer_L7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_master/miner_util/set_pwm_by_temp.c" >> 16;
