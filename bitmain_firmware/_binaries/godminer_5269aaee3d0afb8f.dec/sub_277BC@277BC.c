int __fastcall sub_277BC(_DWORD *a1, int a2)
{
  int v4; // r0
  bool v5; // zf
  int v6; // r5
  ...
  {
    v6 = v4;
    sub_23DB8(a1, 1, 11, *(const char **)(a2 + 8));
    v63 = json_array();
    v7 = json_object();
    ...
    sub_12D7DC((__int64)(v15 * 100.0));
    v21 = json_real();
    json_object_set_new(v7, "GHS av", v21);
    sub_12D7DC((__int64)(v14 * 100.0));
    v22 = json_real();
    ...
    sub_12D7DC((__int64)(v17 / v58 * 60.0 * 100.0));
    v28 = json_real();
    ...
    {
      LODWORD(v56) = sub_12D7CC(__SPAIR64__(v61, v64));
      HIDWORD(v56) = v55;
      LODWORD(v57) = sub_12D7CC(v60);
      sub_12D7DC((__int64)(v56 / v57 * 100.0));
    }
    v41 = json_real();
    json_object_set_new(v7, "Device Hardware%", v41);
    if ( total_diff1 )
    {
      LODWORD(v42) = sub_12D7DC(total_diff1);
      sub_12D7DC((__int64)(total_diff_rejected / v42 * 100.0));
    }
    v43 = json_real();
    json_object_set_new(v7, "Device Rejected%", v43);
    v44 = total_diff_rejected + total_diff_accepted + total_diff_stale;
    if ( v44 != 0.0 )
      sub_12D7DC((__int64)(total_diff_rejected / v44 * 100.0));
    v45 = json_real();
    json_object_set_new(v7, "Pool Rejected%", v45);
    v46 = total_diff_accepted + total_diff_rejected + total_diff_stale;
    if ( v46 != 0.0 )
      sub_12D7DC((__int64)(total_diff_stale / v46 * 100.0));
    v47 = json_real();
