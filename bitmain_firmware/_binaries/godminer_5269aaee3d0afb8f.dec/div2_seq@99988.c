int __fastcall div2_seq(int a1, int a2, int a3, int a4)
{
  ...
  sub_5E2CC(a1, a3, v12, -859045888);
  sub_5E2CC(a1, a3, v11, -65536);
  sub_5E2CC(a1, a3, v13, 52428);
  sub_5E2CC(a1, a3, v11, (int)&loc_FFFFC + 3);
  sub_5E2CC(a1, a3, v13, -859832320);
  sub_5E2CC(a1, a3, v11, -1048576);
  sub_5E2CC(a1, a3, v14, (int)&loc_CCCCC);
  sub_5E2CC(a1, a3, v11, 0xFFFFFF);
  sub_5E2CC(a1, a3, v14, -872415232);
  sub_5E2CC(a1, a3, v11, -16777216);
  sub_5E2CC(a1, a3, v15, 13421772);
  sub_5E2CC(a1, a3, v11, 4095);
  sub_5E2CC(a1, a3, v16, -858996736);
  sub_5E2CC(a1, a3, v11, -4096);
  sub_5E2CC(a1, a3, v12, 3276);
