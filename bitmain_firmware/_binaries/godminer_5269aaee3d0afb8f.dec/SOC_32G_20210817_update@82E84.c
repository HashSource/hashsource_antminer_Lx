int __fastcall SOC_32G_20210817_update(int a1, int a2, int a3, int a4)
{
  ...
  sub_5E2CC(a1, v9, v20, -196609);
  sub_5E2CC(a1, v9, v36, 196608);
  sub_5E2CC(a1, v9, v20, -196609);
  sub_5E2CC(a1, v9, v37, 196608);
  ...
  sub_5CB80(a1, v9, 145, -2147450879);
  sub_5CB80(a1, v9, 144, 0x10000000);
  sub_5CB80(a1, v9, 145, -2147450804);
  sub_5CB80(a1, v9, 144, -97);
  sub_5CB80(a1, v9, 145, -2147450879);
  sub_5CB80(a1, v9, 144, 96);
  sub_5CB80(a1, v9, 145, -2147450868);
  sub_5E2CC(a1, v9, v20, -12289);
  sub_5E2CC(a1, v9, v38, 12288);
