int __fastcall div32_20210813_500M_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  sub_5E2CC(a1, a3, (unsigned __int16)a4 | 0x8B, -65536);
  sub_5E2CC(a1, a3, (unsigned __int16)a4 | 1, -65536);
  sub_5E2CC(a1, a3, (unsigned __int16)a4 | 0x8C, 0xFFFF);
  sub_5E2CC(a1, a3, (unsigned __int16)a4 | 1, (int)&loc_FFFFC + 3);
  sub_5E2CC(a1, a3, (unsigned __int16)a4 | 0x8C, 0);
  ...
  sub_5E2CC(a1, a3, (unsigned __int16)a4 | 0x8D, -16777216);
  sub_5E2CC(a1, a3, (unsigned __int16)a4 | 1, -16777216);
  sub_5E2CC(a1, a3, a4 & 0xF000 | 0x8E, 0xFFFFFF);
  sub_5E2CC(a1, a3, (unsigned __int16)a4 | 1, 4095);
  sub_5E2CC(a1, a3, a4 & 0xF000 | 0x8A, 0);
  sub_5E2CC(a1, a3, (unsigned __int16)a4 | 1, -4096);
  sub_5E2CC(a1, a3, (unsigned __int16)a4 | 0x8B, 0);
