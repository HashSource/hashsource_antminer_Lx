...
LABEL_2:
  ...
  v6 = dev_ctrl((int)a1);
  if ( ((int (__fastcall *)(_DWORD, int, int, int *))v6[19])(a1[36], 52, 393216, &v16) )
  {
    v7 = (unsigned __int16 *)&unk_138D94;
    v8 = 700;
    v9 = (unsigned __int16)v16;
    v10 = HIWORD(v16);
    for ( i = (unsigned __int16 *)&unk_138D94; ; v8 = i[2] )
    {
...
LABEL_21:
    V_LOCK();
    V_INT((int)v21, "chain", (int)a1[37]);
    v15 = &aChipsettingTic[10 * a1[194] - 10];
    logfmt_raw(
      v23,
      0x1000u,
      0,
