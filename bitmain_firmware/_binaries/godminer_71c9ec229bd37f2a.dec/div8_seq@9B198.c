int __fastcall div8_seq(int a1, int a2, int a3, int a4)
{
  ...
  V_LOCK();
  logfmt_raw(v15, 0x1000u, 0, "%s chip_id %02x core_id %02x", "div8_seq", a2, a3);
  V_UNLOCK();
  zlog(
    g_zc,
