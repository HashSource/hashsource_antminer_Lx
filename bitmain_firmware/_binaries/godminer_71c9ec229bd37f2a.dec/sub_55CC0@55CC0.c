int __fastcall sub_55CC0(int a1)
{
  int v1; // r9
  int v3; // r10
  ...
  if ( v17 > 0 )
  {
    ...
    do
    {
      ...
      zlog(
        ...
        v24);
      v6 = *(_DWORD *)(a1 + 204);
      if ( (unsigned __int16)v5 == *(_DWORD *)(a1 + 200) )
        ++v15;
      if ( v6 > 0 )
      {
        ...
        if ( *v7 == v8 )
        {
          ...
          v13 = 0;
LABEL_18:
          *(_DWORD *)(*(_DWORD *)(a1 + 308) + v13) |= v12;
          V_LOCK();
          logfmt_raw(v24, 0x1000u, 0, "detected_chip_bitmask %x", *(_DWORD *)(*(_DWORD *)(a1 + 308) + v13));
          V_UNLOCK();
          zlog(
            g_zc,
