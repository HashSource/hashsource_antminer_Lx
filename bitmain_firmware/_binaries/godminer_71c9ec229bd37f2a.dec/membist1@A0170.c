int __fastcall membist1(int a1)
{
  ...
  do
  {
    sub_5DE08(a1, v2, 12, 1);
    usleep(0x2710u);
    sub_5DE08(a1, v2, 160, -2147483647);
    usleep((__useconds_t)&stru_18698.st_size);
    v3 = ptr;
    v4 = sub_5E074(a1, (unsigned __int16)v2, 161, ptr);
    if ( v4 > 0 )
    {
      v5 = &ptr[12 * v4];
      do
...
LABEL_9:
    v6 = ptr;
    v7 = sub_5E074(a1, (unsigned __int16)v2, 162, ptr);
    if ( v7 > 0 )
    {
      v8 = &ptr[12 * v7];
      do
      {
        ...
        V_LOCK();
        v6 += 12;
        V_INT((int)v28, "chain", *(int *)(a1 + 148));
        logfmt_raw(
          v30,
          0x1000u,
          0,
...
LABEL_15:
  ...
  v16 = strlen(v30);
  v17 = sub_5E4E4(v30, v16);
  v18 = dev_ctrl((int)v17);
  ((void (__fastcall *)(_DWORD))v18[18])(*(_DWORD *)(a1 + 144));
  unk_16CF48 = v29[1];
  unk_16CF4C = v29[2];
  unk_16CF50 = v29[3];
  unk_16CF54 = v29[4];
