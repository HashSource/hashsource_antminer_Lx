int __fastcall i2c_uninit(int a1)
{
  ...
  v4 = a1;
  v1 = pthread_mutex_lock(&stru_16E604);
  if ( v1 )
  {
  ...
  {
    if ( exists_c_map((int *)dword_16E600, (int)&v4) == (int *)1 )
    {
      ...
      zlog(
        ...
        20,
        v6);
      remove_c_map((int *)dword_16E600, (int)&v4);
    }
    else
    {
    ...
    v2 = (int (**)(void))new_iterator_c_map(dword_16E600);
    if ( (*v2)() )
    {
      do
        ++v1;
    ...
    else
    {
      ...
      zlog(
        ...
        v6);
      dword_16E5FC = 0;
      result = delete_c_map((void (__fastcall ***)(_DWORD))dword_16E600);
      dword_16E600 = 0;
    }
  }
  return result;
