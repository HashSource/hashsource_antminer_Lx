int __fastcall enable_rx_equalizer_tuning(int a1, int a2, _BYTE *a3, int a4)
{
  ...
  V_LOCK();
  v8 = 61495;
  V_INT((int)v15, "chain", *(int *)(a1 + 148));
  v9 = 61487;
  logfmt_raw(
    v17,
    0x1000u,
  ...
  sub_5F554(a1, (unsigned __int8)a3, v10, -4194305);
  sub_5F554(a1, (unsigned __int8)a3, v9, 0x400000);
  sub_5F554(a1, (unsigned __int8)a3, v10, -4194305);
  sub_5F554(a1, (unsigned __int8)a3, v9, 0);
  sub_5F554(a1, (unsigned __int8)a3, v10, -2049);
  sub_5F554(a1, (unsigned __int8)a3, v8, 2048);
  sub_5F554(a1, (unsigned __int8)a3, v10, -1073741825);
  sub_5F554(a1, (unsigned __int8)a3, v14, 0x40000000);
  sub_5F554(a1, (unsigned __int8)a3, v10, -16777217);
  sub_5F554(a1, (unsigned __int8)a3, v11, 0);
  sub_5F554(a1, (unsigned __int8)a3, v10, -16777217);
  sub_5F554(a1, (unsigned __int8)a3, v11, 0x1000000);
