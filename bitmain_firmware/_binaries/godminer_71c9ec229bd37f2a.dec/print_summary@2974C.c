char *print_summary()
{
  ...
  *(float *)&v2 = v43;
  ...
  if ( opt_algo != 3 )
    v4 = opt_algo == 0;
  LOWORD(v5) = (unsigned __int16)&dword_166EC0;
  if ( !v4 )
    v1 = 1000.0;
  HIWORD(v5) = (unsigned int)&dword_166EC0 >> 16;
  if ( v4 )
    v3 = v43;
  else
    v2 = v43;
  ...
  LODWORD(v8) = sub_12F50C(total_accepted);
  v9 = v8 / v6 * 60.0;
  ...
  zlog(
    ...
    v47);
  V_LOCK();
  logfmt_raw(v47, 0x1000u, 0, "Total got job from pools: %lld", total_getworks, dword_16E7B4);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_L7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_master/api_new.c",
  ...
  if ( total_accepted || total_rejected )
  {
    V_LOCK();
    v22 = total_rejected;
    LODWORD(v24) = sub_12F50C(100 * total_rejected);
    HIDWORD(v24) = v23;
    LODWORD(v25) = sub_12F50C(v22 + total_accepted);
  ...
  zlog(
    ...
    v47);
  V_LOCK();
  logfmt_raw(v47, 0x1000u, 0, "Stale submissions discarded due to new blocks: %lld", total_stale, dword_16E77C);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_L7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_master/api_new.c",
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        if ( *(_QWORD *)(v26 + 2096) || *(_QWORD *)(v26 + 2104) )
        {
          V_LOCK();
          v28 = *(_QWORD *)(v26 + 2104);
          LODWORD(v30) = sub_12F50C(100 * v28);
          HIDWORD(v30) = v29;
          LODWORD(v31) = sub_12F50C(v28 + *v27);
