int task_check_miner_status()
{
  ...
  pthread_mutex_lock(&stru_1682D4);
  v128[0] = 0;
  v80 = (unsigned __int8)byte_1682D0 ^ 1;
...
LABEL_100:
        V_LOCK();
        v75 |= 2u;
        V_INT((int)v140, v98, *(int *)(*(_DWORD *)v87 + 148));
...
LABEL_102:
      ...
      v51 = v76;
      v52 = v75 | 4;
      V_INT((int)v137, v98, *(int *)(*(_DWORD *)v87 + 148));
...
LABEL_104:
      V_LOCK();
      v60 = v52 | 8;
      V_INT((int)v134, v98, *(int *)(*(_DWORD *)v87 + 148));
...
LABEL_106:
        V_LOCK();
        V_INT((int)v131, v98, *(int *)(*(_DWORD *)v87 + 148));
        V_STR(v130, s, v112);
        v68 = v130[1];
        v69 = v130[2];
        v70 = v130[3];
...
LABEL_27:
  ...
  if ( v124[0] > 0 )
  {
    ...
    do
    {
      ...
      V_LOCK();
      ++v12;
      V_INT((int)v126, (char *)v84, *(int *)(*v14 + 148));
      v81 = v80;
      logfmt_raw(
        (char *)v155,
        0x1000u,
...
LABEL_74:
    ...
    if ( v155[0] > 0 )
    {
      ...
      do
      {
        ...
        v39 = (*(int (**)(void))(v38 + 8))();
        v40 = dev_ctrl(v39);
        (*(void (__fastcall **)(_DWORD))(v40 + 28))(*(_DWORD *)(*(_DWORD *)v37 + 144));
      }
      while ( v35 < v155[0] );
    }
    power_off();
...
LABEL_82:
  ...
  pthread_mutex_unlock(&stru_1682D4);
