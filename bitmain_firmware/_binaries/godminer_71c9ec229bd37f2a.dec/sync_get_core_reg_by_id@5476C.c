...
LABEL_6:
  ...
  if ( a1 != *(_DWORD *)(*all_created_runtime + 144) )
  {
    while ( ++v5 != v16 )
    {
      ...
      if ( a1 == *(_DWORD *)(v12 + 144) )
        goto LABEL_7;
    }
    goto LABEL_6;
  }
LABEL_7:
  if ( *(_DWORD *)(fake_regio_runtime + 664) == *(_DWORD *)(fake_regio_runtime + 672) )
    pthread_create(
      (pthread_t *)(fake_regio_runtime + 684),
      0,
      (void *(*)(void *))get_response,
      (void *)fake_regio_runtime);
  result = (*(int (__fastcall **)(int, int, int, int, int))(fake_regio_runtime + 192))(
             fake_regio_runtime,
             a2,
             a3,
             a4,
  ...
  if ( *(_DWORD *)(fake_regio_runtime + 664) == *(_DWORD *)(fake_regio_runtime + 672) )
  {
    v15 = *(_DWORD *)(fake_regio_runtime + 684);
    *(_BYTE *)(fake_regio_runtime + 693) = 1;
    pthread_join(v15, 0);
    return v14;
  }
  return result;
