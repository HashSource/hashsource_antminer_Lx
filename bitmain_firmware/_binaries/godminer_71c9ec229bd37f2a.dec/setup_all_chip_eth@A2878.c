int __fastcall setup_all_chip_eth(int a1)
{
  ...
  V_LOCK();
  V_INT((int)v19, "chain", *(int *)(a1 + 148));
  ...
  *(_DWORD *)(a1 + 244) = 0;
  if ( v3 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        v8 = dev_ctrl(v5);
        ((void (__fastcall *)(_DWORD))v8[7])(*(_DWORD *)(a1 + 144));
        ...
        v11 = ((int (__fastcall *)(_DWORD, _DWORD, _DWORD))v10[6])(
                ...
                *(_DWORD *)(a1 + 784));
        v12 = dev_ctrl(v11);
        ((void (__fastcall *)(_DWORD))v12[9])(*(_DWORD *)(a1 + 144));
      }
  ...
  do
    *(_BYTE *)++v14 = v13++;
  while ( v13 != 8 );
  v15 = *(void (__fastcall **)(int, int, int))(a1 + 156);
  v16 = *(_DWORD *)(a1 + 304);
  *(_DWORD *)(a1 + 248) = 1;
  v15(a1, v16, 8);
  sub_5E79C(a1, 8);
  ...
  zlog(
    ...
    60,
    v21);
  (*(void (__fastcall **)(int, _DWORD *))(a1 + 164))(a1, v18);
