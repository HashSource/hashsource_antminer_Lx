int __fastcall setup_all_chip_ckb(int a1)
{
  ...
  *(_DWORD *)(a1 + 248) = 9;
  ...
  v23 = 0;
  v24 = 0;
  (*(void (__fastcall **)(int, int *, int, _DWORD))(a1 + 176))(a1, &v23, 20000, 0);
  v6 = (int)(float)(*(float *)(a1 + 768) - 100.0) / 25;
  if ( v6 > 0 )
  {
    v7 = 25;
    v8 = 25 * (v6 + 1);
      ...
      while ( 2 )
      {
        ...
        do
        {
          ...
          if ( v13 - 800 <= 0x640 )
          {
            ...
            v21 = sub_12EF40(25 * (v13 / 0x19), v9);
            v15 = (float)sub_12EF40(v21, v11);
            goto LABEL_11;
          }
...
LABEL_11:
      ...
      zlog(
        ...
        20,
        &v23);
      (*(void (__fastcall **)(int, _DWORD *))(a1 + 164))(a1, v22);
      usleep(0x2710u);
      usleep(0x61A8u);
    }
    while ( v8 != v7 );
