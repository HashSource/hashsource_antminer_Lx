    ...
    do
    {
      ...
      if ( v10 > 0 )
      {
        ...
        do
        {
          ...
          {
            V_LOCK();
            V_INT((int)v42, "chain", *(int *)(v6 + 148));
            logfmt_raw(
              v54,
              0x1000u,
              0,
      ...
      if ( v16 > 0 )
      {
        ...
        do
        {
          ...
          {
            V_LOCK();
            V_INT((int)v44, "chain", *(int *)(v6 + 148));
            logfmt_raw(
              v54,
              0x1000u,
              0,
      ...
      if ( v22 > 0 )
      {
        ...
        do
        {
          V_LOCK();
          v21 += 12;
          V_INT((int)v46, "chain", *(int *)(v6 + 148));
          logfmt_raw(
            v54,
            0x1000u,
            0,
      ...
      if ( v24 > 0 )
      {
        ...
        do
        {
          V_LOCK();
          v23 += 12;
          V_INT((int)v48, "chain", *(int *)(v6 + 148));
          logfmt_raw(
            v54,
            0x1000u,
            0,
      ...
      if ( v26 > 0 )
      {
        ...
        do
        {
          V_LOCK();
          v25 += 12;
          V_INT((int)v50, "chain", *(int *)(v6 + 148));
          logfmt_raw(
            v54,
            0x1000u,
            0,
      ...
      if ( v28 > 0 )
      {
        ...
        do
        {
          V_LOCK();
          v27 += 12;
          V_INT((int)v52, "chain", *(int *)(v6 + 148));
          logfmt_raw(
            v54,
            0x1000u,
            0,
