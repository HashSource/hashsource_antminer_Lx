...
LABEL_4:
    ...
    while ( 1 )
    {
      v13 = *(unsigned __int8 *)(a1 + 788);
      HIWORD(v30) = 0;
      LOBYTE(v31) = v12;
      HIWORD(v31) = 0;
      v14 = *(int (__fastcall **)(int, int *))(a1 + 168);
      v28 = (v13 << 13) | 0x400;
      v15 = v14(a1, &v28);
      if ( v15 )
        break;
...
LABEL_21:
        while ( 1 )
        {
          ...
          LOBYTE(v31) = v8;
          HIWORD(v31) = 0;
          v23 = *(int (__fastcall **)(int, int *))(a1 + 168);
          v28 = (v22 << 13) | 0x9400;
          v15 = v23(a1, &v28);
          if ( v15 )
            break;
