int __fastcall check_mac_done(int a1, int a2, int a3, int a4)
{
  ...
  zlog(
    ...
    20,
    v50);
  sub_5DE08(a1, v6, 149, 0);
  sub_5DE08(a1, v6, 151, 0);
  sub_5DE08(a1, v6, 153, 0);
  sub_5DE08(a1, v6, 87, 255);
  sub_5DE08(a1, v6, 159, 0);
  sub_5DE08(a1, v6, 133, 805306367);
  if ( a4 )
  {
    if ( a4 == 1 )
    {
      sub_5DE08(a1, a3, 134, 0xFFFFFFF);
      sub_5DE08(a1, a3, 132, -2147483647);
    }
  }
  else
  {
    sub_5DE08(a1, a3, 134, 0xFFFFFFF);
    sub_5DE08(a1, a3, 132, 17);
  }
  sleep(8u);
  ...
  do
  {
    ...
    v17 = dev_ctrl(v7);
    ((void (__fastcall *)(_DWORD))v17[18])(*(_DWORD *)(a1 + 144));
    v7 = sub_5E074(a1, v16, 139, v10);
    if ( v7 > 0 )
    {
      v18 = v10;
      v30 = &v10[12 * v7];
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( (*(_DWORD *)v18 & 0xFF000000) == 0xFF000000 )
            break;
          V_LOCK();
          V_INT((int)v48, "chain", *(int *)(a1 + 148));
          logfmt_raw(
            v50,
            0x1000u,
            0,
...
LABEL_27:
        zlog(
          ...
          v50);
LABEL_28:
        if ( sub_5E294(a1, v23, v16, 135, v10) )
        {
          v21 = *(_DWORD *)v10 == 0;
          if ( *(_DWORD *)v10 )
            v21 = v29 == 3;
          ...
          {
            V_LOCK();
            V_INT((int)v40, "chain", *(int *)(a1 + 148));
            logfmt_raw(
              v50,
              0x1000u,
              0,
...
LABEL_33:
        if ( sub_5E294(a1, v23, v16, 136, v10) && *(_DWORD *)v10 )
        {
          V_LOCK();
          V_INT((int)v42, "chain", *(int *)(a1 + 148));
          logfmt_raw(
            v50,
            0x1000u,
            0,
        ...
        if ( sub_5E294(a1, v23, v16, 137, v10) )
        {
          v22 = *(_DWORD *)v10 == 0;
          if ( *(_DWORD *)v10 )
            v22 = v29 == 3;
          ...
          {
            V_LOCK();
            V_INT((int)v44, "chain", *(int *)(a1 + 148));
            logfmt_raw(
              v50,
              0x1000u,
              0,
        ...
        v7 = sub_5E294(a1, v23, v16, 138, v10);
        if ( v7 && *(_DWORD *)v10 )
        {
          V_LOCK();
          V_INT((int)v46, "chain", *(int *)(a1 + 148));
          logfmt_raw(
            v50,
            0x1000u,
            0,
