int __fastcall check_bist_rx_running_one_lane(int a1, int a2, unsigned int a3, int a4)
{
  ...
  if ( back > 0 )
  {
    ...
    do
    {
      ...
      {
        V_LOCK();
        logfmt_raw(v21, 0x1000u, 0, "channel %1x, chip_id %02x core_id %02x rx bist is running", a4, *v8, v8[1]);
        V_UNLOCK();
        v10 = g_zc;
        v11 = 60;
        v12 = 8905;
