int __fastcall get_response(int a1)
{
  ...
  snprintf(v3, 0x40u, "%.10s_%d", "get_response", *(_DWORD *)(a1 + 144));
  V_LOCK();
  v4 = syscall(224);
  ...
  {
    v6 = dev_ctrl((int)v5);
    v7 = ((int (__fastcall *)(_DWORD, char *, int))v6[13])(*(_DWORD *)(a1 + 144), v12, 256);
    v8 = *(unsigned __int8 *)(a1 + 693);
    v9 = v7;
    if ( *(_BYTE *)(a1 + 693) )
      break;
    if ( v7 <= 0 )
    ...
    {
      v2 = 64;
      queue_enqueue(*(_DWORD *)(a1 + 664), v12, v7);
      v5 = memset(v12, v8, v9);
    }
  }
  *(_BYTE *)(a1 + 693) = 0;
