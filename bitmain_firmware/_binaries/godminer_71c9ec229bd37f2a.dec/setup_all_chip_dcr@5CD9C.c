int __fastcall setup_all_chip_dcr(int a1)
{
  ...
  zlog(
    ...
    60,
    &v25);
  v3 = sub_12EF40(256, (unsigned __int8)v2);
  v4 = v3;
  v5 = *(_BYTE **)(a1 + 304);
  if ( (_BYTE)v2 )
  {
  ...
  *v5 = rand();
  *(_DWORD *)(a1 + 248) = v4;
  (*(void (__fastcall **)(int, _DWORD, int))(a1 + 156))(a1, *(_DWORD *)(a1 + 304), v2);
  V_LOCK();
  ...
  while ( 1 )
  {
    ...
    (*(void (__fastcall **)(int, _DWORD *, unsigned int))(a1 + 184))(a1, v19, v16);
    V_LOCK();
  ...
  v26 = 0;
  v25 = 0;
  (*(void (__fastcall **)(int, int *))(a1 + 168))(a1, &v25);
