bool __fastcall sub_4761C(int a1, int *a2, _DWORD *a3)
{
  _BOOL4 v4; // r4
  _DWORD *v7; // r0
  const char *v8; // r5
              ...
              if ( v4 )
              {
                ...
                if ( v4 )
                {
                  ...
                  if ( v4 )
                  {
                    ...
                    if ( memcmp(v73, &dword_168054, 0x20u) )
                    {
                      dword_168054 = *(_DWORD *)v73;
                      memset(v95, 0, sizeof(v95));
                      memset(&unk_168074, 0, 0x20u);
                      hs_blake2b_init(dest, 32);
                      hs_blake2b_update((int)dest, v73, 0x20u);
                      hs_blake2b_update((int)dest, v95, 0x20u);
                      hs_blake2b_final((int)dest, &unk_168074, 0x20u);
                      V_LOCK();
