int __fastcall check_bist_error(int a1, int a2, unsigned int a3, unsigned __int16 a4)
{
  int v7; // r2
  _DWORD *v8; // r12
  int v9; // r3
  ...
  V_LOCK();
  V_INT((int)v68, "chain", *(int *)(a1 + 148));
  logfmt_raw(
    v86,
    0x1000u,
    0,
    ...
    if ( v56 )
    {
      ...
      while ( 1 )
      {
        if ( v16 > 3 || !v57 )
        {
          ...
          if ( *(_DWORD *)(v17 + 244) != back )
          {
            V_LOCK();
            V_INT((int)v70, "chain", *(int *)(v17 + 148));
            logfmt_raw(
              v86,
              0x1000u,
              0,
                  ...
                  do
                  {
                    while ( 1 )
                    {
                      if ( (*((_DWORD *)v33 + 1) & 0xE000000) != 0 )
                      {
                        v35 = *v33;
                        V_LOCK();
                        V_INT((int)v78, "chain", *(int *)(v34 + 148));
                        logfmt_raw(
                          v86,
                          0x1000u,
                          0,
                    ...
                    do
                    {
                      ...
                      V_LOCK();
                      V_INT((int)v80, "chain", *(int *)(v62 + 148));
                      v53 = v44[1];
...
LABEL_49:
              ...
              V_LOCK();
              V_INT((int)v76, "chain", *(int *)(v17 + 148));
              logfmt_raw(
                v86,
                0x1000u,
                0,
            ...
            {
              V_LOCK();
              V_INT((int)v74, "chain", *(int *)(v17 + 148));
              logfmt_raw(
                v86,
                0x1000u,
                0,
          ...
          {
            V_LOCK();
            V_INT((int)v72, "chain", *(int *)(v17 + 148));
            logfmt_raw(
              v86,
              0x1000u,
              0,
