int __fastcall sub_27ADC(_DWORD *a1, int a2)
{
  int v4; // r0
  bool v5; // zf
  int v6; // r5
  ...
  {
    v6 = v4;
    sub_240D0(a1, 1, 11, *(const char **)(a2 + 8));
    v63 = json_array();
    v7 = json_object();
    ...
    sub_12F50C((__int64)(v13 * 100.0));
    v20 = json_real();
    json_object_set_new(v7, "GHS 5s", v20);
    sub_12F50C((__int64)(v15 * 100.0));
    v21 = json_real();
    json_object_set_new(v7, "GHS av", v21);
    sub_12F50C((__int64)(v14 * 100.0));
    v22 = json_real();
    json_object_set_new(v7, "GHS 30m", v22);
    v23 = json_integer((unsigned int)dword_166EE4);
    ...
    sub_12F50C((__int64)(v17 / v58 * 60.0 * 100.0));
    v28 = json_real();
