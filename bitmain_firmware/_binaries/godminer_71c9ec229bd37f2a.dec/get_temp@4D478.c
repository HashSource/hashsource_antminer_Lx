int __fastcall get_temp(int a1)
{
  ...
  signed int v25; // r2
  signed int v26; // t1
  int v27; // [sp+4h] [bp-D8h] BYREF
  signed int *v28; // [sp+8h] [bp-D4h] BYREF
  int *v29; // [sp+Ch] [bp-D0h]
  signed int *v30; // [sp+10h] [bp-CCh]
  int *v31; // [sp+14h] [bp-C8h]
  int v32; // [sp+20h] [bp-BCh]
  int v33; // [sp+24h] [bp-B8h]
