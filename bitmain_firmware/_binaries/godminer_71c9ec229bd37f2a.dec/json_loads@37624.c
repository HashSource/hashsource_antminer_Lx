double *__fastcall json_loads(int a1, int a2, char *a3)
{
  ...
  LOWORD(v4) = 15672;
  HIWORD(v4) = (unsigned int)"orkspace/Antminer_L7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_master/http_test.c" >> 16;
  ...
  {
    LOWORD(v10) = 15684;
    HIWORD(v10) = (unsigned int)"miner_L7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_master/http_test.c" >> 16;
    v8 = 0;
    sub_364DC((int)a3, 0, 4, v10);
  }
  return v8;
}
