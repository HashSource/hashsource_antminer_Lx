double *__fastcall json_loadb(int a1, int a2, int a3, char *a4)
{
  ...
  LOWORD(v5) = 15700;
  HIWORD(v5) = (unsigned int)"/build/rootfs/buildroot/tmp/release/build/godminer-origin_master/http_test.c" >> 16;
  jsonp_error_init(a4, v5);
  if ( a1 )
  {
    LOWORD(v9) = 25692;
    v10 = 0;
    HIWORD(v9) = (unsigned int)&loc_36C4C >> 16;
    v13[0] = a1;
    v13[1] = a2;
    v14[0] = v9;
    v13[2] = 0;
