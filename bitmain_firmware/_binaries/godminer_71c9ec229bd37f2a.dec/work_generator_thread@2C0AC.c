    ...
    while ( 1 )
    {
      ...
      if ( v8 )
      {
        logfmt_raw(
          ...
          1000LL * (tp.tv_sec - send_job_timer) + (tp.tv_nsec - dword_16E7DC) / 1000000);
        V_UNLOCK();
        v21 = 313;
      }
      else
      ...
      n = (int)&loc_F4240 * (__int64)(tp.tv_sec - send_job_timer) + (tp.tv_nsec - dword_16E7DC) / 1000;
      do
      {
        v27 = *v25++;
        v26 = v27;
      ...
      while ( v23 != 10 );
      if ( n > v24 )
        *(_QWORD *)&dword_166EF8[2 * v22 + 30] = n;
      v8 = 0;
      clock_gettime(1, (struct timespec *)&send_job_timer);
      current_pool = (pthread_mutex_t *)get_current_pool();
      v12 = (int)current_pool;
