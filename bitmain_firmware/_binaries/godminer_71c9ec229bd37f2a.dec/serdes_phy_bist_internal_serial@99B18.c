int __fastcall serdes_phy_bist_internal_serial(int a1, int a2, _DWORD *a3, int a4, unsigned __int8 a5)
{
  ...
  | (a5 << 8) & 0x700
  | (16 * a5) & 0x70);
  sub_5F554(a1, (unsigned __int8)a3, v12, -15);
  sub_5F554(a1, (unsigned __int8)a3, v15, (2 * a5) & 0xE);
  sub_5F554(a1, (unsigned __int8)a3, v12, 0);
  sub_5DE08(a1, (unsigned __int8)a3, 98, 255);
  check_bist_tx_running(a1, a2, a3, a4);
  sub_5F554(a1, (unsigned __int8)a3, v12, -13);
  sub_5F554(a1, (unsigned __int8)a3, v16, 12);
  sub_5F554(a1, (unsigned __int8)a3, v12, 0);
  config_rxifrx_sigdet_ovr(a1, a2, (unsigned __int8)a3, a4);
  read_rx_debug_reg2(a1, a2, a3, a4);
  sub_5F554(a1, (unsigned __int8)a3, v12, -9);
  sub_5F554(a1, (unsigned __int8)a3, v13, 8);
  sub_5F554(a1, (unsigned __int8)a3, v12, -1073741825);
  sub_5F554(a1, (unsigned __int8)a3, v9, 0x40000000);
  sub_5F554(a1, (unsigned __int8)a3, v12, 0);
  usleep((__useconds_t)&stru_18698.st_size);
  check_bist_rx_running(a1, a2, (unsigned int)a3, a4);
  sub_5F554(a1, (unsigned __int8)a3, v12, -9);
  sub_5F554(a1, (unsigned __int8)a3, v13, 0);
  sub_5F554(a1, (unsigned __int8)a3, v12, 0);
