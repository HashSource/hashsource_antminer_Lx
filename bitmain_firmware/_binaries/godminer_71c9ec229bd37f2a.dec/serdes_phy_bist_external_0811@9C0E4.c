        ...
        int a7)
{
  ...
  V_LOCK();
  V_INT((int)v25, "chain", *(int *)(a1 + 148));
  v10 = 61458;
  logfmt_raw(
    (char *)&v27,
    0x1000u,
  ...
  | (a5 << 8) & 0x700
  | (16 * a5) & 0x70);
  sub_5F554(a1, (unsigned __int8)a3, v11, -15);
  sub_5F554(a1, (unsigned __int8)a3, v10, (2 * a5) & 0xE);
  sub_5F554(a1, (unsigned __int8)a3, v11, 0);
  if ( a6 )
  {
    v18 = a6 >> 1;
    if ( a6 >> 1 )
...
LABEL_23:
  ...
  read_rx_debug_reg2_one_lane(a1, a2, a3, 7u);
  sub_5DE08(a1, (unsigned __int8)a3, 144, -9);
  sub_5DE08(a1, (unsigned __int8)a3, 145, -2147467263);
  sub_5DE08(a1, (unsigned __int8)a3, 144, 8);
  sub_5DE08(a1, (unsigned __int8)a3, 145, -2147467119);
  sub_5DE08(a1, (unsigned __int8)a3, 144, -1073741825);
  sub_5DE08(a1, (unsigned __int8)a3, 145, -2147467263);
  sub_5DE08(a1, (unsigned __int8)a3, 144, 0x40000000);
  sub_5DE08(a1, (unsigned __int8)a3, 145, -2147467145);
  sub_5DE08(a1, (unsigned __int8)a3, 144, 0);
  sub_5DE08(a1, (unsigned __int8)a3, 145, -2147467263);
  usleep((__useconds_t)&loc_F4240);
  check_bist_tx_running_one_lane(a1, a2, (unsigned int)a3, 7);
  check_bist_rx_running_one_lane(a1, a2, (unsigned int)a3, 4);
  usleep(0x493E0u);
  sub_5DE08(a1, (unsigned __int8)a3, 144, -9);
  sub_5DE08(a1, (unsigned __int8)a3, 145, -2147467263);
  sub_5DE08(a1, (unsigned __int8)a3, 144, 0);
  ...
  check_bist_done_one_lane(a1, a2, (unsigned int)a3, 4);
  check_bist_done_one_lane(a1, a2, (unsigned int)a3, 7);
  check_bist_error_one_lane(a1, a2, (unsigned int)a3, 4);
  if ( _6D != v14 )
    goto LABEL_23;
LABEL_26:
  if ( v24 == 4 )
