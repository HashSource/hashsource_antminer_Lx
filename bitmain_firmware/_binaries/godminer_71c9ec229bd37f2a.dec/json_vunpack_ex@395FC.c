int __fastcall json_vunpack_ex(_DWORD *a1, char *a2, int a3, _BYTE *a4, _QWORD **a5)
{
  ...
  if ( a1 )
  {
    if ( a4 && *a4 )
    {
      ...
      else
      {
        ...
        if ( (_BYTE)v19 )
        {
          LOWORD(v13) = 16708;
          LOWORD(v14) = 15884;
          HIWORD(v13) = (unsigned int)"g pool %d to pool %d" >> 16;
          HIWORD(v14) = (unsigned int)": get test = %d" >> 16;
          sub_37BF0(v18, v14, 9, v13);
          return -1;
        }
      }
    }
    else
    {
      ...
      LOWORD(format) = 16680;
      HIWORD(format) = (unsigned int)" pool in add_pool" >> 16;
  ...
  {
    LOWORD(v15) = 16736;
    HIWORD(v15) = (unsigned int)"No pool %d found!" >> 16;
    v9 = -1;
    jsonp_error_init(a2, v15);
    LOWORD(v16) = 16744;
    HIWORD(v16) = (unsigned int)"%d found!" >> 16;
