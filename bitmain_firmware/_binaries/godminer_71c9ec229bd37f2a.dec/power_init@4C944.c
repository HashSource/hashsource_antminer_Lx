int power_init()
{
  ...
  v1 = (unsigned __int8)byte_168240;
  if ( byte_168240 )
  {
    ...
    while ( &byte_16825C != v3 );
    if ( (unsigned __int16)word_168242 != v2 )
    {
      V_LOCK();
      logfmt_raw(v21, 0x1000u, 0, "power version error, expect %04x, actual %04x", (unsigned __int16)word_168242, v2);
      V_UNLOCK();
      v14 = g_zc;
      v15 = 232;
      goto LABEL_37;
...
LABEL_6:
    ...
    if ( opt_custom_voltage_swith || is_eeprom_loaded() )
      dword_168248 = opt_custom_voltage;
    V_LOCK();
    ...
    zlog(
      ...
      v21);
    V_LOCK();
    logfmt_raw(v21, 0x1000u, 0, "current_voltage_raw     = %d", dword_168260);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_L7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
      ...
      v21);
    V_LOCK();
    logfmt_raw(v21, 0x1000u, 0, "working_voltage_raw     = %d", dword_168248);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_L7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
      ...
      v21);
    V_LOCK();
    logfmt_raw(v21, 0x1000u, 0, "check_asic_voltage_enable     = %d", (unsigned __int8)byte_16824C);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_L7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
      ...
      v21);
    V_LOCK();
    logfmt_raw(v21, 0x1000u, 0, "check_asic_voltage_raw  = %d", dword_168250);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_L7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_"
    ...
    else
    {
      ...
      {
        v18 = dword_168260;
        v6 = (double)dword_168260 * 0.75 / 100.0;
      }
      else
      {
        v6 = -0.0075;
