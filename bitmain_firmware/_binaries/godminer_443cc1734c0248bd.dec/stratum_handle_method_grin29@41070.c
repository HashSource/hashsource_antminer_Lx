            ...
            while ( v173 > v91 )
            {
              ...
              if ( !v129 || strlen(v129) != 64 )
              {
                ...
                zlog(
                  ...
                  "iner-origin_master/frontend/frontend_grin29/frontend_grin29.c",
                  163,
                  "stratum_notify",
                  14,
                  235,
  ...
  else
  {
    ...
    if ( strcasecmp(v8, "client.get_algo") )
    {
      if ( !strcasecmp(v8, "client.get_stats") )
      {
        ...
        {
          sub_3FDB4(v93, (_DWORD *)1, "disabled");
        }
...
LABEL_90:
      ...
      else
      {
        ...
        sub_3FDB4(v71, (_DWORD *)0x26, "unknown method");
        v76 = json_dumps(v71, 0);
        v10 = stratum_send_line((int *)a2, v76);
        if ( v71 && v71[1] != -1 )
        {
