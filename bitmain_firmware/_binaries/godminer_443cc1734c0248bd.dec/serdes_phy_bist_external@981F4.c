int __fastcall serdes_phy_bist_external(int a1, int a2, _BYTE *a3, int a4, unsigned __int8 a5, int a6)
{
  ...
  sub_5D4B4(a1, (unsigned __int8)a3, v11, (2 * a5) & 0xE);
  ...
  {
    v26 = 336529925;
    sub_5BD68(a1, (unsigned __int8)a3, 98, 16);
    ...
    for ( i = 5; ; i = v15 )
    {
      ...
      sub_5BD68(a1, (unsigned __int8)a3, 144, -9);
      sub_5BD68(a1, (unsigned __int8)a3, 145, -2147454975);
      sub_5BD68(a1, (unsigned __int8)a3, 144, 8);
      sub_5BD68(a1, (unsigned __int8)a3, 145, -2147454831);
      sub_5BD68(a1, (unsigned __int8)a3, 144, -1073741825);
      sub_5BD68(a1, (unsigned __int8)a3, 145, -2147454975);
      sub_5BD68(a1, (unsigned __int8)a3, 144, 0x40000000);
      sub_5BD68(a1, (unsigned __int8)a3, 145, -2147454857);
    ...
    sub_5BD68(a1, (unsigned __int8)a3, 98, 0);
    sub_5BD68(a1, 3u, 83, 0);
    sub_5BD68(a1, (unsigned __int8)a3, 98, 128);
    for ( j = 5; ; j = v21 )
    {
      enable_rxbist_autostop_one_lane(a1, a2, (unsigned __int8)a3, 7u, j);
      sub_5BD68(a1, (unsigned __int8)a3, 144, -13);
      sub_5BD68(a1, (unsigned __int8)a3, 145, -2147454975);
      sub_5BD68(a1, (unsigned __int8)a3, 144, 12);
      sub_5BD68(a1, (unsigned __int8)a3, 145, -2147454962);
      sub_5BD68(a1, (unsigned __int8)a3, 144, 0);
      sub_5BD68(a1, (unsigned __int8)a3, 145, -2147454975);
