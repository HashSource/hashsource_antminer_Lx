int __fastcall sub_333D0(_DWORD *a1, int a2, int a3, _DWORD *a4, int (__fastcall *a5)(char *, int, int), int a6)
{
  _DWORD *v7; // r5
  int v8; // r9
  unsigned int v9; // r8
    ...
    case 0:
      ...
      if ( (v11 & 0x80) == 0 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( sub_333D0(v28, v9, v48, (int)v7, a5, a6) )
            return -1;
          if ( !v23 )
          {
            v8 = (int)base;
            v14 = 0;
            if ( !sub_332C8(v9, v44, 0, a5, a6) )
              goto LABEL_65;
            return -1;
          }
          if ( a5((char *)&word_12DAF4, 1, a6) || sub_332C8(v9, v48, 1, a5, a6) )
            return -1;
        }
      }
      ...
      while ( v34 );
      v7 = (_DWORD *)v51;
      qsort(basea, nmemb, 4u, (__compar_fn_t)sub_33034);
      if ( nmemb )
      {
        v53 = v8;
        v36 = v52;
        ...
        do
        {
          ...
          v40 = strlen(v38);
          sub_33040(v38, v40, a5, a6, v9);
          if ( a5(v41, v43, a6) || sub_333D0(v39, v9, v48, v51, a5, a6) )
          {
LABEL_70:
            v14 = -1;
            jsonp_free(basea);
          ...
          else if ( sub_332C8(v9, a3, 0, a5, a6) )
          {
            goto LABEL_70;
          }
        }
...
LABEL_47:
    ...
    case 2:
      ...
      return sub_33040(v16, (int)v17, a5, a6, v9);
    case 3:
    ...
    case 4:
      json_real_value();
      v20 = jsonp_dtostr(s, 0x64u, (unsigned __int16)v9 >> 11);
      if ( v20 < 0 )
        return -1;
      return a5(s, v20, a6);
    case 5:
  ...
  do
  {
    ...
    v14 = sub_333D0(v31, v9, v30, (int)v7, a5, a6);
    if ( v14 )
      return -1;
    v32 = (unsigned int)v42 - 1 > v29++;
    if ( v32 )
    {
      if ( a5((char *)&word_12DAF4, 1, a6) || sub_332C8(v9, v30, 1, a5, a6) )
        return -1;
    }
    else if ( sub_332C8(v9, v45, 0, a5, a6) )
    {
      return -1;
    }
  }
