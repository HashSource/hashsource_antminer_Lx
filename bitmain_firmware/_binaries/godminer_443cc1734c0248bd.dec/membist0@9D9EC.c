int __fastcall membist0(int a1)
{
  ...
  do
  {
    ...
    do
    {
      sub_5BD68(a1, v26, 12, 1);
      sub_5BD68(a1, v26, 160, 3);
      usleep((__useconds_t)&stru_18694.st_info);
      v3 = ptr;
      v4 = sub_5BFD4(a1, (unsigned __int16)v26, 161, ptr);
      if ( v4 > 0 )
      {
        v5 = &ptr[12 * v4];
        do
...
LABEL_10:
      v6 = ptr;
      v7 = sub_5BFD4(a1, (unsigned __int16)v26, 162, ptr);
      if ( v7 > 0 )
      {
        v8 = &ptr[12 * v7];
        do
...
LABEL_16:
      v9 = ptr;
      v10 = sub_5BFD4(a1, (unsigned __int16)v26, 163, ptr);
      if ( v10 > 0 )
      {
        v11 = &ptr[12 * v10];
        do
