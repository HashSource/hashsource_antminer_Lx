int __fastcall membist1(int a1)
{
  ...
  do
  {
    sub_5BD68(a1, v2, 12, 1);
    usleep(0x2710u);
    sub_5BD68(a1, v2, 160, -2147483647);
    usleep((__useconds_t)&stru_18694.st_info);
    v3 = ptr;
    v4 = sub_5BFD4(a1, (unsigned __int16)v2, 161, ptr);
    if ( v4 > 0 )
    {
      v5 = &ptr[12 * v4];
      do
...
LABEL_9:
    v6 = ptr;
    v7 = sub_5BFD4(a1, (unsigned __int16)v2, 162, ptr);
    if ( v7 > 0 )
    {
      v8 = &ptr[12 * v7];
      do
