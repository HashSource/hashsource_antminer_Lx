        ...
        unsigned __int8 a5)
{
  ...
  zlog(
    ...
    60,
    v11);
  sub_5D4B4(a1, a3, a4 | 1, -5);
  sub_5D4B4(a1, a3, a4 & 0xF000 | 0x11, 4);
  sub_5D4B4(a1, a3, a4 | 1, -66060289);
  sub_5D4B4(a1, a3, a4 & 0xF000 | 0x13, (a5 << 20) & 0x3F00000);
  sub_5D4B4(a1, a3, a4 | 1, 0);
  return 0;
}
