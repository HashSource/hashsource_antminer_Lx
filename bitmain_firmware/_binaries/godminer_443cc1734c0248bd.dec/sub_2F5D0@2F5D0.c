void sub_2F5D0()
{
  ...
  if ( dword_164458 > 0 )
  {
    ...
    do
    {
      v5 = sub_2E9A4();
      ++v4;
      sub_2E370((void **)(v5 + 8), (_BYTE *)(v5 + 24), v3);
      set_user(v3 + 256);
      v6 = v3 + 512;
      v3 += 768;
      set_pass(v6);
    }
    while ( dword_164458 > v4 );
  }
  if ( total_pools == v39 )
  {
    V_LOCK();
  ...
  if ( v40 )
  {
    ...
    v34 = pthread_create((pthread_t *)&dword_16BD14, &attr, (void *(*)(void *))watchpool_thread, &dword_16BD10);
