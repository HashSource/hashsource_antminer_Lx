bool __fastcall sub_45DB8(int a1, pthread_mutex_t *a2, _DWORD *a3)
{
  _BOOL4 v4; // r4
  _DWORD *v7; // r0
  const char *v8; // r5
              ...
              if ( v4 )
              {
                ...
                if ( v4 )
                {
                  ...
                  if ( v4 )
                  {
                    ...
                    if ( memcmp(v73, &dword_16502C, 0x20u) )
                    {
                      dword_16502C = *(_DWORD *)v73;
                      memset(v95, 0, sizeof(v95));
                      memset(&unk_16504C, 0, 0x20u);
                      hs_blake2b_init(dest, 32);
                      hs_blake2b_update((int)dest, v73, 0x20u);
                      hs_blake2b_update((int)dest, v95, 0x20u);
                      hs_blake2b_final((int)dest, &unk_16504C, 0x20u);
                      V_LOCK();
