int __fastcall SOC_24G_20210915_update(int a1, int a2, unsigned __int8 a3, int a4)
{
  ...
  sub_5D4B4(a1, a3, v44, 0x4000000);
  sub_5BD68(a1, a3, 144, -131073);
  sub_5BD68(a1, a3, 145, -2147450879);
  sub_5BD68(a1, a3, 144, 0);
  sub_5BD68(a1, a3, 145, -2147450818);
  sub_5D4B4(a1, a3, v7, -262145);
  sub_5D4B4(a1, a3, v45, 0x40000);
  sub_5D4B4(a1, a3, v7, -1025);
  sub_5D4B4(a1, a3, v46, 1024);
  sub_5D4B4(a1, a3, v7, -8388609);
  sub_5D4B4(a1, a3, v47, 0x800000);
  sub_5D4B4(a1, a3, v7, 0xFFFFFFF);
  sub_5D4B4(a1, a3, v48, 1610612736);
