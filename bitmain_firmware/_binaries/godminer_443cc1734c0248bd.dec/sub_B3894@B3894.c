int __fastcall sub_B3894(int a1, int a2)
{
  int v3; // r7
  int *v4; // r11
  int v5; // r4
  ...
  zlog(
    ...
    20,
    v9);
  if ( pthread_mutex_lock(&stru_16B338) )
  {
  ...
  if ( a2 == 1 )
  {
    sub_B36D0((int *)v3, (int *)dword_16B350);
    v5 = gpio_write(v3, 0);
    pthread_mutex_unlock(&stru_16B338);
  }
  else if ( a2 == 2 )
  {
    v7 = v3;
    ...
    {
      v5 = -1;
      if ( exists_c_map((int *)dword_16B350, (int)&v7) )
      {
