      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            ...
            while ( 1 )
            {
              v11 = (*(int (__fastcall **)(int *))(v2 + 4))(v10) == 0;
              v12 = v4;
              if ( !v11 )
              {
              ...
              (*(void (__fastcall **)(int *, int *))(v2 + 8))(v4, v12);
...
LABEL_21:
        ...
        v14 = (*(int (__fastcall **)(int *))(v2 + 12))(v4);
        v15 = (void *)v14;
        if ( !v14 )
          goto LABEL_21;
        if ( !(*(int (__fastcall **)(int, int *, int))(v2 + 24))(v2, v4, v14) )
