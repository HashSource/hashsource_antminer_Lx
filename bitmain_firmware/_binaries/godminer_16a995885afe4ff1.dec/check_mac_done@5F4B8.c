int __fastcall check_mac_done(int a1, int a2, int a3, int a4)
{
  ...
  zlog(
    ...
    20,
    v50);
  sub_5C8F0(a1, v6, 149, 0);
  sub_5C8F0(a1, v6, 151, 0);
  sub_5C8F0(a1, v6, 153, 0);
  sub_5C8F0(a1, v6, 87, 255);
  sub_5C8F0(a1, v6, 159, 0);
  sub_5C8F0(a1, v6, 133, 805306367);
  if ( a4 )
  {
    if ( a4 == 1 )
    {
      sub_5C8F0(a1, a3, 134, 0xFFFFFFF);
      sub_5C8F0(a1, a3, 132, -2147483647);
    }
  }
  else
  {
    sub_5C8F0(a1, a3, 134, 0xFFFFFFF);
    sub_5C8F0(a1, a3, 132, 17);
  }
  sleep(8u);
...
LABEL_46:
          ...
          v7 = zlog(
                 ...
                 "ase/build/godminer-origin_master/backend/backend_eth/backend_eth.c",
                 169,
                 "check_mac_done",
                 14,
                 v25,
...
LABEL_27:
        zlog(
          ...
          v50);
LABEL_28:
        if ( sub_5CD7C(a1, v23, v16, 135, v10) )
        {
          v21 = *(_DWORD *)v10 == 0;
          if ( *(_DWORD *)v10 )
            v21 = v29 == 3;
...
LABEL_33:
        if ( sub_5CD7C(a1, v23, v16, 136, v10) && *(_DWORD *)v10 )
        {
          V_LOCK();
        ...
        if ( sub_5CD7C(a1, v23, v16, 137, v10) )
        {
          v22 = *(_DWORD *)v10 == 0;
          if ( *(_DWORD *)v10 )
            v22 = v29 == 3;
        ...
        v7 = sub_5CD7C(a1, v23, v16, 138, v10);
        if ( v7 && *(_DWORD *)v10 )
        {
          V_LOCK();
