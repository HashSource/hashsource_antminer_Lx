int __fastcall membist0(int a1)
{
  ...
  do
  {
    ...
    do
    {
      sub_5C8F0(a1, v26, 12, 1);
      sub_5C8F0(a1, v26, 160, 3);
      usleep((__useconds_t)&stru_1869C.st_value);
      v3 = ptr;
      v4 = sub_5CB5C(a1, (unsigned __int16)v26, 161, ptr);
      if ( v4 > 0 )
      {
        v5 = &ptr[12 * v4];
        do
        {
          while ( (*(_DWORD *)v3 & 0x80) == 0 )
          {
            V_LOCK();
            v3 += 12;
            V_INT((int)v34, "chain", *(int *)(a1 + 140));
            logfmt_raw(
              v41,
              0x1000u,
              0,
...
LABEL_10:
      v6 = ptr;
      v7 = sub_5CB5C(a1, (unsigned __int16)v26, 162, ptr);
      if ( v7 > 0 )
      {
        v8 = &ptr[12 * v7];
        do
...
LABEL_16:
      v9 = ptr;
      v10 = sub_5CB5C(a1, (unsigned __int16)v26, 163, ptr);
      if ( v10 > 0 )
      {
        v11 = &ptr[12 * v10];
        do
