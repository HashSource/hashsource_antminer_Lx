int __fastcall pic1704_get_single_voltage(char a1, _DWORD *a2)
{
  ...
  *(_DWORD *)&v14[3] = 0;
  v13 = 0;
  result = sub_ACC1C(v15, 0, (int)&v12, v14);
  if ( result )
  {
    v5 = v14[2];
    v6 = v14[0];
    ...
    if ( v14[2] == 1 && v14[0] > 3u )
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/backend/device/hal/drv_pic/pic_1704.c",
        173,
        "check_pic_crc",
        13,
        397,
      ...
      if ( v2 == v10 )
      {
        ...
        *a2 = (unsigned __int16)v11;
        ...
        zlog(
          ...
          "ld/godminer-origin_master/backend/device/hal/drv_pic/pic_1704.c",
          173,
