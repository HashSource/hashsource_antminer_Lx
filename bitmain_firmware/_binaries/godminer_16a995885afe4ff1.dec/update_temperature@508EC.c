int __fastcall update_temperature(int a1, _DWORD *a2, int a3)
{
  ...
  if ( read_temperature(a1, a2, &v26, &v27, &v28, &v29, &v30, &v31, &v32) )
  {
    ...
    zlog(
      ...
      "odminer-origin_master/miner_util/miner_monitor/update_miner_status/update_temperature.c",
      201,
      "update_temperature",
      18,
      269,
  ...
  LOWORD(v8) = (unsigned __int16)&unk_16A6A0;
  v9 = *(_DWORD *)(a1 + 136);
  if ( v30 )
  {
    v14 = v31;
...
LABEL_8:
    ...
    *(_DWORD *)(v11 + 16) = v12;
    if ( !(v13 ^ __OFSUB__(v12, 2) | (v12 == 2)) )
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/miner_util/miner_monitor/update_miner_status/update_temperature.c",
        201,
        "update_temperature",
        18,
        281,
  ...
  *(_DWORD *)(v8 + v10 + 32) = v23;
  ...
  {
    V_LOCK();
    V_INT((int)v37, "chain", *(int *)(a1 + 140));
    logfmt_raw(
      v45,
      0x1000u,
      v14,
...
LABEL_9:
  ...
  else
  {
    ...
    *(_DWORD *)(v8 + v10 + 48) = v17;
    ...
    {
      V_LOCK();
      V_INT((int)v39, "chain", *(int *)(a1 + 140));
      logfmt_raw(
        v45,
        0x1000u,
        0,
  ...
  if ( a2[4] > v16[2] || *(_DWORD *)(v8 + 4 * v9) > v16[3] )
  {
    ...
    *(_DWORD *)(v8 + v10 + 64) = v24;
    ...
    {
      V_LOCK();
      V_INT((int)v41, "chain", *(int *)(a1 + 140));
      logfmt_raw(
        v45,
        0x1000u,
        0,
  ...
  if ( a2[5] <= v16[4] )
  {
    ...
    *(_DWORD *)(v18 + 80) = v19;
    ...
    {
      V_LOCK();
      V_INT((int)v43, "chain", *(int *)(a1 + 140));
      logfmt_raw(
        v45,
        0x1000u,
        0,
