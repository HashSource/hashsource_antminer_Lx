int __fastcall check_nonce_hns(int a1, int a2)
{
  ...
  HIBYTE(dest[62]) = v7;
  dest[63] = v8;
  sub_A5788("awork", (int)v5, 256);
  sub_A5788("pwork", (int)dest, 256);
  hns_hash((int)dest);
  sub_A5788("target", v2 + 32 * (*(unsigned __int8 *)(a2 + 57) + 1200), 32);
  sub_A5788("vvhash", (int)v13, 32);
  ...
  if ( v9 <= 0x19 )
  {
    ...
    zlog(
      ...
      "odminer-origin_master/backend/backend_hns/backend_hns.c",
      169,
      "check_nonce_hns",
      15,
      365,
  ...
  else
  {
    ...
    if ( v11 == v9 )
    {
      if ( v6 > v11 )
      {
        ...
        zlog(
          ...
          "ld/godminer-origin_master/backend/backend_hns/backend_hns.c",
          169,
          "check_nonce_hns",
          15,
          375,
    ...
    else
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/backend/backend_hns/backend_hns.c",
        169,
        "check_nonce_hns",
        15,
        370,
