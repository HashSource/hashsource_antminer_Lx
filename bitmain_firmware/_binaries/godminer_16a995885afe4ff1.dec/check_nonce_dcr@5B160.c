int __fastcall check_nonce_dcr(int a1, int a2)
{
  ...
  if ( v9 <= 0x1F )
  {
    ...
    zlog(
      ...
      "odminer-origin_master/backend/backend_dcr/backend_dcr.c",
      169,
      "check_nonce_dcr",
      15,
      357,
...
LABEL_9:
        ...
        zlog(
          ...
          "ld/godminer-origin_master/backend/backend_dcr/backend_dcr.c",
          169,
          "check_nonce_dcr",
          15,
          367,
      ...
      else
      {
        ...
        do
        {
          ...
          zlog(
            ...
            "uild/godminer-origin_master/backend/backend_dcr/backend_dcr.c",
            169,
            "fulltest_dcr",
            12,
            306,
    ...
    else
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/backend/backend_dcr/backend_dcr.c",
        169,
        "check_nonce_dcr",
        15,
        362,
