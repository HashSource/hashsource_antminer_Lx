int sub_4ED04()
{
  ...
  result = zlog(
             ...
             "build/godminer-origin_master/miner_util/miner_monitor/miner_monitor.c",
             176,
             "task_applog_printer",
             19,
             116,
  ...
  if ( v24 > 0 )
  {
    ...
    do
    {
      ...
      result = zlog(
                 ...
                 "ase/build/godminer-origin_master/miner_util/miner_monitor/miner_monitor.c",
                 176,
                 "task_applog_printer",
                 19,
                 138,
