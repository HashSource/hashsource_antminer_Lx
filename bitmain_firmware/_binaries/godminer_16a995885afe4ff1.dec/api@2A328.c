...
LABEL_9:
  ...
  while ( bind(v3, v0->ai_addr, v0->ai_addrlen) < 0 )
  {
    ...
    if ( time(0) - v4 > 61 )
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/api_new.c",
        145,
        "api_init_socket",
        15,
        1930,
  ...
  if ( v3 >= 0 )
  {
    ...
    while ( 1 )
    {
      servlen = (unsigned __int8)byte_164EC4;
      if ( byte_164EC4 )
      {
LABEL_102:
      ...
      *(_DWORD *)::s1 = servlen;
      dword_164EB8 = servlen;
      dword_164EBC = servlen;
      dword_164EC0 = servlen;
      v134[v9] = servlen;
      *(_DWORD *)v102 = servlen;
      *(_DWORD *)v106 = servlen;
      v103 = servlen;
      ...
      v108 = servlen;
      v109 = servlen;
      dword_164EB0 = time((time_t *)servlen);
      ...
      *(_DWORD *)s1 = servlen;
      ...
      if ( !v18 || *(_DWORD *)v18 )
      {
        ...
        sub_25C9C(v17, v102, (int)v106, 2u);
        goto LABEL_33;
      }
      ...
      if ( v43 && *v43 == 2 )
      {
        ...
        if ( v80 && *v80 == 5 )
        {
          ...
          {
            v89 = protocol;
            sub_25C9C(v17, v102, (int)v106, protocol);
            goto LABEL_33;
          }
          v82 = protocol;
        }
        else
        {
          ...
          {
            v89 = 1;
            sub_25C9C(v17, v102, (int)v106, 1u);
            goto LABEL_33;
          }
          v82 = 1;
        }
        ...
        if ( v85 )
        {
          sub_25C9C(v17, v102, (int)v106, v82);
        }
        else
        {
          json_delete(v19);
          sub_25C9C(v17, v102, (int)v106, v89);
        }
      }
      else
      {
        ...
        zlog(
          ...
          100,
          v126);
        sub_23CA0(v17, 0, 24, "Missing JSON 'command'");
      }
LABEL_33:
      if ( v89 == 2 )
      {
...
LABEL_119:
  ...
  return zlog(
           ...
           "ild/godminer-origin_master/api_new.c",
           145,
           "api",
           3,
           2281,
