int __fastcall sync_get_core_reg_ltc(int a1, int a2, int a3, int a4, int *a5, unsigned __int64 a6)
{
  ...
  sub_12D6FC(a6, 0x3E8u);
  v31[1] = 1000000 * v21;
  v27 = 0;
  v31[0] = sub_12D6FC(a6, 0x3E8u);
  while ( a3 > v27 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 664), v32, 9u, v31) == 110 )
      {
        v7 = 3;
        goto LABEL_16;
      }
      ...
      if ( (v35 & 0x10) != 0 )
      {
        ...
        zlog(
          ...
          "ld/godminer-origin_master/backend/backend_ltc/chip_reg_io_ltc.c",
          173,
