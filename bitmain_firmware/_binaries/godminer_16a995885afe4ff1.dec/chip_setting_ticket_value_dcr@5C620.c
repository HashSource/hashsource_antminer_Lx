int __fastcall chip_setting_ticket_value_dcr(int a1, int a2)
{
  ...
  V_LOCK();
  logfmt_raw(v12, 0x1000u, 0, "ticket_mask %s reg %02x tm %02x", "chip_setting_ticket_value_dcr", 3, a2, v7, 0, 0, 0, 0);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/buildroot/tmp/release/build/god"
    "miner-origin_master/backend/backend_dcr/chip_setting_dcr.c",
    174,
