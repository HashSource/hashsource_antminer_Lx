int __fastcall SOC_32G_20210817_update(int a1, int a2, int a3, int a4)
{
  ...
  sub_5E03C(a1, v9, v20, -196609);
  sub_5E03C(a1, v9, v33, 196608);
  sub_5E03C(a1, v9, v20, -196609);
  sub_5E03C(a1, v9, v34, 196608);
  ...
  sub_5C8F0(a1, v9, 145, -2147450879);
  sub_5C8F0(a1, v9, 144, 0x10000000);
  sub_5C8F0(a1, v9, 145, -2147450804);
  sub_5C8F0(a1, v9, 144, -97);
  sub_5C8F0(a1, v9, 145, -2147450879);
  sub_5C8F0(a1, v9, 144, 96);
  sub_5C8F0(a1, v9, 145, -2147450868);
  sub_5E03C(a1, v9, v20, -12289);
  sub_5E03C(a1, v9, v35, 12288);
