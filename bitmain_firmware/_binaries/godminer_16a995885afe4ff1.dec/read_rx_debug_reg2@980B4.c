int __fastcall read_rx_debug_reg2(int a1, int a2, _BYTE *a3, unsigned __int16 a4)
{
  ...
  if ( a4 )
  {
    ...
    do
    {
      ...
      sub_5E03C(a1, (unsigned __int8)a3, v8 | 1, -9);
      sub_5E03C(a1, (unsigned __int8)a3, v8 | 0x16, 0);
      sub_5E03C(a1, (unsigned __int8)a3, v8 | 1, -9);
      v11 = v8 | 0x16;
      v12 = v8 | 0x1A;
      sub_5E03C(a1, (unsigned __int8)a3, v11, 8);
      sub_5E03C(a1, (unsigned __int8)a3, v9, -9);
      sub_5E03C(a1, (unsigned __int8)a3, v10, 0);
      sub_5DE94(a1, a3, v12);
      sub_5E03C(a1, (unsigned __int8)a3, v9, -9);
      sub_5E03C(a1, (unsigned __int8)a3, v10, 0);
      sub_5E03C(a1, (unsigned __int8)a3, v9, -9);
      sub_5E03C(a1, (unsigned __int8)a3, v10, 8);
      sub_5E03C(a1, (unsigned __int8)a3, v9, -9);
      sub_5E03C(a1, (unsigned __int8)a3, v10, 0);
      sub_5DE94(a1, a3, v12);
      sub_5E03C(a1, (unsigned __int8)a3, v9, -9);
