int __fastcall i2c_uninit(int a1)
{
  ...
  v4 = a1;
  v1 = pthread_mutex_lock(&stru_16C5D4);
  if ( v1 )
  {
  ...
  {
    if ( exists_c_map((int *)dword_16C5D0, (int)&v4) == (int *)1 )
    {
      ...
      zlog(
        ...
        20,
        v6);
      remove_c_map((int *)dword_16C5D0, (int)&v4);
    }
    else
    {
    ...
    v2 = (int (**)(void))new_iterator_c_map(dword_16C5D0);
    if ( (*v2)() )
    {
      do
        ++v1;
      ...
      return zlog(
               ...
               "e/build/godminer-origin_master/backend/device/hal/platform/7007/7007_i2c.c",
               179,
               "i2c_uninit",
               10,
               82,
    ...
    else
    {
      ...
      zlog(
        ...
        v6);
      dword_16C5CC = 0;
      result = delete_c_map((void (__fastcall ***)(_DWORD))dword_16C5D0);
      dword_16C5D0 = 0;
    }
  }
  return result;
