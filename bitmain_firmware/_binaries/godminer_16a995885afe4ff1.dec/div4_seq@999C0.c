int __fastcall div4_seq(int a1, int a2, int a3, int a4)
{
  ...
  sub_5E03C(a1, a3, v9, -252706816);
  sub_5E03C(a1, a3, v8, -65536);
  sub_5E03C(a1, a3, v10, 61680);
  sub_5E03C(a1, a3, v8, (int)&loc_FFFFC + 3);
  sub_5E03C(a1, a3, v10, 251658240);
  sub_5E03C(a1, a3, v8, -1048576);
  sub_5E03C(a1, a3, v11, (int)&loc_F0F0C + 3);
  sub_5E03C(a1, a3, v8, 0xFFFFFF);
  sub_5E03C(a1, a3, v11, -268435456);
  sub_5E03C(a1, a3, v8, -16777216);
  sub_5E03C(a1, a3, v12, 15790320);
  sub_5E03C(a1, a3, v8, 4095);
  sub_5E03C(a1, a3, v13, 252641280);
  sub_5E03C(a1, a3, v8, -4096);
  sub_5E03C(a1, a3, v9, 3855);
