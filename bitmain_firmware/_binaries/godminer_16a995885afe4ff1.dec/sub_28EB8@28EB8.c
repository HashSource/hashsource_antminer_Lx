int __fastcall sub_28EB8(_DWORD *a1, const char **a2)
{
  int v2; // r4
  const char **v5; // r7
  ...
  sub_12D3E4((__int64)(v12 * 100.0));
  v16 = json_real();
  json_object_set_new(v9, "rate_5s", v16);
  LODWORD(v17) = sub_12D3E4((__int64)(v13 * 100.0));
  v18 = v17 / 100.0;
  v19 = json_real();
