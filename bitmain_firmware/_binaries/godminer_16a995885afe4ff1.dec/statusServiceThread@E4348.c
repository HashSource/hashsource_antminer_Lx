...
LABEL_25:
      zlog(
        ...
        "/godminer-origin_master/common/general/http.c",
        157,
        "statusServiceThread",
        19,
        v20,
  ...
  zlog(
    ...
    "miner-origin_master/common/general/http.c",
    157,
    "statusServiceThread",
    19,
    66,
...
LABEL_21:
              ...
              LOWORD(v18) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/bu"
                                              "ild/rootfs/buildroot/tmp/release/build/godminer-origin_master/common/general/http.c";
              v25 = v34;
              goto LABEL_23;
            }
            V_LOCK();
            ...
            zlog(
              ...
              "/build/godminer-origin_master/common/general/http.c",
              157,
              "statusServiceThread",
              19,
              131,
      ...
      do
      {
        ...
        zlog(
          ...
          "ld/godminer-origin_master/common/general/http.c",
          157,
          "statusServiceThread",
          19,
          158,
        ...
        if ( v22 <= 0 )
        {
          ...
          zlog(
            ...
            "uild/godminer-origin_master/common/general/http.c",
            157,
            "statusServiceThread",
            19,
            162,
...
LABEL_23:
    ...
    HIWORD(v18) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/bui"
                                "ldroot/tmp/release/build/godminer-origin_master/common/general/http.c" >> 16;
    zlog(v15, v18, 157, v17, 19, v16, 20, v25);
    return 0;
  }
}
