char *__fastcall http_test_bm(int a1, char *a2, size_t a3)
{
  ...
  if ( v6 )
  {
    ...
    zlog(
      ...
      "odminer-origin_master/http_test.c",
      147,
      "http_test_bm",
      12,
      224,
    ...
    if ( !v6 )
    {
      if ( strstr(v4, "/max_rate") )
      {
        ...
        zlog(
          ...
          "ld/godminer-origin_master/http_test.c",
          147,
          "http_test_bm",
          12,
          264,
      ...
      else
      {
        ...
        if ( v6 )
        {
          ...
          else
          {
            ...
            zlog(
              ...
              "/build/godminer-origin_master/http_test.c",
              147,
              "http_test_bm",
              12,
              356,
        ...
        else
        {
          ...
          zlog(
            ...
            "uild/godminer-origin_master/http_test.c",
            147,
            "http_test_bm",
            12,
            283,
