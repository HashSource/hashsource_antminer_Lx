int __fastcall check_nonce_ckb2(int a1, int a2)
{
  ...
  if ( v23 <= 0x18 )
  {
    ...
    zlog(
      ...
      "odminer-origin_master/backend/backend_ckb2/backend_ckb2.c",
      171,
      "check_nonce_ckb2",
      16,
      318,
...
LABEL_9:
        ...
        zlog(
          ...
          "ld/godminer-origin_master/backend/backend_ckb2/backend_ckb2.c",
          171,
          "check_nonce_ckb2",
          16,
          328,
    ...
    else
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/backend/backend_ckb2/backend_ckb2.c",
        171,
        "check_nonce_ckb2",
        16,
        323,
