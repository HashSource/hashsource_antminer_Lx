void sub_2FCF0()
{
  ...
  if ( dword_165468 > 0 )
  {
    ...
    do
    {
      v5 = sub_2F090();
      ++v4;
      sub_2EA60((void **)(v5 + 8), (_BYTE *)(v5 + 24), v3);
      set_user(v3 + 256);
      v6 = v3 + 512;
      v3 += 768;
      set_pass(v6);
    }
    while ( dword_165468 > v4 );
  }
  if ( total_pools == v39 )
  {
    V_LOCK();
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        zlog(
          ...
          "ld/godminer-origin_master/pool.c",
          142,
          "pool_change_function",
          20,
          708,
      ...
      if ( total_pools > 0 )
      {
        do
        {
          ...
          zlog(
            ...
            "uild/godminer-origin_master/pool.c",
            142,
            "pool_change_function",
            20,
            753,
  ...
  if ( v40 )
  {
    ...
    v34 = pthread_create((pthread_t *)&dword_16CE1C, &attr, (void *(*)(void *))watchpool_thread, &dword_16CE18);
