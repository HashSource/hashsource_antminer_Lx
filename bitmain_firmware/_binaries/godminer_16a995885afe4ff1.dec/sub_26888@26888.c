int __fastcall sub_26888(_DWORD *a1, int a2)
{
  int v3; // r9
  _DWORD *v4; // r4
  char *v5; // r0
  ...
  *(_DWORD *)v145 = 0;
  ...
  {
    sub_23CA0(a1, 1, 70, *(const char **)(a2 + 8));
    v137 = json_array();
    v4 = json_object();
    v5 = BUFX_strdup("2.12");
    ...
    sub_12D3E4((__int64)(v20 * 100.0));
    v25 = json_real();
    json_object_set_new(v16, "GHS 5s", v25);
    sub_12D3E4((__int64)(v22 * 100.0));
    v26 = json_real();
    json_object_set_new(v16, "GHS av", v26);
    sub_12D3E4((__int64)(v21 * 100.0));
    v27 = json_real();
      ...
      if ( v139 > 0 )
      {
        ...
        if ( v139 > 0 )
        {
          ...
          do
          {
            ...
            sub_240F0(*((_DWORD *)v68 - 50), *((_DWORD *)v68 - 45), v155);
          ...
          if ( v139 > 0 )
          {
            ...
            do
            {
              ...
              sub_240F0(*((_DWORD *)v73 - 51), *((_DWORD *)v73 - 46), v155);
            ...
            if ( v139 > 0 )
            {
              ...
              do
              {
                ...
                sub_240F0(*((_DWORD *)v78 - 50), *((_DWORD *)v78 - 45), v155);
