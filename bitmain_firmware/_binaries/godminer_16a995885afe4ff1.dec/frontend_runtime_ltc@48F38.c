void *frontend_runtime_ltc()
{
  ...
  dword_166174 = (int)sub_48E2C;
  dword_166178 = (int)sub_48EC4;
  dword_16617C = (int)sub_483B8;
  dword_166170 = (int)sub_48D78;
  dword_166180 = (int)sub_48B44;
  dword_166184 = (int)stratum_subscribe_base;
  dword_166188 = (int)stratum_authorize_base;
  dword_16618C = (int)sub_483F0;
  dword_166190 = (int)sub_480F0;
