    ...
    if ( v13 )
    {
      ...
      else
      {
        ...
        if ( v10 )
        {
          ...
          v16 = 208;
          v17 = g_zc;
          LOWORD(v18) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/"
                                          "rootfs/buildroot/tmp/release/build/godminer-origin_master/frontend/frontend_vb"
                                          "k/frontend_vbk.c";
LABEL_8:
          HIWORD(v18) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/root"
                                      "fs/buildroot/tmp/release/build/godminer-origin_master/frontend/frontend_vbk/frontend_vbk.c" >> 16;
          zlog(v17, v18, 172, "stratum_authorize_vbk", 21, v16, v15, v26);
          free(v9);
          if ( *((_DWORD *)v13 + 1) != -1 )
          {
