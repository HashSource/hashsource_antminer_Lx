...
LABEL_17:
  ...
  v14 = 268;
  v15 = g_zc;
  LOWORD(v16) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/b"
                                  "uildroot/tmp/release/build/godminer-origin_master/frontend/frontend_vbk/frontend_vbk.c";
LABEL_8:
  HIWORD(v16) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/build"
                              "root/tmp/release/build/godminer-origin_master/frontend/frontend_vbk/frontend_vbk.c" >> 16;
  zlog(v15, v16, 172, "stratum_subscribe_vbk", 21, v14, v13, v24);
  free(v7);
  if ( *((_DWORD *)v11 + 1) != -1 )
  {
