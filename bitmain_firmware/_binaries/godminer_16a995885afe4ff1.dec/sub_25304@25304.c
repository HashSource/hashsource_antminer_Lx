int __fastcall sub_25304(_DWORD *a1, int a2)
{
  bool v4; // zf
  int v5; // r5
  __int64 v6; // kr00_8
  ...
  *(_DWORD *)v58 = 0;
  ...
  else
  {
    ...
    if ( total_pools )
    {
      sub_23CA0(a1, 1, 7, *(const char **)(a2 + 8));
      v53 = json_array();
      if ( total_pools > 0 )
      {
        v6 = 0;
        do
        {
          ...
          *(_DWORD *)v58 = 0;
          ...
          sub_12D3E4((__int64)(*(double *)(v17 + 2128) * 100.0));
          v47 = json_real();
          json_object_set_new(v18, "Difficulty Accepted", v47);
          sub_12D3E4((__int64)(*(double *)(v17 + 2136) * 100.0));
          v48 = json_real();
          json_object_set_new(v18, "Difficulty Rejected", v48);
          sub_12D3E4((__int64)(*(double *)(v17 + 1984) * 100.0));
          v49 = json_real();
          json_object_set_new(v18, "Difficulty Stale", v49);
          sub_12D3E4((__int64)(*(double *)(v17 + 1792) * 100.0));
          v50 = json_real();
