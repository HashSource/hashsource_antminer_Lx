bool __fastcall sub_3D13C(int a1, int *a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  _DWORD *v6; // r4
  _BOOL4 v7; // r9
    ...
    && valid_hex(v43) )
  {
    if ( a2 != (int *)-448 )
    {
      ...
      {
        V_LOCK();
        logfmt_raw(v53, 0x1000u, 0, "Stratum notify: new job's job_id doesnot change, %s, %s", a2[400], v11);
        V_UNLOCK();
        zlog(
          g_zc,
          "/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/buildroot/tmp/release/bui"
          "ld/godminer-origin_master/frontend/frontend_dash/frontend_dash.c",
          174,
          "stratum_notify_dash",
          19,
          88,
      ...
      nmemb = strlen(v15) >> 1;
      n = strlen(s) >> 1;
      snprintf((char *)a2 + 324, 9u, "%s", v42);
      snprintf((char *)a2 + 336, 9u, "%s", v44);
      snprintf((char *)a2 + 348, 9u, "%s", v43);
      v25 = a2[20];
      v26 = a2[79];
      v27 = nmemb + a2[18];
      a2[78] = v27;
      *((_BYTE *)a2 + 436) = v21;
      ...
      if ( v9 )
      {
        ...
        while ( 1 )
        {
          ...
          *(_DWORD *)(v37 + 4 * v34) = v39;
          ...
          ++v34;
          if ( !hex2bin(*(_DWORD *)(a2[80] + v51), v38, 32) )
          {
            v7 = 0;
            v11 = v50;
            V_LOCK();
      ...
      snprintf(
        ...
        "00000000",
        workpadding);
      v7 = hex2bin((int)(a2 + 40), (unsigned __int8 *)v52, 112);
      if ( v7 )
      {
        src = calloc(nmemb, 1u);
          ...
          if ( v7 )
          {
            ...
            if ( !v32 )
            {
              ...
              zlog(
                ...
                "se/build/godminer-origin_master/frontend/frontend_dash/frontend_dash.c",
                174,
                "stratum_notify_dash",
                19,
                167,
            ...
            memcpy((void *)(a2[73] + a2[18] + a2[20] + nmemb), v30, n);
            *((_QWORD *)a2 + 56) = *a2;
          }
          else
          {
        ...
        else
        {
          ...
          zlog(
            ...
            "uild/godminer-origin_master/frontend/frontend_dash/frontend_dash.c",
            174,
            "stratum_notify_dash",
            19,
            153,
...
LABEL_58:
  ...
  zlog(
    ...
    "miner-origin_master/frontend/frontend_dash/frontend_dash.c",
    174,
    "stratum_notify_dash",
    19,
    82,
