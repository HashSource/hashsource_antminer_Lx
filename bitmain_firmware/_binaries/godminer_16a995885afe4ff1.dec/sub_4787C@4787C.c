int __fastcall sub_4787C(int a1, int a2, _DWORD *a3, unsigned int a4)
{
  _DWORD *v7; // r0
  const char *v8; // r0
  char *v9; // r8
...
LABEL_4:
    ...
    zlog(
      ...
      "odminer-origin_master/frontend/frontend_kda/frontend_kda.c",
      172,
      v13,
      28,
      v11,
...
LABEL_14:
      ...
      zlog(
        ...
        "/godminer-origin_master/frontend/frontend_kda/frontend_kda.c",
        172,
  ...
  zlog(
    ...
    "miner-origin_master/frontend/frontend_kda/frontend_kda.c",
    172,
    "stratum_parse_extranonce_kda",
    28,
    v25,
