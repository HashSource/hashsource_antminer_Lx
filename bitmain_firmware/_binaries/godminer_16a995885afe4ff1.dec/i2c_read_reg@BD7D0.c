int __fastcall i2c_read_reg(int a1, unsigned __int8 *a2, int a3, int a4, int a5)
{
  ...
  if ( a3 == 1 )
  {
    v7 = pthread_mutex_lock(&stru_16C5D4);
    if ( v7 )
    {
    ...
    {
      v13 = 0;
      if ( find_c_map((int *)dword_16C5D0, (int)&v12, &v13) == 1 )
      {
        v8 = v13;
        ...
        if ( a5 )
        {
          while ( 1 )
          {
            ...
            if ( !sub_BCC74() )
            {
              ...
              zlog(
                ...
                "se/build/godminer-origin_master/backend/device/hal/platform/7007/7007_i2c.c",
                179,
                "i2c_read_reg",
                12,
                243,
          ...
          zlog(
            ...
            "uild/godminer-origin_master/backend/device/hal/platform/7007/7007_i2c.c",
            179,
            "i2c_read_reg",
            12,
            254,
