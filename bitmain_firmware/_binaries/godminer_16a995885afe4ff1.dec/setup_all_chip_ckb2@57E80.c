int __fastcall setup_all_chip_ckb2(int a1)
{
  ...
  v3 = *(_DWORD *)(a1 + 196);
  V_LOCK();
  logfmt_raw(v16, 0x1000u, 0, "%s", "setup_all_chip_ckb2");
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/buildroot/tmp/release/build/god"
    "miner-origin_master/backend/backend_ckb2/backend_ckb2.c",
    171,
    "setup_all_chip_ckb2",
    19,
    238,
  ...
  if ( !sub_57590(a1) )
    return 3;
  v4 = *(_DWORD *)(a1 + 296);
  v5 = sub_12CE18(256, (unsigned __int8)v3);
  if ( (_BYTE)v3 )
  {
    v6 = v4 - 1;
    v7 = 0;
  ...
  *(_DWORD *)(a1 + 240) = v5;
  ...
  v11 = (int)v9;
  v12 = rand();
  memset((void *)(v11 + 40), (unsigned __int8)(v10 + v12), 0x30u);
