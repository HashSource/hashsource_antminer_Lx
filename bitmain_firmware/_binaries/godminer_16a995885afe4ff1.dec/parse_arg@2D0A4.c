...
LABEL_8:
    ...
    if ( result == 111 )
    {
      ...
      v8 = 483;
      v9 = g_zc;
      LOWORD(v10) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/root"
                                      "fs/buildroot/tmp/release/build/godminer-origin_master/god-miner.c";
    }
    else
    {
      if ( result != 112 )
...
LABEL_47:
    HIWORD(v10) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/bui"
                                "ldroot/tmp/release/build/godminer-origin_master/god-miner.c" >> 16;
    return zlog(v9, v10, 147, "parse_arg", 9, v8, 100, v25);
  }
  if ( result > 1033 )
  {
    if ( result == 1034 )
