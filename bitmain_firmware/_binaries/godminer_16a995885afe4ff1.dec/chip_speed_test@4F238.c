int __fastcall chip_speed_test(_DWORD *a1, int a2)
{
  ...
  else
  {
    ...
    do
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/miner_util/miner_monitor/update_miner_status/update_chip_status.c",
        201,
        "chip_speed_test",
        15,
        26,
  ...
  zlog(
    ...
    "miner-origin_master/miner_util/miner_monitor/update_miner_status/update_chip_status.c",
    201,
    "chip_speed_test",
    15,
    40,
