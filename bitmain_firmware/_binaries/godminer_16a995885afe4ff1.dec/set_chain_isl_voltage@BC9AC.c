int __fastcall set_chain_isl_voltage(unsigned __int8 a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    {
      v13 = -1;
      sub_BC388(a1, v5, 0, &v13, 1);
      usleep((__useconds_t)&stru_1869C.st_value);
      v14 = v3;
      sub_BC388(a1, v5, 33, (char *)&v14, 2);
      ...
      zlog(
        *v2,
        ...
        "/godminer-origin_master/backend/device/hal/drv_pic/isl68127.c",
        173,
    ...
    zlog(
      *v2,
      ...
      "odminer-origin_master/backend/device/hal/drv_pic/isl68127.c",
      173,
