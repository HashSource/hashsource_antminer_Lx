int __fastcall sub_55CB0(int a1, unsigned int a2)
{
  int v4; // r2
  int v6; // r7
  unsigned int v7; // r0
...
LABEL_6:
    ...
    *(_DWORD *)(a1 + 772) = (int)v8 * v7;
    ...
    return zlog(
             ...
             "build/godminer-origin_master/backend/backend_ckb/backend_ckb.c",
             169,
  ...
  return zlog(
           ...
           "ild/godminer-origin_master/backend/backend_ckb/backend_ckb.c",
           169,
           "overclock_update_ckb",
           20,
           v4,
