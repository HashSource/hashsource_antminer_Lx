            ...
            while ( v173 > v91 )
            {
              ...
              if ( !v129 || strlen(v129) != 64 )
              {
                ...
                zlog(
                  ...
                  "ease/build/godminer-origin_master/frontend/frontend_grin32/frontend_grin32.c",
                  178,
                  "stratum_notify",
                  14,
                  228,
  ...
  else
  {
    if ( !strcasecmp(v8, "client.reconnect") )
    {
      ...
      if ( !v66 )
      {
        ...
        zlog(
          ...
          "ld/godminer-origin_master/frontend/frontend_grin32/frontend_grin32.c",
          178,
          "stratum_reconnect",
          17,
          469,
    ...
    if ( strcasecmp(v8, "client.get_algo") )
    {
      if ( !strcasecmp(v8, "client.get_stats") )
      {
        ...
        {
          sub_4375C(v93, (_DWORD *)1, "disabled");
        }
...
LABEL_90:
      ...
      else
      {
        ...
        sub_4375C(v71, (_DWORD *)0x26, "unknown method");
        v76 = json_dumps(v71, 0);
        v10 = stratum_send_line((int *)a2, v76);
        if ( v71 && v71[1] != -1 )
        {
