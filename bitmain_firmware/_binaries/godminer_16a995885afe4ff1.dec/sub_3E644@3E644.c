bool __fastcall sub_3E644(int a1, int *a2, _DWORD *a3)
{
  _DWORD *v5; // r0
  _DWORD *v6; // r5
  _BOOL4 v7; // r4
  ...
  if ( valid_ascii(v10) && valid_hex(v12) && valid_hex(v14) && valid_hex(v17) && valid_hex(v19) && valid_hex(v54) )
  {
    ...
    if ( v22 && !strcmp(v22, v10) )
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/frontend/frontend_dcr/frontend_dcr.c",
        172,
        "stratum_notify_dcr",
        18,
        111,
    ...
    if ( v53 )
    {
      ...
      if ( v53 > 0 )
      {
          ...
          *(_DWORD *)(v65 + 4 * v47) = v50;
          if ( !v50 )
          {
            ...
            zlog(
              ...
              "/build/godminer-origin_master/frontend/frontend_dcr/frontend_dcr.c",
              172,
              "stratum_notify_dcr",
              18,
              145,
        ...
        zlog(
          ...
          "ld/godminer-origin_master/frontend/frontend_dcr/frontend_dcr.c",
          172,
          "stratum_notify_dcr",
          18,
          152,
          ...
          if ( v7 )
          {
            ...
            if ( !v43 )
            {
              ...
              zlog(
                ...
                "se/build/godminer-origin_master/frontend/frontend_dcr/frontend_dcr.c",
                172,
                "stratum_notify_dcr",
                18,
                196,
...
LABEL_58:
  ...
  zlog(
    ...
    "miner-origin_master/frontend/frontend_dcr/frontend_dcr.c",
    172,
    "stratum_notify_dcr",
    18,
    105,
