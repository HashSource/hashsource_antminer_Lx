int __fastcall stratum_handle_method_eth(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    ...
    zlog(
      ...
      "odminer-origin_master/frontend/frontend_eth/frontend_eth.c",
      172,
  ...
  if ( v8 )
  {
    ...
    if ( v25 )
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/frontend/frontend_eth/frontend_eth.c",
        172,
        "rpc2_job_decode",
        15,
        380,
      ...
      *(_DWORD *)(a2 + 1916) = v29;
      if ( v29 )
      {
        ...
        if ( *(_DWORD *)(a2 + 1916) )
        {
          ...
          *(_DWORD *)(a2 + 1596) = get_epoch_number_rvn((const void *)(a2 + 1512));
          V_LOCK();
          ...
          zlog(
            ...
            "uild/godminer-origin_master/frontend/frontend_eth/frontend_eth.c",
            172,
            "rpc2_job_decode",
            15,
            424,
        ...
        zlog(
          ...
          "ld/godminer-origin_master/frontend/frontend_eth/frontend_eth.c",
          172,
          "rpc2_job_decode",
          15,
          409,
