int __fastcall SOC_24G_20210817_update(int a1, int a2, unsigned __int8 a3, int a4)
{
  ...
  zlog(
    ...
    60,
    v46);
  sub_5E03C(a1, a3, v24, -536870913);
  sub_5E03C(a1, a3, v28, 0x20000000);
  sub_5E03C(a1, a3, v24, -5);
  sub_5E03C(a1, a3, v30, 0);
  sub_5E03C(a1, a3, v24, 0x7FFFFFFF);
  sub_5E03C(a1, a3, v31, 0x80000000);
  sub_5E03C(a1, a3, v24, -262145);
  sub_5E03C(a1, a3, v27, 0);
  sub_5E03C(a1, a3, v24, -5);
  sub_5E03C(a1, a3, v27, 0);
  sub_5E03C(a1, a3, v24, 0x7FFFFFFF);
  sub_5E03C(a1, a3, v28, 0);
  sub_5E03C(a1, a3, v24, -1025);
  sub_5E03C(a1, a3, v32, 0);
  ...
  sub_5E03C(a1, a3, v24, -67108865);
  sub_5E03C(a1, a3, v33, 0x4000000);
  sub_5C8F0(a1, a3, 144, -131073);
  sub_5C8F0(a1, a3, 145, -2147450879);
  sub_5C8F0(a1, a3, 144, 0);
  sub_5C8F0(a1, a3, 145, -2147450818);
  sub_5E03C(a1, a3, v24, -262145);
  sub_5E03C(a1, a3, v34, 0x40000);
  sub_5E03C(a1, a3, v24, -1025);
  sub_5E03C(a1, a3, v35, 1024);
  sub_5E03C(a1, a3, v24, -8388609);
  sub_5E03C(a1, a3, v36, 0x800000);
  sub_5E03C(a1, a3, v24, 0xFFFFFFF);
  sub_5E03C(a1, a3, v37, 1610612736);
  ...
  sub_5E03C(a1, a3, v24, -196609);
  sub_5E03C(a1, a3, v26, 0x20000);
  sub_5E03C(a1, a3, v24, -4);
  sub_5E03C(a1, a3, v38, 2);
  sub_5E03C(a1, a3, v24, -196609);
  sub_5E03C(a1, a3, v38, 196608);
  sub_5E03C(a1, a3, v24, -196609);
  sub_5E03C(a1, a3, v39, 196608);
  ...
  sub_5E03C(a1, a3, v24, -12289);
  sub_5E03C(a1, a3, v40, 0x2000);
  sub_5E03C(a1, a3, v24, -4194305);
  sub_5E03C(a1, a3, v41, 0x400000);
  sub_5E03C(a1, a3, v24, -497);
  sub_5E03C(a1, a3, v25, 384);
  sub_5E03C(a1, a3, v24, -225);
  sub_5E03C(a1, a3, v19, 0);
  sub_5E03C(a1, a3, v24, -61441);
  sub_5E03C(a1, a3, v25, 0x2000);
  sub_5E03C(a1, a3, v24, -32769);
  sub_5E03C(a1, a3, v42, 0x8000);
  sub_5E03C(a1, a3, v24, -65537);
  sub_5E03C(a1, a3, v43, 0x10000);
  sub_5E03C(a1, a3, v24, -131073);
  sub_5E03C(a1, a3, v43, 0x20000);
  sub_5E03C(a1, a3, v24, -65521);
  sub_5E03C(a1, a3, v26, 0x8000);
  sub_5E03C(a1, a3, v24, 0xFFFFFF);
  sub_5E03C(a1, a3, v44, -268435456);
  sub_5E03C(a1, a3, v24, -256);
  sub_5E03C(a1, a3, v45, 255);
