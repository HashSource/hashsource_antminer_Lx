int __fastcall SOC_28G_20210929_update(int a1, int a2, int a3, int a4)
{
  ...
  V_LOCK();
  logfmt_raw(v48, 0x1000u, 0, &unk_13A7A0, "SOC_28G_20210929_update", a3);
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  sub_5E03C(a1, a3, v16, 0x80000000);
  ...
  sub_5E03C(a1, a3, v17, 50);
  sub_5E03C(a1, a3, v8, 0xFFFFFF);
  sub_5E03C(a1, a3, v18, 838860800);
  ...
  sub_5E03C(a1, a3, v24, 0x4000000);
  sub_5C8F0(a1, a3, 144, -131073);
  sub_5C8F0(a1, a3, 145, -2147450879);
  sub_5C8F0(a1, a3, 144, 0);
  sub_5C8F0(a1, a3, 145, -2147450818);
  sub_5E03C(a1, a3, v8, -262145);
  sub_5E03C(a1, a3, v25, 0x40000);
  sub_5E03C(a1, a3, v8, -1025);
  sub_5E03C(a1, a3, v26, 1024);
  sub_5E03C(a1, a3, v8, -8388609);
  sub_5E03C(a1, a3, v27, 0x800000);
  sub_5E03C(a1, a3, v8, 0xFFFFFFF);
  sub_5E03C(a1, a3, v28, 1610612736);
  ...
  sub_5E03C(a1, a3, v10, 0x10000);
  sub_5E03C(a1, a3, v8, -4);
  sub_5E03C(a1, a3, v29, 1);
  sub_5E03C(a1, a3, v8, -196609);
  sub_5E03C(a1, a3, v29, 196608);
  sub_5E03C(a1, a3, v8, -196609);
  sub_5E03C(a1, a3, v30, 196608);
  ...
  sub_5E03C(a1, a3, v39, 96);
  sub_5E03C(a1, a3, v8, -4);
  sub_5E03C(a1, a3, v10, 3);
  sub_5E03C(a1, a3, v8, -4);
  sub_5E03C(a1, a3, v15, 2);
  sub_5E03C(a1, a3, v8, -8193);
  sub_5E03C(a1, a3, v11, 0);
  sub_5E03C(a1, a3, v8, -1025);
  sub_5E03C(a1, a3, v40, 0);
  sub_5E03C(a1, a3, v8, -9);
  sub_5E03C(a1, a3, v12, 8);
  sub_5E03C(a1, a3, v8, -134217729);
  sub_5E03C(a1, a3, v41, 0x8000000);
  sub_5E03C(a1, a3, v8, -2);
  sub_5E03C(a1, a3, v42, 0);
  sub_5E03C(a1, a3, v8, -3145729);
  sub_5E03C(a1, a3, v43, 0x200000);
  sub_5E03C(a1, a3, v8, 0xFFFFFFF);
  sub_5E03C(a1, a3, v44, -268435456);
  sub_5E03C(a1, a3, v8, -16);
  sub_5E03C(a1, a3, v45, 8);
  sub_5E03C(a1, a3, v8, -234881025);
  sub_5E03C(a1, a3, v46, 0x8000000);
  sub_5E03C(a1, a3, v8, -8);
  sub_5E03C(a1, a3, v13, 6);
  sub_5E03C(a1, a3, v8, -1793);
  sub_5E03C(a1, a3, v13, 768);
  sub_5E03C(a1, a3, v8, -458753);
  sub_5E03C(a1, a3, v13, 393216);
  sub_5E03C(a1, a3, v8, -117440513);
  sub_5E03C(a1, a3, v13, 0x2000000);
  sub_5E03C(a1, a3, v8, -8);
  sub_5E03C(a1, a3, v47, 6);
  sub_5E03C(a1, a3, v8, -8388609);
  sub_5E03C(a1, a3, v11, 0x800000);
  sub_5E03C(a1, a3, v8, -2049);
  sub_5E03C(a1, a3, v12, 2048);
