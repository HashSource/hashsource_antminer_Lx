int __fastcall serdes_phy_bist_external(int a1, int a2, _BYTE *a3, int a4, unsigned __int8 a5, int a6)
{
  ...
  | (a5 << 8) & 0x700
  | (16 * a5) & 0x70);
  sub_5E03C(a1, (unsigned __int8)a3, v10, -15);
  sub_5E03C(a1, (unsigned __int8)a3, v11, (2 * a5) & 0xE);
  sub_5E03C(a1, (unsigned __int8)a3, v10, 0);
  V_LOCK();
  if ( a5 )
    v12 = "prbs";
  else
  ...
  if ( a6 > 2 )
  {
    ...
    sub_5E03C(a1, (unsigned __int8)a3, v10, -2);
    v16 = (unsigned __int16)v23 | 0x91;
    v17 = (unsigned __int16)v23 | 0x77;
    sub_5E03C(a1, (unsigned __int8)a3, v16, 1);
    sub_5E03C(a1, (unsigned __int8)a3, v10, -4194305);
    sub_5E03C(a1, (unsigned __int8)a3, v17, 0x400000);
    sub_5E03C(a1, (unsigned __int8)a3, v10, 0);
    sub_5E03C(a1, (unsigned __int8)a3, v10, -9);
    sub_5E03C(a1, (unsigned __int8)a3, v16, 8);
    sub_5E03C(a1, (unsigned __int8)a3, v10, -1073741825);
    sub_5E03C(a1, (unsigned __int8)a3, v17, 0x40000000);
    sub_5E03C(a1, (unsigned __int8)a3, v10, 0);
    check_bist_tx_running(a1, a2, a3, a4);
    check_bist_rx_running(a1, a2, (int)a3, a4);
    usleep(0x493E0u);
    sub_5E03C(a1, (unsigned __int8)a3, v10, -9);
    sub_5E03C(a1, (unsigned __int8)a3, v16, 0);
    sub_5E03C(a1, (unsigned __int8)a3, v10, 0);
  ...
  else
  {
    ...
    sub_5C8F0(a1, (unsigned __int8)a3, 98, 0);
    sub_5C8F0(a1, 3u, 83, 0);
    sub_5C8F0(a1, (unsigned __int8)a3, 98, 128);
    for ( j = 5; ; j = v21 )
    {
      enable_rxbist_autostop_one_lane(a1, a2, (unsigned __int8)a3, 7u, j);
      sub_5C8F0(a1, (unsigned __int8)a3, 144, -13);
      sub_5C8F0(a1, (unsigned __int8)a3, 145, -2147454975);
      sub_5C8F0(a1, (unsigned __int8)a3, 144, 12);
      sub_5C8F0(a1, (unsigned __int8)a3, 145, -2147454962);
      sub_5C8F0(a1, (unsigned __int8)a3, 144, 0);
      sub_5C8F0(a1, (unsigned __int8)a3, 145, -2147454975);
