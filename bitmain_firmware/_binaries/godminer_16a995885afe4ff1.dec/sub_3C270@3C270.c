int __fastcall sub_3C270(int a1, int a2, _DWORD *a3, unsigned int a4)
{
  _DWORD *v7; // r0
  char *v8; // r4
  _DWORD *v9; // r0
...
LABEL_7:
    ...
    zlog(
      ...
      "odminer-origin_master/frontend/frontend_ckb/frontend_ckb.c",
      172,
      v17,
      28,
      v15,
    ...
    *(_DWORD *)(a2 + 1608) = v23;
    if ( v23 )
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/frontend/frontend_ckb/frontend_ckb.c",
        172,
