        ...
        _DWORD *a9)
{
  ...
  *a6 = 150;
  ...
  if ( v14 > 0 )
  {
    ...
    v15 = 0;
    v78 = &v71;
    v83 = "/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/buildroot/tmp/release/bui"
          "ld/godminer-origin_master/miner_util/miner_monitor/update_miner_status/update_temperature.c";
    v90 = 0;
    v87 = 0;
    v85 = &g_zc;
    v86 = &g_temp_zc;
...
LABEL_5:
      ...
      *((_DWORD *)v24 + 3) = v36;
      ...
      V_UNLOCK();
      zlog(*v85, v83, 201, "read_temperature", 16, 80, 20, v137);
      V_LOCK();
      ...
      *((_DWORD *)v45 + 3) = v57;
      ...
      V_UNLOCK();
      zlog(*v86, v83, 201, "read_temperature", 16, 82, 40, v137);
      v14 = v75[1];
    }
    while ( v14 > v15 );
  }
