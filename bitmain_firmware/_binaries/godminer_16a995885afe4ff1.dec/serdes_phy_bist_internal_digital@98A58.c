int __fastcall serdes_phy_bist_internal_digital(int a1, int a2, _DWORD *a3, int a4, unsigned __int8 a5)
{
  ...
  v14 = v12;
  sub_5E03C(a1, (unsigned __int8)a3, v10, -521);
  sub_5E03C(a1, (unsigned __int8)a3, v8, 520);
  ...
  sub_5E03C(a1, (unsigned __int8)a3, v9, (2 * a5) & 0xE);
  sub_5E03C(a1, (unsigned __int8)a3, v10, 0);
  sub_5C8F0(a1, (unsigned __int8)a3, 98, 255);
  sub_5E03C(a1, (unsigned __int8)a3, v10, -9);
  sub_5E03C(a1, (unsigned __int8)a3, v11, 8);
