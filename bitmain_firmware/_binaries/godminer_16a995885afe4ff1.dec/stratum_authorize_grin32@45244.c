...
LABEL_11:
  ...
  if ( !v14 )
  {
    ...
    zlog(
      ...
      "odminer-origin_master/frontend/frontend_grin32/frontend_grin32.c",
      178,
  ...
  if ( (unsigned int)json_integer_value(v17) == 2 && (!v15 || *v15 == 6 || v16 && *v16 != 7) )
  {
    ...
    zlog(
      ...
      v50);
    V_LOCK();
    logfmt_raw(v50, 0x1000u, 0, "stratum_authorize_grin32 authentication failed");
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/buildroot/tmp/release/build/g"
  ...
  if ( v20 )
  {
    if ( *v20 != 111 || v20[1] != 107 || v20[2] )
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/frontend/frontend_grin32/frontend_grin32.c",
        178,
        "rpc2_login_decode",
        17,
        100,
...
LABEL_21:
  ...
  zlog(
    ...
    "miner-origin_master/frontend/frontend_grin32/frontend_grin32.c",
    178,
    "rpc2_login_decode",
    17,
    119,
      ...
      if ( v38 )
      {
        ...
        if ( v40 )
        {
          ...
          if ( json_integer_value(v42) != 3 && !(*(int (__fastcall **)(int, int, void *))(a1 + 24))(a1, a2, v39) )
          {
            ...
            zlog(
              ...
              "/build/godminer-origin_master/frontend/frontend_grin32/frontend_grin32.c",
              178,
              "stratum_authorize_grin32",
              24,
              916,
        ...
        else
        {
          ...
          zlog(
            ...
            "uild/godminer-origin_master/frontend/frontend_grin32/frontend_grin32.c",
            178,
            "stratum_authorize_grin32",
            24,
            911,
