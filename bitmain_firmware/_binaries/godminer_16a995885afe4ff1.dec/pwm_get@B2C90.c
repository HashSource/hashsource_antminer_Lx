  ...
  else
  {
    ...
    *(_DWORD *)a2 = v4;
    ...
    LOWORD(v8) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/"
                                   "buildroot/tmp/release/build/godminer-origin_master/backend/device/hal/platform/7007/7007_pwm.c";
  }
  HIWORD(v8) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/buildr"
                             "oot/tmp/release/build/godminer-origin_master/backend/device/hal/platform/7007/7007_pwm.c" >> 16;
  zlog(v7, v8, 179, "pwm_get", 7, v6, v5, v11);
  return v2;
}
