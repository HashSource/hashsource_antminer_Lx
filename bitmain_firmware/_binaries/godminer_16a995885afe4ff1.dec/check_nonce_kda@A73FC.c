int __fastcall check_nonce_kda(int a1, int a2)
{
  ...
  if ( v13 <= 0x19 )
  {
    ...
    logfmt_raw(
      ...
      0x1000u,
      0,
      "hw error calculate diff %d ans diff %d TICKET_MASK_KDA %d",
      v14,
    ...
    zlog(
      ...
      "odminer-origin_master/backend/backend_kda/backend_kda.c",
      169,
      "check_nonce_kda",
      15,
      387,
  ...
  else
  {
    ...
    if ( v15 == v13 )
    {
      ...
      V_LOCK();
      logfmt_raw((char *)v46, 0x1000u, 0, "hw diff (%d<%d) not reach pool", *(unsigned __int8 *)(a2 + 88), v5);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_L7_release_USE_APW121417b/build/rootfs/buildroot/tmp/release/build"
        "/godminer-origin_master/backend/backend_kda/backend_kda.c",
        169,
        "check_nonce_kda",
        15,
        397,
