int __fastcall check_nonce_grin29(int a1, int a2)
{
  ...
  if ( v13 )
  {
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        while ( a2 + 199 != v19 );
        qsort(v3, 0x2Au, 4u, (__compar_fn_t)sub_A1D88);
        ++v17;
        v15 = v14[1];
        if ( v17 >= *v14 )
          break;
  ...
  if ( v22 == 42 )
  {
    ...
    if ( v36 > v31 )
    {
      ...
      zlog(
        ...
        "/godminer-origin_master/backend/backend_grin29/backend_grin29.c",
        175,
        "check_nonce_grin29",
        18,
        462,
  ...
  else
  {
    ...
    zlog(
      ...
      "odminer-origin_master/backend/backend_grin29/backend_grin29.c",
      175,
      "check_nonce_grin29",
      18,
      436,
