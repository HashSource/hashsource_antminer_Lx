  ...
  do
  {
    ...
    *((_DWORD *)v11 + 3) = v14;
    ...
    zlog(
      ...
      "odminer-origin_master/miner_util/miner_monitor/update_miner_status/update_fanspeed.c",
      198,
      "update_fanspeed",
      15,
      34,
    ...
    if ( realtime_speed != -1 )
    {
      ...
      *v18 = v59[4];
      ...
      zlog(
        ...
        "/godminer-origin_master/miner_util/miner_monitor/update_miner_status/update_fanspeed.c",
        198,
        "update_fanspeed",
        15,
        36,
