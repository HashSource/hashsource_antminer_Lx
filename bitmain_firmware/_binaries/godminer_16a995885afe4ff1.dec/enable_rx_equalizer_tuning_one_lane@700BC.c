int __fastcall enable_rx_equalizer_tuning_one_lane(int a1, int a2, int a3, int a4)
{
  ...
  zlog(
    ...
    60,
    v11);
  sub_5E03C(a1, a3, v8, -4194305);
  sub_5E03C(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x2F, 0);
  sub_5E03C(a1, a3, v8, -4194305);
  sub_5E03C(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x2F, 0x400000);
  sub_5E03C(a1, a3, v8, -4194305);
  sub_5E03C(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x2F, 0);
  sub_5E03C(a1, a3, v8, -2049);
  sub_5E03C(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x37, 2048);
  sub_5E03C(a1, a3, v8, -1073741825);
  v9 = (unsigned __int16)((_WORD)a4 << 12) | 0x98;
  sub_5E03C(a1, a3, (unsigned __int16)((_WORD)a4 << 12) | 0x7E, 0x40000000);
  sub_5E03C(a1, a3, v8, -16777217);
  sub_5E03C(a1, a3, v9, 0);
  sub_5E03C(a1, a3, v8, -16777217);
  sub_5E03C(a1, a3, v9, 0x1000000);
